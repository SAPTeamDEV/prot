...
values = {
    "accountSettingsWindow": {
        ...
        "linkAccountsInstructionsNewText": (
            "दो खातों को लिंक करने के लिए, पहले खाते पर एक कोड उत्पन्न करें \n"
        ...
        "linkAccountsInstructionsText": (
            "दो खातों को जोड़ने के लिए एक में कोड उत्पन्न\n"
        ...
        "setAccountNameDesc": (
            "अपने खाते के लिए प्रदर्शित करने के लिए नाम चुनें। \n"
            "आप अपने लिंक किए गए किसी एक से नाम का उपयोग कर सकते हैं \n"
            "खातों या अनन्य कस्टम नाम बनाएं"
        ),
        "signInInfoText": (
            "सभी यंत्रों पर अपनी प्रगति को संग्रहीत करने के लिए, \n"
        ...
        "testAccountWarningCardboardText": (
            'चेतावनी: आप एक "परीक्षा" खाते से साइन इन कर रहे हैं |\n'
    ...
    "alreadySignedInText": (
        "आपका खाता किसी अन्य डिवाइस से साइन किया गया है; \n"
    ...
    "buttonText": "बटन",
    "canWeDebugText": (
        "क्या आप बोम्ब-स्क्वाड को अपने आप खराबियों व \n"
    ...
    "configGamepadWindow": {
        ...
        "secondHalfText": (
            "इसका प्रयोग करके एक में दो वाले \n"
    ...
    "configTouchscreenWindow": {
        ...
        "swipeInfoText": (
            "स्वाइप से खेलना सिखने में थोडा टाइम लगता है परन्तु\n"
    ...
    "connectMobileDevicesWindow": {
        ...
        "explanationText": (
            "किसी स्मार्ट फ़ोन या टेबलेट का वायरलेस नयन्त्रक के रूप में प्रयोग करने के लिए \n"
        ...
        "getItForText": (
            "${REMOTE_APP_NAME} पायें आई-ओ-एस के लिए एप्पल एप्लीकेशन भंडार से \n"
    ...
    "coopSelectWindow": {
        ...
        "activenessInfoText": (
            "यह गुणक उन दिनों बढ़ता है जब आप खेलते हैं \n"
            "और उन दिनों घटता है जिन दिन आप नहीं खेलते"
        ),
        "activityText": "सक्रियता",
        "campaignText": "अभियान",
        "challengesInfoText": (
            "छोटे गेम खेल के पुरस्कार जीतें |  \n"
            "\n"
        ...
        "totalText": "सम्पूर्ण",
        "tournamentInfoText": (
            "सम्पूर्ण अंकों में अपने संघ के बाकी \n"
    ...
    "creditsWindow": {
        ...
        "songCreditText": (
            "${TITLE} ${PERFORMER} के द्वारा, ${COMPOSER} के द्वारा रचा हुआ,\n"
    ...
    "difficultyHardUnlockOnlyText": (
        "इस स्तर को सिर्फ कठिन में खोला जा सकता है | \n"
    ...
    "editProfileWindow": {
        "accountProfileInfoText": (
            "यह एक ख़ास पार्श्वचित्र ( एक नाम और आइकॉन के साथ) है \n"
        ...
        "globalProfileInfoText": (
            "खिलाड़ियों के वैश्विक पार्श्वचित्र का अनोखा नाम होगा | \n"
        ...
        "localProfileInfoText": (
            "स्थानिक खिलाड़ी पार्श्वचित्र का कोई आइकॉन नहीं होता है \n"
        ...
        "upgradeProfileInfoText": (
            "यह आपके नाम को विश्व भर में निग्रह कर देगा \n"
    ...
    "failText": "असफल",
    "fatalErrorText": (
        "माफ़ करें कुछ लुप्त है या गड़बड़ है | \n"
    ...
    "gameSettingsWindow": {"addGameText": "गेम जोड़ें"},
    "gamesToText": "${WINCOUNT} जीते और ${LOSECOUNT} हारे",
    "gatherWindow": {
        "aboutDescriptionLocalMultiplayerExtraText": (
            "ध्यान रखें: किसी भी यंत्र पे एक से ज्यादा खिलाड़ी हो सकते हैं \n"
            "अगर आपके पास पर्याप्त नियंत्रक हैं"
        ),
        "aboutDescriptionText": (
            "पार्टी इकट्ठा करने के लिए इन टैब्स का प्रयोग करें |  \n"
            "\n"
            "पार्टी में आप गेम व \n"
        ...
        "appInviteInfoText": (
            "दोस्तों को बोम्ब-स्क्वाड खेलने के लिए आमंत्रित करें\n"
        ...
        "earnTicketsForRecommendingAmountText": (
            "यदि वे गेम को आज़माते हैं तो दोस्तों को ${COUNT} \n"
        ...
        "friendPromoCodeInstructionsText": (
            'इसका प्रयोग करने के लिए, ${APP_NAME} खोले और फिर "सेटिंग->उन्नत सेटिंग->कोड डालें" में जाएँ \n'
        ...
        "googlePlayReInviteText": (
            "आपकी पार्टी में ${COUNT} गूगल प्ले के खिलाड़ी हैं \n"
        ...
        "inviteAFriendText": (
            "दोस्तों के पास यह गेम नहीं है ? उन्हें आमंत्रित करें खेलने के लिए | \n"
        ...
        "wifiDirectDescriptionBottomText": (
            "यदि सारे यंत्रों में 'वाई-फाई डायरेक्ट' का पैनल है \n"
        ...
        "wifiDirectDescriptionTopText": (
            "वाई-फाई डायरेक्ट' से एंड्राइड यंत्रों को बिना वाई-फाई नेटवर्क के भी जोड़ा जा सकता है | \n"
    ...
    "getTicketsWindow": {
        ...
        "unavailableLinkAccountText": (
            "माफ़ करें इस प्लेटफार्म पर खरीदारी नहीं कि जा सकती है |\n"
    ...
    "helpWindow": {
        ...
        "controllersInfoText": (
            "आप नेटवर्क पे दोस्तों के साथ ${APP_NAME} खेल सकते हैं, या आप एक ही यंत्र पे भी खेल सकते हैं \n"
            "अगर आपके पास पर्याप्त नियंत्रक हैं | \n"
        ...
        "controlsText": "नियंत्रण",
        "devicesInfoText": (
            "${APP_NAME} गेम का वी-आर संस्करण आम संस्करण के \n"
        ...
        "devicesText": "यंत्र",
        "friendsGoodText": (
            "इनका होना नहुत अच्छा है | ${APP_NAME} को कई खिलाड़ियों (अधिकतम ८ खिलाड़ी) \n"
        ...
        "powerupStickyBombsDescriptionText": (
            "जिस भी चीज़ को छुएँगे उससे चिपक जायेंगे .. \n" "इसका मज़ा लें !"
        ),
    ...
    "installDiskSpaceErrorText": (
        "त्रुटी: इनस्टॉल ख़तम नहीं कर पाया | \n"
    ...
    "internal": {
        ...
        "connectionFailedVersionMismatchText": (
            "जुड़ना असफल रहा; मेज़बान गेम का अलग संस्करण चला रहा है | \n"
        ...
        "incompatibleVersionHostText": (
            "मेज़बान गेम का अलग संस्करण चला रहा है | \n"
            "यह सुनिश्चित करें कि आप दोनों के पास एक ही संस्करण है और फिर प्रयास करें |"
        ),
        "incompatibleVersionPlayerText": (
            "${NAME} गेम का अलग संस्करण चला रहा है | \n"
            "यह सुनिश्चित करें कि आप दोनों के पास एक ही संस्करण है और फिर प्रयास करें |"
        ),
        ...
        "joinedPartyInstructionsText": (
            "कोई आपकी पार्टी में जुड़ गया है | \n"
    ...
    "macControllerSubsystemMFiNoteText": (
        "आईओएस/मैक के लिए बना हुआ नियंत्रक का पता चला; \n"
    ...
    "mustInviteFriendsText": (
        "टिपण्णी: आपको अपने दोस्तों को आमंत्रण \n"
    ...
    "newTestBuildAvailableText": (
        "एक नया परीक्षा का संस्करण उपलब्ध है ! \n"
    ...
    "noProfilesErrorText": (
        "आपकी कोई खिलाड़ी पार्श्वचित्र नहीं है, इसलिए आप '${NAME}' नाम के साथ फंसे हैं |\n"
    ...
    "pleaseRateText": (
        "अगर आपको ${APP_NAME} में मज़ा आ रहा है, \n"
    ...
    "ps3ControllersWindow": {
        "macInstructionsText": (
            "अपने पी.एस.३ के पीछे कि बिजली को काटें, \n"
        ...
        "ouyaInstructionsText": (
            "पी.एस.३ नियंत्रक को ऊया के सस्थ चलने के लिए सिर्फ उसे एक बार यु.एस.बी तार से जोड़ दें |\n"
    ...
    "remoteAppInfoShortText": (
        "${APP_NAME} सबसे मजेदार है जब परिवार और दोस्तों के साथ खेला जाता है। \n"
    ...
    "remote_app": {
        ...
        "description": (
            "अपने फ़ोन या टेबलेट का नियंत्रिक के रूप में बोम्ब-स्क्वाड के लिए प्रयोग करें |  \n"
        ...
        "searching_caption": (
            "जुड़ने के लिए किसी गेम के नाम को दबाएँ | \n"
    ...
    "replayVersionErrorText": (
        "माफ़ करें, यह रीप्ले किसी और संस्करण में बना था  \n"
    ...
    "reportPlayerExplanationText": (
        "इस ईमेल का प्रयोग करके धोकाधड़ी या अनुचित शब्दों के प्रयोग या \n"
    ...
    "signInWithGameCenterText": (
        "गेम केंद्र खाते का उपयोग करने के लिए, \n" "गेम सेंटर एप के साथ साइन इन करें।"
    ),
    ...
    "store": {
        ...
        "bombSquadProNewDescriptionText": (
            "• इन-गेम विज्ञापनों और नैग-स्क्रीन को निकाल देता है \n"
        ...
        "freeBombSquadProText": (
            "बम्ब्सक्वाड अब नि:शुल्क है, लेकिन जब से आपने मूल रूप से इसे खरीदा था \n"
    ...
    "translations": {
        ...
        "gameDescriptions": {
            (
                ...
                "जीतने के लिए लंबे समय तक चुने गए व्यक्ति बनें। \n"
        ...
        "inputDeviceNames": {"Keyboard": "कीबोर्ड", "Keyboard P2": "कीबोर्ड प.२"},
        "languages": {
            "Arabic": "अरबी",
        ...
        "playlistNames": {"Just Epic": "सिर्फ उत्कृष्ट", "Just Sports": "सिर्फ्र खेल"},
        "scoreNames": {
            "Flags": "झण्डें",
            "Goals": "लक्ष्य",
            "Score": "स्कोर",
        ...
        "serverResponses": {
            ...
            (
                ...
                "क्या आप वाकई इन खातों को जोड़ना चाहते हैं?  \n"
                "\n"
                "${ACCOUNT1} \n"
                "${ACCOUNT2}  \n"
                "\n"
            ...
            (
                ...
                "जुड़ाव अस्वीकृत। ${ACCOUNT} में  महत्वपूर्ण डेटा शामिल है \n"
            ...
            (
                ...
                "इस खाते में ${ACCOUNT} खाता लिंक करें? \n"
            ...
            (
                ...
                "साइन इन करने के लिए ${COUNT} टिकट प्राप्त हुए। \n"
            ...
            (
                ...
                "सर्वर कार्यक्षमता अब खेल के इस संस्करण में समर्थित नहीं है; \n"
            ...
            (
                ...
                "इस खाते से ${ACCOUNT} अनलिंक करें? ${ACCOUNT} \n"
            ...
            (
                ...
                "चेतावनी: आपके खाते के खिलाफ हैकिंग की शिकायतें जारी की गई हैं। \n"
            ...
            (
                ...
                "खेल की आपकी प्रति संशोधित कर दी गई है। \n"
        ...
        "tips": {
            (
                ...
                "एक परिपूर्ण समय से किआ गया दौड़-कूद-स्पिन-पंच एक ही बार में मार सकता है\n"
            ...
            (
                ...
                "यादृच्छिक के बजाये अपने पसंदीदा नाम और भेष का उपयोग करके  \n"
            ...
            (
                ...
                "अभिशाप बक्से आपको एक टिकिंग टाइम बम में बदल देते हैं।\n"
            ...
            (
                ...
                "उनके दिक्खावट के अलावा, सभी पात्रों की क्षमता समान हैं,\n"
            ...
            (
                ...
                "दौड़ने के लिए किसी भी बटन को दबाए रखें। आप स्थानों को तेजी से प्राप्त करेंगे\n"
            ...
            (
                ...
                "बर्फ बम बहुत शक्तिशाली नहीं हैं, लेकिन जो भी उसके चपेट में अत है जम जाता है, \n"
            ...
            (
                ...
                "अगर कोई आपको उठाता है, तो उन्हें मुक्का मारें और वे जाने देंगे।\n"
            ...
            (
                ...
                "यदि आपके पास नियंत्रकों की कमी है, तो अपने मोबाइल उपकरणों पर '${REMOTE_APP_NAME}' ऐप ​​इंस्टॉल करें\n"
            ...
            (
                ...
                "यदि आप चिपचिपा-बम के शिकार हो गए , तो चारों ओर कूदें और गोल-गोल घूमे। आप शायद\n"
            ...
            (
                ...
                "यदि आप एक अभिशाप उठाते हैं, तो अस्तित्व के लिए आपकी एकमात्र आशा है\n"
            ...
            (
                ...
                "यदि आपके पास बहुत से खिलाड़ी आ रहे हैं और जा रहे हैं, तो सेटिंग्स के तहत 'ऑटो-किक-निष्क्रिय-प्लेयर्स' चालू करें\n"
            ...
            (
                ...
                "यदि आपका डिवाइस बहुत गर्म हो जाता है या आप बैटरी पावर को संरक्षित करना चाहते हैं,\n"
            ...
            (
                ...
                "कैप्चर-द-फ्लैग में, आपका खुद का झंडा स्कोर करने के लिए आपके आधार पर होना चाहिए, यदि दूसरा\n"
            ...
            (
                ...
                "अन्य खिलाड़ियों सहित कई चीजों को उठाया और फेंक दिया जा सकता है। पटकना\n"
            ...
            (
                ...
                "खिलाड़ी अधिकांश खेलों के बीच में शामिल हो सकते हैं और छोड़ सकते हैं,\n"
            ...
            (
                ...
                "पंच आपके मुट्ठी तेजी से बढ़ रहे हैं, और अधिक नुकसान पहुंचाते हैं,\n"
            ...
            (
                ...
                "सिर सबसे कमजोर क्षेत्र है, इसलिए एक चिपचिपा-बम\n"
            ...
            (
                ...
                "यह स्तर कभी खत्म नहीं होता है, लेकिन यहां एक उच्च स्कोर है\n"
            ...
            (
                ...
                "फेंक ताकत आपके द्वारा धारित दिशा पर आधारित है।\n"
            ...
            (
                ...
                "साउंडट्रैक से थक गए? अपनी स्वयं की वस्तु से इसे प्रतिस्थापित करें!\n"
            ...
            (
                ...
                "आप बाएं या दाएं कताई करके अपने पेंच 'लक्ष्य' कर सकते हैं।\n"
            ...
            (
                ...
                "जब आप एक बम विस्फोट करने जा रहे हैं तो आप न्याय कर सकते हैं\n"
            ...
            (
                ...
                "जब आप चीजों पर अपना सिर फटकारते हैं तो आप नुकसान लेते हैं,\n"
    ...
    "wiimoteLicenseWindow": {"titleText": "डार्विन रिमोट  कॉपीराइट"},
    "wiimoteListenWindow": {
    ...
    "wiimoteSetupWindow": {
        ...
        "listenText": "सुनें",
        "macInstructionsText": (
            "सुनिश्चित करें कि आपके मैक पर वाईआई बंद है और ब्लूटूथ सक्षम है, \n"
    ...
    "xbox360ControllersWindow": {
        ...
        "macInstructionsText": (
            "Xbox 360 नियंत्रकों का उपयोग करने के लिए,  \n"
        ...
        "ouyaInstructionsText": (
            "BombSquad के साथ वायर्ड Xbox 360 नियंत्रकों का उपयोग करने के लिए, \n"
