...
class NinjaFightGame(bs.TeamGameActivity):
    ...
    def getScoreInfo(cls):
        return {"scoreType": "milliseconds", "lowerIsBetter": True, "scoreName": "Time"}
    ...
    def onBegin(self):
        ...
        bs.gameTimer(
            1000,
            bs.Call(self._bots.spawnBot, bs.NinjaBot, pos=(3, 3, -2), spawnTime=3000),
        )
        bs.gameTimer(
            2000,
            bs.Call(self._bots.spawnBot, bs.NinjaBot, pos=(-3, 3, -2), spawnTime=3000),
        ...
        bs.gameTimer(
            3000,
            bs.Call(self._bots.spawnBot, bs.NinjaBot, pos=(5, 3, -2), spawnTime=3000),
        )
        bs.gameTimer(
            4000,
            bs.Call(self._bots.spawnBot, bs.NinjaBot, pos=(-5, 3, -2), spawnTime=3000),
        ...
        if len(self.initialPlayerInfo) > 2 or isPro:
            bs.gameTimer(
                5000,
                bs.Call(
                    self._bots.spawnBot, bs.NinjaBot, pos=(0, 3, -5), spawnTime=3000
                ),
            )
        if len(self.initialPlayerInfo) > 3 or isPro:
            bs.gameTimer(
                6000,
                bs.Call(
                    self._bots.spawnBot, bs.NinjaBot, pos=(0, 3, 1), spawnTime=3000
                ),
            )
