...
values = {
    "accountSettingsWindow": {
        ...
        "resetProgressConfirmText": (
            "Această acțiune va reseta progresul\n"
        ...
        "signInInfoText": (
            "Conectează-te pentru a colecta bilete, a juca online,\n"
    ...
    "buttonText": "buton",
    "canWeDebugText": (
        "Ai dori ca BombSquad să trimită automat bug-uri,\n"
    ...
    "configGamepadWindow": {
        ...
        "secondHalfText": (
            "Foloseşte această opțiune pentru a configura\n"
    ...
    "configKeyboardWindow": {
        ...
        "keyboard2NoteText": (
            "Notă: multe tastaturi pot inregistra doar câteva apăsări\n"
    ...
    "configTouchscreenWindow": {
        ...
        "swipeInfoText": (
            'Modul "swipe" are nevoie de puțin antrenament, dar e mai\n'
    ...
    "connectMobileDevicesWindow": {
        ...
        "bestResultsText": (
            "Pentru cele mai bune rezultate vei avea nevoie de o rețea Wi-Fi \n"
        ...
        "explanationText": (
            "Pentru a folosi un telefon inteligent sau o tabletă drept controller, instalează\n"
        ...
        "getItForText": (
            "Ia-ți ${REMOTE_APP_NAME} pentru iOS din Apple App Store\n"
    ...
    "coopSelectWindow": {
        ...
        "challengesInfoText": (
            "Primeşte premii pentru completarea minijocurilor.\n"
            "\n"
        ...
        "welcome1Text": (
            "Bine ai venit la ${LEAGUE}. Poți să-ți măreşti\n"
            "rankul prin completarea medaliilor, câştigând trofee\n"
            "in concursuri şi prin rankul de 3 stele la jocuri."
        ),
        "welcome2Text": (
            "Mai poți primii bilete şi prin alte activități de acelaşi fel.\n"
    ...
    "difficultyHardUnlockOnlyText": (
        'Acest nivel poate fi deblocat doar pe "Greu".\n' "Crezi că poți s-o faci?!?!"
    ),
    ...
    "editProfileWindow": {
        ...
        "globalProfileInfoText": (
            "Profilurile globale de playeri sunt garantate \n"
        ...
        "localProfileInfoText": (
            "Profilurile locale nu au imagini şi numele lor nu sunt \n"
    ...
    "failText": "Eșuare",
    "fatalErrorText": (
        "Oh nu; ceva lipseşte sau este stricat.\n"
    ...
    "gameSettingsWindow": {"addGameText": "Adaugă joc"},
    "gamesToText": "${WINCOUNT} jocuri la ${LOSECOUNT}",
    "gatherWindow": {
        "aboutDescriptionLocalMultiplayerExtraText": (
            "Ține minte: orice dispozitiv din grup poate avea\n"
            "mai mult de un jucător dacă sunt destule controllere."
        ),
        "aboutDescriptionText": (
            "Folosește aceste tab-uri pentru a asambla un grup.\n"
            "\n"
        ...
        "appInviteInfoText": (
            "Invită-ți prietenii să încerce BombSquad și\n"
        ...
        "disconnectClientsText": (
            "Aceasta va deconecta ${COUNT} jucător(i) din\n"
            "grupul tău curent. Ești sigur?"
        ),
        "earnTicketsForRecommendingAmountText": (
            "Prietenii vor primii ${COUNT} tichete daca vor incerca jocul \n"
        ...
        "googlePlayReInviteText": (
            "Sunt ${COUNT} jucători Google Play în grupul tău care vor\n"
        ...
        "inviteAFriendText": (
            "Prietenii nu au jocul? Invită-i să-l\n"
        ...
        "wifiDirectDescriptionTopText": (
            "Wi-Fi direct se poate folosi pentru conectarea dispozitivelor Android fără\n"
    ...
    "getTicketsWindow": {
        ...
        "unavailableLinkAccountText": (
            "Scuze, dar cumpăratul nu funcționează pe această platformă.\n"
    ...
    "helpWindow": {
        ...
        "controllersInfoText": (
            "Poți juca BombSquad cu prietenii peste o rețea, sau dacă aveți\n"
        ...
        "controlsText": "Controluri",
        "devicesInfoText": (
            "Versiunea VR a jocului poate fi jucată peste rețea cu versiunea\n"
        ...
        "friendsGoodText": (
            "E bine să ai și de-aceștia. ${APP_NAME} e și mai amuzant cu mai\n"
        ...
        "powerupBombDescriptionText": (
            "Te lasă să poți arunca 3 bombe\n" "deodată în loc de numai una."
        ),
    ...
    "installDiskSpaceErrorText": (
        "EROARE: Nu s-a putut completa instalarea.\n"
    ...
    "internal": {
        ...
        "joinedPartyInstructionsText": (
            "Un prieten a venit la petrecerea ta.\n"
        ...
        "vrOrientationResetCardboardText": (
            "Foloseşte această opțiune pentru a reseta orientatea RV.\n"
    ...
    "mustInviteFriendsText": (
        "Notă: trebuie să inviți prieteni pe \n"
    ...
    "noProfilesErrorText": (
        "Nu ai niciun Profil de Jucător, deci eşti blocat cu '${NAME}'.\n"
    ...
    "pleaseRateText": (
        "Dacă îți place BombSquad, consideră să-ți iei un moment să\n"
    ...
    "ps3ControllersWindow": {
        "macInstructionsText": (
            "Închide sursa de putere din spatele PS3-ului, asigură-te că \n"
        ...
        "ouyaInstructionsText": (
            "Pentru a folosi un controller de PS3 cu OUYA-ul tău, conectează-l simplu printr-un cablu USB\n"
    ...
    "remote_app": {
        ...
        "connected": "Conectat.",
        "description": (
            "Folosește-ți telefonul sau tableta ca un controller pt. BombSquad.\n"
        ...
        "searching_caption": (
            "Apasă pe numele unui joc pentru a intra în el.\n"
    ...
    "replayVersionErrorText": (
        "Scuze, această reluare a fost făcută în altă versiune\n"
    ...
    "reportPlayerExplanationText": (
        "Foloseşte acest email pentru a raporta trişări, limbaj licențios, sau alte tipuri de comportament rău.\n"
    ...
    "settingsWindowAdvanced": {
        ...
        "helpTranslateText": (
            "Translatările BombSquad sunt un efort depus de comunitate.\n"
    ...
    "store": {
        ...
        "freeBombSquadProText": (
            "BombSquad este acum gratis, dar fiindcă tu l-ai cumpărat primeşti upgrade-ul \n"
    ...
    "translations": {
        ...
        "gameDescriptions": {
            (
                ...
                "Fi ales pentru o perioadă de timp pentru a câştiga.\n"
        ...
        "inputDeviceNames": {"Keyboard": "Tastatură", "Keyboard P2": "Tastatură 2"},
        "languages": {
        ...
        "playlistNames": {"Just Epic": "Doar Epic", "Just Sports": "Doar Sporturi"},
        "scoreNames": {
            "Flags": "Steaguri",
            "Goals": "Goluri",
            "Score": "Scor",
        ...
        "serverResponses": {
            ...
            (
                ...
                "Eşti sigur că vrei să conectezi aceste 2 conturi?\n"
                "\n"
                "${ACCOUNT1}\n"
                "${ACCOUNT2}\n"
                "\n"
            ...
            (
                ...
                "Ai primit ${COUNT} de bilete pentru conectare.\n"
            ...
            (
                ...
                "Copia ta de joc a fost modificată.\n"
        ...
        "tips": {
            (
                ...
                "O lovitură alergat-sărit-rotit-pumn perfect sincronizată poate omorî\n"
            ...
            (
                ...
                "Creează-ți profile de jucător pentru tine şi prietenii tăi cu\n"
            ...
            (
                ...
                "Blestemele te transformă înntr-o bombă cu timp.\n"
            ...
            (
                ...
                "Înafară de look-ul lor, toate caracterele au abilități identice,\n"
            ...
            (
                ...
                "Ține apăsat orice buton pentru a fugi. Vei ajunge mai repede unde vrei,\n"
            ...
            (
                ...
                "Bombele de gheață nu sunt foarte puternice, dar îngheață\n"
            ...
            (
                ...
                "Dacă cineva te ia pe sus, dă-i cu pumnul şi te va lăsa.\n"
            ...
            (
                ...
                "Dacă nu ai destule controllere, instalează 'BombSquad Remote' pe\n"
            ...
            (
                ...
                "Dacă ți s-a lipit o bombă lipicoasă de tine, sari și învârte-te în cercuri. S-ar\n"
            ...
            (
                ...
                "Dacă atingi un Blestem, singura ta şansă de viața este să\n"
            ...
            (
                ...
                "Dacă ai foarte mulți jucători care vin continuu, porneşte 'Dă afară jucătorii care nu fac nimic'\n"
            ...
            (
                ...
                "Dacă dispozitivul tău se încăljeşte prea tare sau ai vrea să conservezi baterie,\n"
            ...
            (
                ...
                "Dacă jocul rulează mai încet, încearcă să dai mai jos rezoluția \n"
            ...
            (
                ...
                "În Capturează-Steagul, steagul tău trebuie să fie la baza ta pentru a înscrie. Dacă\n"
            ...
            (
                ...
                "Multe lucruri pot fi ridicate şi aruncate, inclusiv alți jucători. Aruncarea\n"
            ...
            (
                ...
                "Jucătorii pot intra şi ieşii în mijlocul jocului,\n"
            ...
            (
                ...
                "Pumnii cauzează mai multe daune când te mişti,\n"
            ...
            (
                ...
                "Acest nivel nu se termină niciodată, dar un scor mare\n"
            ...
            (
                ...
                "Puterea aruncării este bazată pe direcția care o ții.\n"
            ...
            (
                ...
                "Eşti săturat de coloana sonoră? Schimbăl cu al tău!\n"
            ...
            (
                ...
                "Poți să dai cu pumnii în stânga sau dreapta dacă te învârți.\n"
            ...
            (
                ...
                "Poți să îti dai seama când o bombă va exploda dupa culoarea\n"
            ...
            (
                ...
                "Iei daune când iți trânteşti capul de lucruri,\n"
    ...
    "waveText": "Val",
    "wellSureText": "Sigur!",
    "wiimoteLicenseWindow": {"titleText": "Copyright Darwiinmote"},
    "wiimoteListenWindow": {
    ...
    "wiimoteSetupWindow": {
        ...
        "listenText": "Ascultă",
        "macInstructionsText": (
            "Asigură-te că Wii-ul e închis și Bluetooth e activat\n"
    ...
    "xbox360ControllersWindow": {
        ...
        "macInstructionsText": (
            "Pentru a folosi controalele Xbox 360, trebuie sa instalezi \n"
            "driver-ul de Mac disponibil in link-ul de mai jos. \n"
            "Functioneaza pentru controalele cu si fara fir."
        ),
        "ouyaInstructionsText": (
            "Pentru a folosi controllere X-Box 360 cu fir, pur și simplu\n"
