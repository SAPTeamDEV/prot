...
values = {
    "accountSettingsWindow": {
        ...
        "linkAccountsInstructionsNewText": (
            "Para vincular duas contas, gere um código na primeira\n"
        ...
        "linkAccountsInstructionsText": (
            "Para vincular duas contas, gere um código\n"
        ...
        "setAccountNameDesc": (
            "Escolha o nome que será exibido na sua conta.\n"
            "Você pode usar o nome de uma de suas contas\n"
            "ou criar um nome personalizado exclusivo."
        ),
        "signInInfoText": (
            "Inicie a sessão para ganhar bilhetes, compita online e compartilhe\n"
        ...
        "testAccountWarningCardboardText": (
            'Atenção: você está entrando com uma conta "teste".\n'
        ...
        "testAccountWarningOculusText": (
            'Aviso: você está conectando com uma "conta de teste".\n'
        ...
        "testAccountWarningText": (
            'Aviso: você está conectando com uma "conta teste".\n'
    ...
    "allowText": "Permitir",
    "alreadySignedInText": (
        "Sua conta está logada em outro dispositivo;\n"
    ...
    "buttonText": "botão",
    "canWeDebugText": (
        "Gostaria que BombSquad reportasse erros, falhas e \n"
    ...
    "configGamepadSelectWindow": {
        ...
        "pressAnyButtonText": (
            "Aperte qualquer botão no controle\n" "que você deseja configurar..."
        ),
    ...
    "configKeyboardWindow": {
        ...
        "keyboard2NoteText": (
            "Nota: a maioria dos teclados só podem registrar\n"
    ...
    "configTouchscreenWindow": {
        ...
        "swipeInfoText": (
            "O estilo 'Deslize' do controle leva um tempo para se acostumar, mas\n"
    ...
    "connectMobileDevicesWindow": {
        ...
        "bestResultsText": (
            "Para melhores resultados, é necessário uma rede Wi-Fi\n"
        ...
        "explanationText": (
            "Para usar um telefone ou tablet como controle,\n"
        ...
        "forIOSText": "para iOS:",
        "getItForText": (
            "Baixe ${REMOTE_APP_NAME} para iOS na Apple App Store\n"
    ...
    "coopSelectWindow": {
        ...
        "activenessInfoText": (
            "Este multiplicador aumenta nos dias que você joga\n"
            "e diminui nos dias que você não joga."
        ),
        "activityText": "Atividade",
        "campaignText": "Campanha",
        "challengesInfoText": (
            "Ganhe prêmios por completar minijogos.\n"
            "\n"
        ...
        "totalText": "total",
        "tournamentInfoText": (
            "Jogue para ser o melhor contra\n"
        ...
        "welcome1Text": (
            "Bem-vindo à ${LEAGUE}. Você pode melhorar a sua\n"
            "classificação de liga ao receber estrelas, ao obter\n"
            "conquistas e ao ganhar troféus em torneios."
        ),
        "welcome2Text": (
            "Você também pode ganhar bilhetes ao fazer várias dessas atividades.\n"
    ...
    "creditsWindow": {
        ...
        "creditsText": (
            "  Codificação, Gráficos, e Áudio por Eric Froemling\n"
            "  \n"
    ...
    "difficultyHardUnlockOnlyText": (
        "Esta fase só pode ser desbloqueada no modo difícil.\n"
    ...
    "editProfileWindow": {
        "accountProfileInfoText": (
            "Este perfil especial tem nome e\n"
        ...
        "globalProfileInfoText": (
            "Garante-se que perfis globais tenham nomes\n"
        ...
        "localProfileInfoText": (
            "Os perfis locais não possuem ícones e não se garante que seus\n"
        ...
        "upgradeProfileInfoText": (
            "Isso irá reservar o nome do seu jogador mundialmente\n"
    ...
    "failText": "Falhou",
    "fatalErrorText": (
        "Ops; algo está faltando ou está corrompido.\n"
    ...
    "fireTVRemoteWarningText": (
        "* Para uma melhor experiência, use\n"
    ...
    "gameSettingsWindow": {"addGameText": "Adicionar jogo"},
    ...
    "gatherWindow": {
        "aboutDescriptionLocalMultiplayerExtraText": (
            "Lembre-se: qualquer dispositivo em uma sala pode ter\n"
            "mais de um jogador se você tiver outros controles."
        ),
        "aboutDescriptionText": (
            "Use estas guias para montar uma sala.\n"
            "\n"
        ...
        "disconnectClientsText": (
            "Você está prestes a desconectar o(s) ${COUNT}\n"
            "jogador(es) da sua sala. Tem certeza?"
        ),
        "earnTicketsForRecommendingAmountText": (
            "Os amigos ganharão ${COUNT} bilhetes ao experimentar o jogo\n"
        ...
        "friendPromoCodeInstructionsText": (
            'Para usar, abra ${APP_NAME} e vá até "Configurações-> Avançado-> Inserir código".\n'
        ...
        "googlePlayReInviteText": (
            "Há ${COUNT} jogador(es) do Google Play na sua sala\n"
        ...
        "inviteAFriendText": (
            "Seus amigos ainda não têm o jogo? Convide para\n"
        ...
        "wifiDirectDescriptionBottomText": (
            "Se todos os dispositivos tiverem 'Wi-Fi Direct', poderão usar para encontrar\n"
        ...
        "wifiDirectDescriptionTopText": (
            "Wi-Fi Direct pode conectar dispositivos Android sem a necessidade\n"
    ...
    "getTicketsWindow": {
        ...
        "unavailableLinkAccountText": (
            "Desculpe, as compras não estão disponíveis nesta plataforma.\n"
    ...
    "helpWindow": {
        ...
        "controllersInfoText": (
            "Você pode jogar ${APP_NAME} com amigos em uma rede, ou todos \n"
        ...
        "controllersInfoTextFantasia": (
            "Um jogador pode usar o controle remoto como controle, mas controles para games\n"
        ...
        "controllersInfoTextMac": (
            "Um ou dois jogadores podem usar o teclado, mas BombSquad é melhor com gamepads.\n"
        ...
        "controllersInfoTextOuya": (
            "Você pode usar controles OUYA, controles PS3, controles Xbox 360,\n"
        ...
        "devicesInfoText": (
            "A versão VR de ${APP_NAME} pode ser jogada em rede com\n"
        ...
        "friendsGoodText": (
            "São sempre boas companhias. ${APP_NAME} é mais divertido com muitos\n"
    ...
    "installDiskSpaceErrorText": (
        "ERRO: Não pôde concluir a instalação.\n"
    ...
    "internal": {
        ...
        "connectionFailedVersionMismatchText": (
            "A conexão falhou; o anfitrião está rodando uma versão diferente do jogo.\n"
        ...
        "touchScreenJoinWarningText": (
            "Você entrou com o modo touchscreen.\n"
        ...
        "vrOrientationResetCardboardText": (
            "Use para reiniciar a orientação do VR.\n"
    ...
    "macControllerSubsystemMFiNoteText": (
        "Feito para iOS/Mac controle detectado ;\n"
    ...
    "mustInviteFriendsText": (
        "Nota: você deve convidar amigos no\n"
    ...
    "newTestBuildAvailableText": (
        "Uma nova versão de teste está disponível! (${VERSION} teste ${BUILD}).\n"
        "Adquira em ${ADDRESS}"
    ),
    "newText": "Novo",
    ...
    "ownFlagAtYourBaseWarning": (
        "Sua própria bandeira deve estar\n" "em sua base para fazer um ponto!"
    ),
    ...
    "pleaseRateText": (
        "Se você está curtindo ${APP_NAME}, por favor, dê um tempinho\n"
    ...
    "profileInfoText": (
        "Crie perfis para você e seus amigos\n"
    ...
    "ps3ControllersWindow": {
        "macInstructionsText": (
            "Desligue a energia na parte traseira do seu PS3, verifique se\n"
        ...
        "ouyaInstructionsText": (
            "Para usar um controle de PS3 com seu OUYA, basta conectá-lo com um cabo USB\n"
    ...
    "remoteAppInfoShortText": (
        "${APP_NAME} é mais divertido quando é jogado com família e amigos.\n"
    ...
    "remote_app": {
        ...
        "connected": "Conectado.",
        "description": (
            "Use seu telefone ou tablet como controle com BombSquad.\n"
        ...
        "searching_caption": (
            "Clique em uma partida para entrar.\n"
    ...
    "reportPlayerExplanationText": (
        "Use este e-mail para denunciar trapaças, linguagem inapropriada, ou outro comportamento ruim.\n"
    ...
    "settingsWindowAdvanced": {
        ...
        "helpTranslateText": (
            "As traduções do ${APP_NAME} são sustentadas pelo\n"
    ...
    "signInWithGameCenterText": (
        "Para usar uma conta Game Center,\n"
    ...
    "store": {
        ...
        "bombSquadProDescriptionText": (
            "• Duplica os tickets ganhos em desafios\n"
        ...
        "bombSquadProNewDescriptionText": (
            "• Remove anúncios no jogo e nas telas\n"
        ...
        "freeBombSquadProText": (
            "BombSquad agora é gratuito, mas já que você já tinha comprado ele\n"
    ...
    "translations": {
        ...
        "gameDescriptions": {
            (
                ...
                "Seja o escolhido por um período de tempo para vencer.\n"
        ...
        "serverResponses": {
            ...
            (
                ...
                "Tem certeza de que deseja vincular estas contas?\n"
                "\n"
                "${ACCOUNT1}\n"
                "${ACCOUNT2}\n"
                "\n"
            ...
            (
                ...
                "VINCULAÇÃO NEGADA. ${ACCOUNT} contém\n"
            ...
            (
                ...
                "Vincular conta ${ACCOUNT} com essa conta?\n"
            ...
            (
                ...
                "Recebeu ${COUNT} tickets por entrar.\n"
            ...
            (
                ...
                "A funcionalidade do servidor não é mais compatível nesta versão do jogo;\n"
            ...
            (
                ...
                "Desvincular ${ACCOUNT} dessa conta?\n"
            ...
            (
                ...
                "ATENÇÃO: denúncias sobre você estar usando hack foram feitas.\n"
            ...
            (
                ...
                "Sua copia do jogo foi modificada.\n"
        ...
        "tips": {
            (
                ...
                "Se você bater, correr, pular e girar em perfeita sincronia poderá matar\n"
            ...
            (
                ...
                "Crie perfis de jogadores para você e seus amigos com\n"
            ...
            (
                ...
                "Caixas amaldiçoadas o transformam em uma bomba-relógio.\n"
            ...
            (
                ...
                "Apesar de suas aparências, as habilidades de todos os personagens são idênticas,\n"
            ...
            (
                ...
                "Mantenha pressionado qualquer botão para correr. Você vai alcançar lugares mais\n"
            ...
            (
                ...
                "As bombas de gelo não são muito poderosas, mas elas congelam\n"
            ...
            (
                ...
                "Se alguém te levantar, soque-o e ele irá te largar.\n"
            ...
            (
                ...
                "Se você está sem controles, instale o aplicativo '${REMOTE_APP_NAME}'\n"
            ...
            (
                ...
                "Se você estiver com controles insuficientes, instale o aplicativo 'BombSquad Remote'\n"
            ...
            (
                ...
                "Se você tiver uma bomba grudenta presa em você, salte e gire em círculos. Você pode\n"
            ...
            (
                ...
                "Se você pegar uma maldição, sua única esperança de sobrevivência é\n"
            ...
            (
                ...
                "Se você tem muitos jogadores entrando e saindo, ligue 'Expulsar Jogadores Ociosos Automaticamente'\n"
            ...
            (
                ...
                "Se seu dispositivo ficar muito quente ou você quiser conservar bateria,\n"
            ...
            (
                ...
                "Se sua taxa de quadros estiver baixa, tente diminuir a resolução\n"
            ...
            (
                ...
                "Em Capture a bandeira, a sua própria bandeira deve estar em sua base para marcar. Se a outra\n"
            ...
            (
                ...
                "Muitas coisas podem ser apanhadas e lançadas, incluindo outros jogadores. Jogar\n"
            ...
            (
                ...
                "Jogadores podem entrar e sair no meio da maioria dos jogos,\n"
            ...
            (
                ...
                "Os jogadores podem entrar e sair no meio da maioria dos jogos,\n"
            ...
            (
                ...
                "Poderes só tem limite de tempo no modo cooperativo.\n"
            ...
            (
                ...
                "Socos fazem mais danos quanto mais rápido os punhos estão se movendo,\n"
            ...
            (
                ...
                "Corra para frente e para trás antes de arremessar uma bomba\n"
                "para 'chicoteá-la' e jogá-la longe."
            ),
            ("Take out a group of enemies by\n" "setting off a bomb near a TNT box."): (
                "Elimine um grupo de inimigos ao\n"
            ...
            (
                ...
                "A cabeça é a área mais vulnerável, portanto uma bomba grudenta\n"
            ...
            (
                ...
                "Este nível nunca termina, mas uma alta pontuação aqui\n"
            ...
            (
                ...
                "Força de arremesso baseia-se na direção em que você está pressionando.\n"
            ...
            (
                ...
                "Cansado das músicas? Troque-as pelas suas próprias!\n"
            ...
            (
                ...
                "Você pode 'mirar' seus socos girando para esquerda ou direita.\n"
            ...
            (
                ...
                "Você pode avaliar quando uma bomba vai explodir baseado na\n"
            ...
            (
                ...
                "Você não precisa editar seu perfil para mudar de personagem; É só pressionar\n"
            ...
            (
                ...
                "Você se fere quando você bate sua cabeça em coisas,\n"
    ...
    "trialPeriodEndedText": (
        "Seu período experimental terminou. Gostaria\n"
    ...
    "wiimoteSetupWindow": {
        ...
        "listenText": "Procurar",
        "macInstructionsText": (
            "Certifique-se de que o seu Wii está desligado e o Bluetooth\n"
    ...
    "xbox360ControllersWindow": {
        ...
        "macInstructions2Text": (
            "Para usar os controles sem fio, você também precisará de um receptor\n"
        ...
        "macInstructionsText": (
            "Para usar os controles do Xbox 360, você precisará instalar\n"
            "o driver Mac disponível no link abaixo.\n"
            "Isso funciona com ambos os controles com e sem fios."
        ),
        "macInstructionsTextScale": 0.8,
        "ouyaInstructionsText": (
            "Para usar os controles com fio do Xbox 360 com BombSquad, basta\n"
