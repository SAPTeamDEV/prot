...
values = {
    "accountSettingsWindow": {
        ...
        "linkAccountsInstructionsNewText": (
            "Két fiók összekapcsolásához először hozzon létre egy kódot\n"
        ...
        "linkAccountsInstructionsText": (
            "Hogy párosíts két profilt, generálj egy kódot\n"
        ...
        "setAccountNameDesc": (
            "Válassza ki a megjeleníteni kívánt fiók nevét.\n"
            "Használhatja a nevét az egyik kapcsoltól\n"
            "fiókokat, vagy egyedi egyedi nevet hozhat létre."
        ),
        "signInInfoText": (
            "Lépj be, hogy tudj jegyeket gyűjteni, online versenyezni\n"
        ...
        "testAccountWarningCardboardText": (
            'Vigyázat:egy "teszt" fiókkal lépsz be.\n'
        ...
        "testAccountWarningOculusText": (
            'Figyelmeztetés: egy "teszt" felhasználóval jelentkezel be.\n'
    ...
    "buttonText": "Gomb",
    "canWeDebugText": (
        "Szeretnéd, ha a BombSquad automatikusan jelentené a hibákat, \n"
    ...
    "configGamepadSelectWindow": {
        ...
        "pressAnyButtonText": (
            "Nyomj akármilyen gombot a vezérlőn\n" "amit be akarsz állítani..."
        ),
    ...
    "configGamepadWindow": {
        ...
        "secondHalfText": (
            "Használd ezt ,hogy beállítsd a második felét \n"
    ...
    "configKeyboardWindow": {
        ...
        "keyboard2NoteText": (
            "A legtöbb billentyűzet csak pár gombnyomást érzékel egyszerre,\n"
    ...
    "configTouchscreenWindow": {
        ...
        "swipeInfoText": (
            "A 'Nyilak' stílushoz hozzá kell szokni \n"
    ...
    "connectMobileDevicesWindow": {
        ...
        "bestResultsText": (
            "A legjobb eredményért szükséged lesz egy lag-mentes Wi-fi hálózatra.\n"
        ...
        "explanationText": (
            "Hogy az okos telefonodat vagy a tableted használni tudd mint vezeték nélküli kontroller,\n"
        ...
        "forIOSText": "iOS-hez:",
        "getItForText": (
            "Töltsd le a ${REMOTE_APP_NAME} alkalmazást iOS-hez, az Apple\n"
    ...
    "coopSelectWindow": {
        ...
        "activenessInfoText": (
            "Ez a szorzó növekszik mikor naponta játszol,\n"
            "de kihagyott napok után viszont csökkenni fog."
        ),
        "activityText": "Aktivitás",
        "campaignText": "Kampány",
        "challengesInfoText": (
            "Nyerj nyereményeket mini-játékok megcsinálásával.\n"
            "\n"
        ...
        "tournamentInfoText": (
            "Versenyez a legjobb eredményeiddel\n"
        ...
        "welcome1Text": (
            "Üdv a ${LEAGUE} Ligában. Fejlesztheted a liga \n"
            "helyezésedet azzal, hogy csillagokat, teljesítményeket \n"
            "szerzel vagy akár megnyered a mérkőzéseket."
        ),
        "welcome2Text": (
            "Jegyeket is szerezhetsz. A jegyekkel beléphetsz mérkőzésekbe,\n"
    ...
    "creditsWindow": {
        ...
        "songCreditText": (
            "${PERFORMER} előadásával a(z) ${TITLE}\n"
    ...
    "difficultyHardUnlockOnlyText": (
        "Ezt a szintet csak nehéz módban lehet feloldani.\n"
    ...
    "editProfileWindow": {
        "accountProfileInfoText": (
            "Ez a különleges profil rendelkezik névvel,\n"
        ...
        "localProfileInfoText": (
            "Alkalmi játékos profilok nem rendelkeznek ikonokkal és lehet,\n"
    ...
    "failText": "Bukta",
    "fatalErrorText": (
        "Ajajj; valami hiányzik vagy megsérült.\n"
    ...
    "fireTVRemoteWarningText": (
        "A jobb játékélményért, használj\n"
    ...
    "gameSettingsWindow": {"addGameText": "Játék Hozzáadása"},
    "gamesToText": "${WINCOUNT} játék a ${LOSECOUNT}-hez/hoz/höz",
    "gatherWindow": {
        "aboutDescriptionLocalMultiplayerExtraText": (
            "Emlékezz: néhány eszköz a társaságban, több mint\n"
            "egy játékost is kezelhet, ha van elég vezérlő hozzá."
        ),
        "aboutDescriptionText": (
            "Használd ezeket a füleket, hogy összegyűjts egy társaságot.\n"
            "\n"
        ...
        "appInviteInfoText": (
            "Hívj meg barátokat hogy kipróbálják a BombSquad-ot és ők\n"
        ...
        "disconnectClientsText": (
            "Ez le fogja csatlakoztatni a ${COUNT} játékost\n"
            "a társaságodból. Biztos vagy benne?"
        ),
        "earnTicketsForRecommendingAmountText": (
            "A barátaid kapni fognak ${COUNT} jegyet ha kipróbálják a játékot\n"
        ...
        "friendPromoCodeInstructionsText": (
            'Hogy használhasd, nyisd meg a ${APP_NAME}-ot, menj a "Beállítások->Haladó>Promóciós Kód Beírása" menüpontba.\n'
        ...
        "googlePlayReInviteText": (
            "Van ${COUNT} Google Play játékos a társaságodban\n"
        ...
        "inviteAFriendText": (
            "Nincs meg a barátoknak a játék? Hívd meg őket,\n"
        ...
        "wifiDirectDescriptionBottomText": (
            "Ha minden eszköznek van 'Wi-Fi Direct' panelje, akkor meg kellene találniuk és \n"
        ...
        "wifiDirectDescriptionTopText": (
            "Wi-Fi Direct-t arra is lehet használni, hogy Android eszközön közvetlenül, Wi-Fi hálózat\n"
    ...
    "getTicketsWindow": {
        ...
        "unavailableLinkAccountText": (
            "Sajnálom, a vásárlások ezen az eszközön nem elérhetőek.\n"
    ...
    "helpWindow": {
        ...
        "controllersInfoText": (
            "Játszhatsz ${APP_NAME}-ot a barátaiddal egy hálózaton keresztül, vagy\n"
        ...
        "controlsText": "Irányítás",
        "devicesInfoText": (
            "A VR verziós ${APP_NAME} játszható hálózaton keresztül a sima verzióval,\n"
        ...
        "friendsGoodText": (
            "Jó ha vannak. A ${APP_NAME} akkor a legszórakoztatóbb, hogy ha másokkal játszol,\n"
    ...
    "installDiskSpaceErrorText": (
        "Hiba: Nem lehet teljesíteni a telepítést.\n"
    ...
    "internal": {
        ...
        "connectionFailedVersionMismatchText": (
            "Csatlakozás nem sikerült; a kiszolgáló a játék másik verzióját futtatja.\n"
        ...
        "touchScreenJoinWarningText": (
            "Az érintőképernyővel csatlakoztál.\n"
        ...
        "vrOrientationResetCardboardText": (
            "Használd ezt, hogy visszaállíts a VR orientációkat.\n"
    ...
    "mustInviteFriendsText": (
        "Jegyezd meg: meg kell hívnod a barátaidat \n"
    ...
    "newTestBuildAvailableText": (
        "Egy újabb teszt szerkezet elérhető! (${VERSION} build ${BUILD}).\n"
    ...
    "noProfilesErrorText": (
        "Nincs játékos profilod, tehát te most '${NAME}'-val nyomulsz.\n"
    ...
    "pleaseRateText": (
        "Ha élvezed a játékot, kérlek értékeld, vagy írj egy\n"
    ...
    "ps3ControllersWindow": {
        "macInstructionsText": (
            "Kapcsold ki a PS3-dat majd ellenőrizd ,hogy a MAC-eden \n"
        ...
        "ouyaInstructionsText": (
            "Ha PS3 kontrollert szeretnél használni az OUYA-hoz egyszerűen \n"
    ...
    "remoteAppInfoShortText": (
        "A ${APP_NAME} akkor a legjobb hogyha a barátaiddal játszod.\n"
    ...
    "remote_app": {
        ...
        "description": (
            "Használd a telefonod vagy tableted egy irányítóként a BombSqaud-hez.\n"
        ...
        "searching_caption": (
            "Nyomj annak a játéknak a nevére amelynez csatlakozni akarsz.\n"
    ...
    "replayVersionErrorText": (
        "Hiba: Ez a visszajátszás még a régebbi verzióval\n"
    ...
    "reportPlayerExplanationText": (
        "Használd ezt az emailt hogy feljelents csalást, trágár nyelhasználatot , vagy más szabálysért.\n"
        "Kérlek ide írd:"
    ),
    ...
    "settingsWindowAdvanced": {
        ...
        "helpTranslateText": (
            "A ${APP_NAME} nem Angol fordításait a közösség végzi.\n"
    ...
    "signInWithGameCenterText": (
        "Hogy használd a Játék Központ felhasználódat\n"
    ...
    "store": {
        ...
        "bombSquadProDescriptionText": (
            "-Megduplázza a jegyek szerzését az eredményekért\n"
        ...
        "freeBombSquadProText": (
            "A BombSquad most ingyenes, de mivel te eredetileg megvetted, ezért \n"
    ...
    "translations": {
        ...
        "gameDescriptions": {
            (
                ...
                "Légy a kiválasztott egy ideig hogy nyerj.\n"
        ...
        "playlistNames": {"Just Epic": "Csak Hatalmas", "Just Sports": "Csak Sportok"},
        "scoreNames": {
            "Flags": "Zászlók",
            "Goals": "Gólok",
            "Score": "Pontok",
        ...
        "serverResponses": {
            ...
            (
                ...
                "Össze akarod kötni ezt a két fiókot?\n"
                "\n"
                "${ACCOUNT1}\n"
                "${ACCOUNT2}\n"
                "\n"
            ...
            (
                ...
                "Összekötöd a/az ${ACCOUNT} fiókot ehhez a fiókhoz?\n"
            ...
            (
                ...
                "${COUNT} jegy megkapva a bejelentkezés miatt.\n"
            ...
            (
                ...
                "A szerver nem működik a játék jelenlegi verziójával; \n"
        ...
        "tips": {
            (
                ...
                "Egy tökéletesen időzített futás-ugrás-pörgés-ütés kombináció azonnal képes ölni\n"
            ...
            (
                ...
                "Csinálj játékos profilokat magadnak és a barátaidnak,\n"
            ...
            (
                ...
                "Az átok doboz visszaszámlálós bombává tesz téged.\n"
            ...
            (
                ...
                "Annak ellenére ,hogy a karakterek másképp néznek ki a képességük azonosak,\n"
            ...
            (
                ...
                "A futáshoz, nyomj meg egy gombot. Gyorsabb leszel,\n"
            ...
            (
                ...
                "Jégbombák nem a legerősebbek, de ha valakit eltalál\n"
            ...
            (
                ...
                "Ha valaki felvesz a hátára, csak üsd meg és elfog engedni.\n"
            ...
            (
                ...
                "Ha nincs elég kontrollered, töltsd le a '${REMOTE_APP_NAME}' alkalmazást\n"
            ...
            (
                ...
                "HA nincs kontrollered ,telepítsd a BombSquad Remote alkalmazást \n"
            ...
            (
                ...
                "Ha egy ragadós bomba rád ragadna,ugrálj és forogj \n"
            ...
            (
                ...
                "Ha felveszel egy átok dobozt csak egy esélyed van a túlélésre \n"
            ...
            (
                ...
                "Ha sok egy játékos csatlakozik le és fel kapcsold be a 'Tétlen Játékosok Kirúgása'-t\n"
            ...
            (
                ...
                "Ha a telefonod híján van az energiának és szeretnél több energiát megtartani \n"
            ...
            (
                ...
                "Ha az FPS-ed túl kicsi lenne próbáld meg lejjebb venni\n"
            ...
            (
                ...
                "A Szerezd meg a Zászlót játékban, ahhoz, hogy pontot szerezz a zászlódnak a bázisodon kell lennie,\n"
            ...
            (
                ...
                "Rengeteg dolog fogható meg és dobható el még a játékos.\n"
            ...
            (
                ...
                "A játékosok a legtöbb játékmódban akár a meccs közepén \n"
            ...
            (
                ...
                "Az ütések hatékonyabbak ha az öklöd mozog,\n"
            ...
            (
                ...
                "Menj vissza és fuss neki a bomba dobásnak\n"
                " így a bomba sokkal messzebre repül majd."
            ),
            ("Take out a group of enemies by\n" "setting off a bomb near a TNT box."): (
                "Iktass egyszerre egy egész csapatnyi ellenfelet\n"
            ...
            (
                ...
                "A fej a legsebezhetőbb rész, szóval egy fejre ragadt bomba \n"
            ...
            (
                ...
                "Ennek a pályának nincs vége, viszont a \n"
            ...
            (
                ...
                "Az erős dobás egyik alapja az irány nyomva tartása.\n"
            ...
            (
                ...
                "Unalmasak az alap zenék? Rakj be sajátot!\n"
            ...
            (
                ...
                "'Becélozhatod' űtésed azzal, hogy forogsz balra vagy jobbra.\n"
            ...
            (
                ...
                "Megtudod állapítani, hogy a bomba mikor fog robbani, a kanócon lévő\n"
            ...
            (
                ...
                "Sérülést szerzel, amikor beütöd a fejedet a dolgokba,\n"
    ...
    "wiimoteLicenseWindow": {"titleText": "DarwiinRemote Szerzői jog"},
    "wiimoteListenWindow": {
    ...
    "wiimoteSetupWindow": {
        ...
        "listenText": "Figyelj",
        "macInstructionsText": (
            "Bizonyosodj meg arról, hogy a Wii-d ki van kapcsolva és a bluetooth engedélyezve van\n"
    ...
    "xbox360ControllersWindow": {
        ...
        "macInstructions2Text": (
            "Hogy használj vezérlőket vezetéknélkül, szükséged lesz egy vevőre (reciever),\n"
        ...
        "macInstructionsText": (
            "Hogy használj xbox 360 vezérlőket, fel kell telepítened\n"
            "a Mac illesztő programot, ami elérhető a fenti link-en.\n"
            "Működik vezetékes, és vezetéknélküli vezérlőkkel is."
        ),
        "ouyaInstructionsText": (
            "Hogy használj xbox 360 vezérlőket a BombSquad-dal, szimplán\n"
