...
values = {
    "accountSettingsWindow": {
        ...
        "signInInfoText": (
            "Ensalutu por konservi vian progreson\n"
        ...
        "testAccountWarningCardboardText": (
            "Atentu: vi ensalutis per testa konto.\n"
        ...
        "testAccountWarningOculusText": (
            "Atentu: vi ensalutiĝis per test-konto.\n"
        ...
        "testAccountWarningText": (
            "Atentu: vi estas ensalutita per test-konto.\n"
    ...
    "buttonText": "butono",
    "canWeDebugText": (
        "Ĉu vi ŝatus ke BombSquad aŭtomate raportu cimojn,\n"
    ...
    "configGamepadSelectWindow": {
        ...
        "pressAnyButtonText": (
            "Premu ajnan butonon sur la regilo\n" " kiun vi volas konfigurigi..."
        ),
    ...
    "configGamepadWindow": {
        ...
        "secondHalfText": (
            "Uzu ĉi tion por konfiguri duan duonon\n"
    ...
    "configKeyboardWindow": {
        ...
        "keyboard2NoteText": (
            "Notu: plej multaj klavaroj nur registras kelkajn klavojn\n"
    ...
    "configTouchscreenWindow": {
        ...
        "swipeInfoText": (
            "Glittuŝaj regumoj bezonas iom da kutimiĝo, sed pli\n"
    ...
    "connectMobileDevicesWindow": {
        ...
        "explanationText": (
            "Por uzi poŝtelefonon aŭ tabletkomputilon kiel sendratan\n"
        ...
        "forIOSText": "por iOS:",
        "getItForText": (
            "Akiru BombSquad Remote por iOS en la aplikaĵvendejo de \n"
    ...
    "coopSelectWindow": {
        ...
        "activenessInfoText": (
            "Ĉi tiu multobligo supreniras en tagoj\n"
        ...
        "totalText": "entute",
        "welcome1Text": (
            "Bonvenon al ${LEAGUE}. Vi povas plibonigi vian\n"
            "ligan rankon gajnante stelajn rankojn, kompletante\n"
            "atingojn, kaj gajnante trofeojn en turniroj."
        ),
        "welcome2Text": (
            "Vi ankaŭ povas gajni biletojn per multaj de la samaj aktivaĵoj.\n"
    ...
    "gameSettingsWindow": {"addGameText": "Aldoni ludon"},
    ...
    "gatherWindow": {
        "aboutDescriptionLocalMultiplayerExtraText": (
            "Memoru: ajna aparato en ludantaro povas havi\n"
            "pli ol unu ludanto se vi havas sufiĉe da regiloj."
        ),
        "aboutDescriptionText": (
            "Uzu ĉi tiujn paĝojn por kunigi ludantaron.\n"
            "\n"
        ...
        "googlePlayReInviteText": (
            "Estas ${COUNT} ludanto(j) de Google Play en via ludantaro\n"
        ...
        "wifiDirectDescriptionBottomText": (
            "Se ĉiuj aparatoj havas panelon 'Wi-Fi Direct', ili devus povi uzi tion por trovi\n"
        ...
        "wifiDirectDescriptionTopText": (
            "Wi-Fi Direct povas esti uzata por konekti Android-aparatojn rekte sen\n"
    ...
    "helpWindow": {
        ...
        "controllersInfoText": (
            "Vi povas ludi BombSquad kun amikoj en reto, aŭ vi povas ĉiuj ludi\n"
        ...
        "controllersInfoTextFantasia": (
            "Unu persono povas uzi la teleregilon kiel regilo, sed mi forte\n"
        ...
        "controllersInfoTextMac": (
            "Unu aŭ du ludantoj povas uzi la klavaron, sed BombSquad plej bonas kun\n"
        ...
        "controllersInfoTextOuya": (
            "Vi povas uzi OUYA-regilon, PS3-regilojn, regilojn de XBox 360 kaj multajn\n"
        ...
        "devicesInfoText": (
            "La VR-versio de BombSquad povas esti ludata en la reto kun la\n"
        ...
        "friendsGoodText": (
            "Bonas havi ilin. BombSquad plej amuzas kun pluraj ludantoj kaj\n"
    ...
    "installDiskSpaceErrorText": (
        "ERARO: Neeble kompletigi la instalon.\n"
    ...
    "internal": {
        ...
        "incompatibleVersionHostText": (
            "Gastiganto uzas alian version de la ludo.\n"
            "Certigu vin ke vi ambaŭ estu ĝisdataj kaj provu denove."
        ),
        "incompatibleVersionPlayerText": (
            "${NAME} uzas alian version de la ludo.\n"
            "Certigu vin ke vi ambaŭ estu ĝisdataj kaj provu denove."
        ),
        ...
        "vrOrientationResetCardboardText": (
            "Uzu ĉi tion por reigi la VR-orientiĝon.\n"
    ...
    "mustInviteFriendsText": (
        "Notu: vi devas inviti amikojn en\n"
    ...
    "newTestBuildAvailableText": (
        "Nova testkonstruo haveblas! (${VERSION} konstruo ${BUILD}).\n"
    ...
    "noProfilesErrorText": (
        "Vi ne havas ludantoprofilojn, do ni devos nomi vin '${NAME}'.\n"
    ...
    "pleaseRateText": (
        "Se vi ŝatas BombSquad, bonvolu konsideri momenton\n"
    ...
    "profileInfoText": (
        "Kreu profilojn por vi mem kaj viajn amikojn\n"
    ...
    "ps3ControllersWindow": {
        "macInstructionsText": (
            "Malŝaltu la energion malantaŭe de via PS3, certigu ke Bludento\n"
        ...
        "ouyaInstructionsText": (
            "Por uzi PS3-regilon kun via OUYA, simple konektu ĝin per USB-kablo unufoje\n"
    ...
    "replayVersionErrorText": (
        "Pardonu, ĉi tiu remontro estas farita en alia\n"
    ...
    "settingsWindowAdvanced": {
        ...
        "helpTranslateText": (
            "La neanglaj tradukoj de BombSquad nur eblas pro la komunumo.\n"
    ...
    "store": {
        ...
        "bombSquadProDescriptionText": (
            "Duobligos biletojn gajnitajn enlude\n"
            "\n"
        ...
        "freeBombSquadProText": (
            "BombSquad nun estas senpaga, sed ĉar vi origine aĉetis ĝin vi ricevas\n"
    ...
    "storeDescriptionText": (
        "Festluda frenezo kun 8 ludantoj!\n"
        "\n"
    ...
    "translations": {
        ...
        "gameDescriptions": {
            (
                ...
                "Estu la elektita dum tiom da tempo por venki.\n"
        ...
        "inputDeviceNames": {"Keyboard": "Klavaro", "Keyboard P2": "Klavaro Lud2"},
        "languages": {
            "Chinese": "Ĉina",
            "Croatian": "Kroata",
            "Czech": "Ĉeĥa",
        ...
        "playlistNames": {"Just Epic": "Nur brile", "Just Sports": "Nur sportoj"},
        "promoCodeResponses": {"invalid promo code": "nevalida promocia kodo"},
        "scoreNames": {
            "Flags": "Flagoj",
            "Goals": "Goloj",
            "Score": "Poentoj",
        ...
        "serverResponses": {
            ...
            (
                ...
                "Vi ricevis ${COUNT} biletojn por ensaluti.\n"
            ...
            (
                ...
                "Via kopio de la ludo adaptiĝis.\n"
        ...
        "tips": {
            (
                ...
                "Perfekttempa kur-salt-rotaci-bato povas mortigi en unu bato kaj\n"
            ...
            (
                ...
                "Kreu ludanto-profilojn por vi kaj viaj amikoj kun\n"
            ...
            (
                ...
                "Malbeno-kestoj ŝanĝas vin en tempobombon.\n"
            ...
            (
                ...
                "Malgraŭ iliaj aspektoj, la ebloj de la roluloj estas tutsamaj,\n"
            ...
            (
                ...
                "Premadu ajnan butonon por kuri. Vi pli rapide atingos\n"
            ...
            (
                ...
                "Glacibomboj ne estas tre potencaj, sed ili frostigos\n"
            ...
            (
                ...
                "Se iu prenas vin, batu al tiu kaj vi povos foriri.\n"
            ...
            (
                ...
                "Se vi havas maltro da regiloj, instalu la aplikaĵon 'BombSquad Remote'\n"
            ...
            (
                ...
                "Se glubombo ekgluas al vi, eksaltu kaj rotaciadu. Eble vi tiel seniĝos de la bombo\n"
            ...
            (
                ...
                "Se vi prenas malbenon, via sola espero por supervivi\n"
            ...
            (
                ...
                "Se multaj ludantoj venas kaj iras, enŝaltu 'aŭtomate-forigu-neaktivajn-ludantojn'\n"
            ...
            (
                ...
                "Se via aparato tro varmiĝas aŭ vi volas konservi baterian potencon,\n"
            ...
            (
                ...
                "Se la ludo malrapide montras la ekranojn, provu malpliigi\n"
            ...
            (
                ...
                "En Kaptu la flagon, via propra flago devas esti en via bazo por poenti. Se la alia\n"
            ...
            (
                ...
                "Multajn aferojn vi povas preni kaj ĵeti, eĉ aliajn ludantojn. Ĵeti viajn malamikojn\n"
            ...
            (
                ...
                "Ludantoj povas aliĝi kaj foriri meze de plej da ludoj,\n"
            ...
            (
                ...
                "Ludantoj povas aliĝi kaj foriri meze de plejmulto da ludoj,\n"
            ...
            (
                ...
                "Donacetoj nur havas tempolimojn en kunlaboraj ludoj.\n"
            ...
            (
                ...
                "Batoj pli damaĝas se viaj pugnoj pli rapide moviĝas, do\n"
            ...
            (
                ...
                "Ĉi tiu nivelo neniam finiĝas, sed altaj poentoj ĉi tie\n"
            ...
            (
                ...
                "Ĵetoforto estas bazita je la tenata direkto.\n"
            ...
            (
                ...
                "Ĉu lacigas vin la sono? Faru mem sontrakojn!\n"
            ...
            (
                ...
                "Vi povas 'celi' viajn batojn rotaciante maldekstren aŭ dekstren.\n"
            ...
            (
                ...
                "Vi povas scii kiam bombo eksplodos laŭ la koloro\n"
            ...
            (
                ...
                "Vi damaĝas vin se vi kapbatas kontraŭ aferoj,\n"
    ...
    "trialPeriodEndedText": (
        "Via provperiodo finiĝis. Ĉu vi ŝatus aĉeti\n" "BombSquad kaj pluludi?"
    ),
    ...
    "wiimoteLicenseWindow": {"titleText": "Kopirajto DarwiinRemote"},
    "wiimoteListenWindow": {
    ...
    "wiimoteSetupWindow": {
        ...
        "listenText": "Aŭskulti",
        "macInstructionsText": (
            "Certigu ke via Wii estas malŝaltitia kaj Bludento estas\n"
    ...
    "xbox360ControllersWindow": {
        ...
        "macInstructions2Text": (
            "Por uzi regilojn sendrate, vi ankaŭ bezonos la ricevilon kiu\n"
        ...
        "macInstructionsText": (
            "Por uzi la regilojn Xbox 360, vi devas instali la pelilon\n"
            "por Makintoŝo havebla je la malsupra ligilo.\n"
            "Ĝi funkcias kaj por drataj kaj sendrataj regiloj."
        ),
        "ouyaInstructionsText": (
            "Por uzi dratajn regilojn de Xbox 360 kun BombSquad, simple\n"
