...
values = {
    "accountSettingsWindow": {
        ...
        "linkAccountsInstructionsNewText": (
            "Pour lier deux comptes, générez un code sur le premier\n"
        ...
        "linkAccountsInstructionsText": (
            "Pour lier deux comptes, générez un code sur l'un\n"
        ...
        "resetProgressConfirmNoAchievementsText": (
            "Ceci réinitialisera votre progression co-op et\n"
        ...
        "resetProgressConfirmText": (
            "Ceci réinitialisera votre progression co-op,\n"
        ...
        "setAccountNameDesc": (
            "Sélectionnez le nom à afficher pour votre compte.\n"
            "Vous pouvez utiliser le nom d'un de vos comptes\n"
            " associés ou créer un nom personnalisé unique."
        ),
        "signInInfoText": (
            "Connectez-vous pour gagner des tickets, participer aux tournois en ligne,\n"
        ...
        "testAccountWarningCardboardText": (
            'Attention: vous êtes connectés avec un compte "test".\n'
        ...
        "testAccountWarningOculusText": (
            'Attention: vous vous connectez avec un compte "test".\n'
    ...
    "buttonText": "bouton",
    "canWeDebugText": (
        "Voulez-vous que BombSquad envoie automatiquement un rapport des bugs, \n"
    ...
    "completeThisLevelToProceedText": (
        "Vous devez compléter ce \n" "niveau pour continuer!"
    ),
    ...
    "configGamepadSelectWindow": {
        ...
        "pressAnyButtonText": (
            "Appuyez sur n'importe quel bouton du support\n"
    ...
    "configGamepadWindow": {
        ...
        "secondHalfText": (
            "Utilisez ceci pour configurer la deuxième \n"
    ...
    "configKeyboardWindow": {
        ...
        "keyboard2NoteText": (
            "Attention: la plupart des claviers ne peuvent enregistrer \n"
    ...
    "configTouchscreenWindow": {
        ...
        "swipeInfoText": (
            "Le style 'Libre' demande un peu de pratique pour s'y habituer mais\n"
    ...
    "connectMobileDevicesWindow": {
        ...
        "bestResultsText": (
            "Pour de meilleurs résultats, il est nécessaire d'avoir un wifi qui fonctionne\n"
        ...
        "explanationText": (
            "Pour utiliser un smartphone ou une tablette comme manette, installez \n"
        ...
        "forIOSText": "pour iOS:",
        "getItForText": (
            "Téléchargez ${REMOTE_APP_NAME} pour iOS dans l'App Store d'Apple\n"
    ...
    "coopSelectWindow": {
        ...
        "activenessInfoText": (
            "Ce bonus multiplicateur augmente lorsque vous jouez\n"
            "et baisse quand vous ne jouez pas."
        ),
        "activityText": "Activité",
        "campaignText": "Campagne",
        "challengesInfoText": (
            "Gagnez des prix en remportant des mini-jeux.\n"
            "\n"
        ...
        "totalText": "total",
        "tournamentInfoText": (
            "Commencez la course au meilleur score\n"
        ...
        "welcome1Text": (
            "Bienvenue à ${LEAGUE}. Vous pouvez améliorer votre\n"
            "rang en gagnant des étoiles, en complétant des\n"
            "succès et en gagnant des trophées durant les tournois."
        ),
        "welcome2Text": (
            "Vous pouvez aussi gagner des tickets en participant à bien d'autres activités.\n"
    ...
    "difficultyHardUnlockOnlyText": (
        "Ce niveau ne peut être débloqué qu'en mode difficile.\n"
    ...
    "editProfileWindow": {
        "accountProfileInfoText": (
            "Ce profil spécial à un nom \n"
        ...
        "globalProfileInfoText": (
            "Chaque profil Mondial de chaque joueur est sûr d'avoir un unique nom\n"
            "dans le monde entier. De même pour les icônes personnalisées."
        ),
        "globalProfileText": "(profil Mondial)",
        "highlightText": "Variante",
        "iconText": "icône",
        "localProfileInfoText": (
            "Un profil Local ne possède pas d'icône ou d'un unique nom \n"
        ...
        "upgradeProfileInfoText": (
            "Ceci vous réserve le droit à un nom de joueur unique dans le monde\n"
    ...
    "failText": "Échec",
    "fatalErrorText": (
        "Oh zut; quelque chose manque ou est endommagé.\n"
    ...
    "gameSettingsWindow": {"addGameText": "Ajouter un Match"},
    ...
    "gatherWindow": {
        "aboutDescriptionLocalMultiplayerExtraText": (
            "Rappel: n'importe quelle appareil peut supporter\n"
            "plus d'un joueur si vous avez plusieurs manettes."
        ),
        "aboutDescriptionText": (
            "Utilisez ces onglets pour créer une partie.\n"
            "\n"
        ...
        "appInviteInfoText": (
            "Invitez vos amis pour jouer BombSquad et \n"
        ...
        "disconnectClientsText": (
            "Ceci déconnectera le(s) ${COUNT} joueur(s)\n"
            "de votre partie. Êtes-vous sûr?"
        ),
        "earnTicketsForRecommendingAmountText": (
            "Vos amis recevront ${COUNT} tickets si ils essayent le jeu\n"
            "(et vous recevrez ${YOU_COUNT} pour chacun d'entre eux qui le feront)"
        ),
        "earnTicketsForRecommendingText": (
            "Partagez le jeu pour \n" "des tickets gratuits..."
        ),
        ...
        "friendPromoCodeInstructionsText": (
            'Pour l\'utiliser, ouvrez ${APP_NAME} puis aller dans "Paramètres->Avancé->Entrer code".\n'
        ...
        "googlePlayReInviteText": (
            "Le(s) ${COUNT} joueur(s) Google Play seront déconnectés \n"
        ...
        "inviteAFriendText": (
            "Vos amis n'ont pas le jeu? Invitez-les à\n"
        ...
        "wifiDirectDescriptionBottomText": (
            "Si tous les appareils ont un onglet 'Wi-Fi Direct', ils devraient être capables de \n"
        ...
        "wifiDirectDescriptionTopText": (
            "Wi-Fi Direct peux être utilisé pour connecter des appareils Android directement\n"
    ...
    "getTicketsWindow": {
        ...
        "unavailableLinkAccountText": (
            "Désolé , les achats ne sont pas disponibles sur cette plateforme.\n"
    ...
    "helpWindow": {
        ...
        "controllersInfoText": (
            "Vous pouvez jouer à ${APP_NAME} avec des amis par réseau, ou vous \n"
        ...
        "controllersInfoTextFantasia": (
            "Un joueur peut utiliser la télécommande comme manette, mais les\n"
        ...
        "controllersInfoTextMac": (
            "Un ou deux joueurs peuvent utiliser le clavier, mais Bombsquad est meilleur avec\n"
        ...
        "controllersInfoTextOuya": (
            "Vous pouvez utiliser des manettes OUYA, PS3, XBOX 360 et beaucoup \n"
        ...
        "devicesInfoText": (
            "La version RV de ${APP_NAME} peut être jouée par réseau avec \n"
        ...
        "friendsGoodText": (
            "Il est bon d'en avoir. ${APP_NAME} est plus amusant avec plusieurs\n"
        ...
        "powerupBombDescriptionText": (
            "Vous permet de lancer trois bombes \n" "d'affilée au lieu d'une seule."
        ),
        "powerupBombNameText": "Triple bombes",
        "powerupCurseDescriptionText": (
            "Vous ne voulez probablement pas y toucher.\n" "...ou peut-être que si?"
        ),
        "powerupCurseNameText": "Malédiction",
        "powerupHealthDescriptionText": (
            "Vous restaure votre santé.\n" "Vous n'aurez jamais pu deviner."
        ),
        "powerupHealthNameText": "Trousse de soin",
        "powerupIceBombsDescriptionText": (
            "Moins puissantes que les bombes normales \n"
            "mais congèlent vos ennemis et les \n"
            "rendent particulièrement cassant."
        ),
        "powerupIceBombsNameText": "Bombes glacées",
        "powerupImpactBombsDescriptionText": (
            "Un peu moins puissantes que les bombes \n"
            "normales, elles explosent à l'impact."
        ),
        "powerupImpactBombsNameText": "Bombes d'impact",
        "powerupLandMinesDescriptionText": (
        ...
        "powerupShieldDescriptionText": (
            "Absorbe les dommages\n" "pour préserver votre santé."
        ),
        "powerupShieldNameText": "Bouclier d'énergie",
        "powerupStickyBombsDescriptionText": (
            "Collent à tout ce qu'elles touchent.\n" "Fous rires garantis."
        ),
    ...
    "installDiskSpaceErrorText": (
        "ERREUR: Incapable de compléter l'installation.\n"
    ...
    "internal": {
        ...
        "connectionFailedVersionMismatchText": (
            "La connexion a échouée; l'hôte joue avec une version différente du jeu.\n"
        ...
        "incompatibleVersionHostText": (
            "L'hôte execute une version différente du jeu.\n"
            "Vérifiez que vous êtes tous les deux à jour et réessayez."
        ),
        "incompatibleVersionPlayerText": (
            "${NAME} execute une version différente du jeu.\n"
            "Vérifiez que vous êtes tous les deux à jour et réessayez."
        ),
        ...
        "joinedPartyInstructionsText": (
            "Quelqu'un a rejoint votre partie.\n"
        ...
        "vrOrientationResetCardboardText": (
            "Utilisez ceci pour réinitialiser l'orientation RV.\n"
    ...
    "macControllerSubsystemMFiNoteText": (
        "Une manette IOS/Mac détectée;\n"
    ...
    "mustInviteFriendsText": (
        "Note: vous devez inviter des amis dans \n"
    ...
    "newTestBuildAvailableText": (
        "Une nouvelle version test est disponible ! (${VERSION} ${BUILD}).\n"
        "Obtenez à ${ADDRESS}"
    ),
    "newText": "Nouveau",
    ...
    "ownFlagAtYourBaseWarning": (
        "Votre drapeau doit être\n" "à votre base pour marquer!"
    ),
    ...
    "pleaseRateText": (
        "Si vous aimez ${APP_NAME}, SVP, prenez un moment pour \n"
    ...
    "profileInfoText": (
        "Créez des profils pour vous et vos amis\n"
    ...
    "ps3ControllersWindow": {
        "macInstructionsText": (
            "Coupez l'alimentation de votre PS3, soyez certain que le\n"
        ...
        "ouyaInstructionsText": (
            "Pour utiliser un contrôleur de PS3 avec votre OUYA, connectez le avec un \n"
    ...
    "remoteAppInfoShortText": (
        "${APP_NAME} est plus amusant quand vous jouez avec votre famille ou des amis.\n"
    ...
    "remote_app": {
        ...
        "connected": "Connecté.",
        "description": (
            "Utilisez votre smartphone ou tablette comme manette avec BombSquad. \n"
        ...
        "searching_caption": (
            "Touchez le nom d'un jeu pour rejoindre.\n"
    ...
    "replayVersionErrorText": (
        "Désolé, cette reprise a été créée avec une version \n"
    ...
    "reportPlayerExplanationText": (
        "Utilisez cet email pour rapporter tricherie, langage inapproprié, ou d'autres comportements mauvais.\n"
        "Décrivez en-dessous:"
    ),
    ...
    "settingsWindowAdvanced": {
        ...
        "helpTranslateText": (
            "Les traductions de ${APP_NAME} proviennent des efforts de \n"
    ...
    "signInWithGameCenterText": (
        "Pour l'utilisation d'un compte Game \n"
    ...
    "store": {
        ...
        "bombSquadProDescriptionText": (
            "• Double le nombre des billets gagnés grâce aux succès\n"
            "• Enlève les annonces\n"
        ...
        "bombSquadProNewDescriptionText": (
            "* Supprime les annonces et publicités dans le jeu\n"
        ...
        "extrasText": "Extras",
        "freeBombSquadProText": (
            "BombSquad est désormais gratuit, mais comme vous l'avez acheté, vous\n"
        ...
        "purchaseNotValidError": (
            "L'Achat n'est pas valide.\n"
    ...
    "translations": {
        ...
        "gameDescriptions": {
            (
                ...
                "Restez l'élu pendant un certain temps pour gagner.\n"
        ...
        "inputDeviceNames": {"Keyboard": "Clavier", "Keyboard P2": "Clavier J2"},
        "languages": {
            "Arabic": "Arabe",
        ...
        "promoCodeResponses": {"invalid promo code": "Code promo invalide"},
        "scoreNames": {
            "Flags": "Drapeaux",
            "Goals": "Buts",
            "Score": "Points",
        ...
        "serverResponses": {
            ...
            (
                ...
                "Voulez-vous vraiment lier ces comptes?\n"
                "\n"
                "${ACCOUNT1}\n"
                "${ACCOUNT2}\n"
                "\n"
            ...
            (
                ...
                "(and lose THIS account's data instead)"
            ): (
                "LIEN REFUSÉ. ${ACCOUNT} contient des\n"
            ...
            (
                ...
                "Lier le compte ${ACCOUNT} à ce compte?\n"
            ...
            (
                ...
                "Vous avez reçu ${COUNT} tickets pour votre connexion.\n"
            ...
            (
                ...
                "La fonctionnalité serveur n'est plus prise en charge dans cette version du jeu;\n"
            ...
            (
                ...
                "(except for achievements in some cases)"
            ): (
                "Dissocier ${ACCOUNT} de ce compte?\n"
            ...
            (
                ...
                "Accounts found to be hacking will be banned.  Please play fair."
            ): (
                "ATTENTION: des plaintes de piratage/tricherie ont été émises contre votre compte.\n"
            ...
            (
                ...
                "Votre copie du jeu a été modifié.\n"
        ...
        "tips": {
            (
                ...
                "Un coup de poing avec le saut, la vitesse et la bonne rotation fait au \n"
            ...
            (
                ...
                "Créez un profil de joueur pour vous même et vos amis avec vos noms\n"
            ...
            (
                ...
                "Les boites de malédiction vous transforment en bombe à retardement. \n"
            ...
            (
                ...
                "Malgré leurs apparences, toutes les personnages ont les mêmes \n"
            ...
            (
                ...
                "Gardez n'importe quel bouton appuyé pour courir. Vous arriverez aux endroits \n"
            ...
            (
                ...
                "Les bombes glacées ne sont pas très puissantes, mais elles\n"
            ...
            (
                ...
                "Si quelqu'un vous ramasse, frappez-le et il vous lâchera. \n"
            ...
            (
                ...
                "Si vous manquez de manettes, installez l'app '${REMOTE_APP_NAME}'\n"
            ...
            (
                ...
                "on your iOS or Android devices to use them as controllers."
            ): (
                "Si vous manquez les contrôleurs, installez l'application 'BombSquad Remote' \n"
            ...
            (
                ...
                "Si une bombe gluante est collée sur vous, sautez et tournez en rond. Vous pourriez\n"
            ...
            (
                ...
                "Si vous prenez une malédiction, votre seule chance est de\n"
            ...
            (
                ...
                "Si vous avez plusieurs joueurs qui sont intermittent, activez 'déconnecter-les-joueurs-inactifs'\n"
            ...
            (
                ...
                "Si votre appareil chauffe trop ou vous souhaitez économiser de la batterie,\n"
            ...
            (
                ...
                "Si votre fréquence d'images est agité, essayez de diminuer la résolution\n"
            ...
            (
                ...
                "Dans Capturer le Drapeau, votre propre drapeau doit être à votre base pour marquer un point. Si l'autre\n"
            ...
            (
                ...
                "Beaucoup de choses peuvent être ramassées et jetées, même les autres joueurs. Jetez vos \n"
            ...
            (
                ...
                "Les joueurs peuvent joindre et quitter quand les jeux sont en cours, \n"
                "vous pouvez aussi brancher et débrancher les contrôleurs rapidement."
            ),
            (
                "Players can join and leave in the middle of most games,\n"
                "and you can also plug and unplug gamepads on the fly."
            ): (
                "Les joueurs peuvent rejoindre et quitter en jeu dans la plupart des modes de jeu,\n"
                "vous pouvez aussi débrancher et rebrancher une manette en cours de partie."
            ),
            (
                "Powerups only have time limits in co-op games.\n"
                "In teams and free-for-all they're yours until you die."
            ): (
                "Les bonus ont seulement une limite de temps en co-op.\n"
            ...
            (
                ...
                "Les coups de poing font plus de dommage quand vous bougez plus vite,\n"
                "essayez de courir, sauter, et tourner comme un fou."
            ),
            (
                "Run back and forth before throwing a bomb\n"
                "to 'whiplash' it and throw it farther."
            ): "Courez en arrière et en avant avant de lancer votre bombe pour lancer plus loin.",
            ("Take out a group of enemies by\n" "setting off a bomb near a TNT box."): (
                "Éliminez un groupe d'ennemis en fesant\n"
            ...
            (
                ...
                "La tête est la plus vulnérable, une bombe gluante sur \n"
            ...
            (
                ...
                "Ce niveau ne finit jamais, mais un score élevé vous \n"
            ...
            (
                ...
                "La force du lancé est basée sur la direction que vous maintenez.\n"
            ...
            (
                ...
                "Ennuyé par la bande sonore? Remplacez la avec votre propre musique!\n"
            ...
            (
                ...
                "Vous pouvez 'viser' avec vos poings en tournant à droite ou à gauche.\n"
            ...
            (
                ...
                "Vous pouvez juger quand la bombe va exploser basant sur la \n"
            ...
            (
                ...
                "button (pick-up) when joining a game to override your default."
            ): (
                "Vous n'avez pas besoin d'éditer votre profil pour changer de personnage; appuyez juste sur\n"
            ...
            (
                ...
                "Vous subissez des dégâts quand vous vous cognez la tête,\n"
    ...
    "trialPeriodEndedText": (
        "Votre période d'essai est terminée. Voulez vous\n"
    ...
    "wiimoteLicenseWindow": {"titleText": "DarwiinRemote Copyright"},
    "wiimoteListenWindow": {
    ...
    "wiimoteSetupWindow": {
        ...
        "listenText": "Écoute",
        "macInstructionsText": (
            "Vérifiez que votre Wii est éteinte et que le Bluetooth est\n"
        ...
        "thanksText": (
            "Merci à l'équipe DarwiinRemote pour\n" "avoir rendu ceci possible."
        ),
    ...
    "xbox360ControllersWindow": {
        ...
        "macInstructions2Text": (
            "Pour utiliser les contrôleurs sans-fils, vous avez besoin du récepteur \n"
        ...
        "macInstructionsText": (
            "Pour utiliser les contrôleurs Xbox 360, vous devez installer \n"
            "le pilote pour Mac qui est disponible au lien en-dessous. \n"
            "Il fonctionne avec les contrôleurs sans-fils et filaires."
        ),
        "ouyaInstructionsText": (
            "Pour utiliser les contrôleurs filaires Xbox 360 avec BombSquad,\n"
