...
values = {
    "accountSettingsWindow": {
        ...
        "linkAccountsInstructionsText": (
            "För att länka ihop två konton, generera en kod på\n"
        ...
        "resetProgressConfirmNoAchievementsText": (
            "Detta kommer att återställa co-op spel och \n"
            "poäng (men inte dina värdekuponger). Kan ej ångras.\n"
            "Är du säker?"
        ),
        "resetProgressConfirmText": (
            "Detta kommer att återställa din co-op kampanj,\n"
        ...
        "testAccountWarningCardboardText": (
            'Varning : du loggar in med ett konto "test" .\n'
        ...
        "testAccountWarningText": (
            'Varning: du loggar på med ett "test" konto.\n'
    ...
    "buttonText": "Knapp",
    "canWeDebugText": (
        "Vill du att BombSquad automatiskt ska skicka bug, - och crashrapporter och grundläggande användarinfo till utvecklaren?\n"
        "\n"
    ...
    "configGamepadSelectWindow": {
        ...
        "pressAnyButtonText": (
            "Tryck valfri knapp på den styrenhet\n" "som du vill konfigurera..."
        ),
    ...
    "configGamepadWindow": {
        ...
        "secondHalfText": (
            "Använd denna för att konfigurera\n"
    ...
    "configKeyboardWindow": {
        ...
        "keyboard2NoteText": (
            "Notera: de flesta tangentbord kan endast registrera några få\n"
    ...
    "configTouchscreenWindow": {
        ...
        "swipeInfoText": (
            "'Swipe' kontroller tar lite tid att vänja sig vid, \n"
    ...
    "connectMobileDevicesWindow": {
        ...
        "bestResultsText": (
            "För bästa resultat behöver du ett responsivt wifinätverk.\n"
        ...
        "explanationText": (
            "För att använda en smartphone eller tablet som styrenhet,\n"
        ...
        "forIOSText": "för iOS:",
        "getItForText": (
            "Hämta ${REMOTE_APP_NAME} för iOS i Apple App Store\n"
    ...
    "difficultyHardUnlockOnlyText": (
        "Denna bana kan bara låsas up i svårt läge.\n"
    ...
    "editProfileWindow": {
        "accountProfileInfoText": (
            "Den här speciella profilen har ett namn\n"
        ...
        "globalProfileInfoText": (
            "Globala spelarprofiler är garanterade att ha unika, \n"
        ...
        "localProfileInfoText": (
            "Lokala spelarprofiler har inga ikoner och namnet är \n"
        ...
        "upgradeProfileInfoText": (
            "Det här kommer att skydda ditt spelar namn världen över \n"
    ...
    "fatalErrorText": (
        "Hoppsan; något saknas eller är trasigt.\n"
    ...
    "gameSettingsWindow": {"addGameText": "Lägg till spel"},
    ...
    "gatherWindow": {
        "aboutDescriptionLocalMultiplayerExtraText": (
            "Kom ihåg: enheter anslutna till ett sällskap kan ha mer \n"
            "än en spelare om det finns tillräckligt med styrenheter."
        ),
        "aboutDescriptionText": (
            "Använd dessa flikar för att samla ett sällskap.\n"
            "\n"
        ...
        "appInviteInfoText": (
            "Bjud in vänner att prova BombSquad så får de \n"
        ...
        "friendPromoCodeInstructionsText": (
            'För att använda den, öppna ${APP_NAME} och gå till "Inställningar->Avancerat->Skriv in Promo Kod".\n'
        ...
        "googlePlayReInviteText": (
            "Det finns ${COUNT} Google Play spelare i ditt sällskap\n"
        ...
        "inviteAFriendText": (
            "Har dina vänner inte spelet? Bjud in dem att\n"
        ...
        "wifiDirectDescriptionBottomText": (
            "Om alla enheter har en 'Wi-Fi Direct' panel, borde de kunna använda den för att hitta\n"
        ...
        "wifiDirectDescriptionTopText": (
            "Wi-Fi Direct kan användas för att ansluta Android enheter direkt utan\n"
    ...
    "getTicketsWindow": {
        ...
        "unavailableLinkAccountText": (
            "Sorry, det går inte att göra inköp på den här plattformen. \n"
    ...
    "helpWindow": {
        ...
        "controllersInfoText": (
            "Du kan spela ${APP_NAME} med vänner över nätverk, eller så\n"
        ...
        "controllersInfoTextFantasia": (
            "En spelare kan använda fjärrkontrollen som styrenhet, men\n"
        ...
        "controllersInfoTextMac": (
            "En eller två spelare kan använda tangentbordet men BombSquad är bäst med gamepads.\n"
        ...
        "controllersInfoTextOuya": (
            "Du kan använda OUYA kontroller, PS3 kontroller, Xbox 360 kontroller \n"
        ...
        "devicesInfoText": (
            "VR versionen av ${APP_NAME} kan spelas över nätverk med en vanlig\n"
        ...
        "devicesText": "Enheter",
        "friendsGoodText": (
            "Dessa är bra att ha. ${APP_NAME} är roligast med flera spelare\n"
    ...
    "installDiskSpaceErrorText": (
        "Fel: Kunde inte slutföra installationen.\n"
    ...
    "internal": {
        ...
        "connectionFailedVersionMismatchText": (
            "Anslutning misslyckades; värden kör en annan version av spelet.\n"
        ...
        "controllerForMenusOnlyText": (
            "Denna kontrollen kan inte användas för spel;\n"
        ...
        "joinedPartyInstructionsText": (
            "En vän har anslutit till ditt sällskap.\n"
        ...
        "touchScreenJoinWarningText": (
            "Du har anslutit med touchscreen.\n"
        ...
        "vrOrientationResetCardboardText": (
            "Använd detta för att återställa VR orientering.\n"
    ...
    "mustInviteFriendsText": (
        "Notera: du måste bjud in vänner i\n"
    ...
    "newTestBuildAvailableText": (
        "Ett nyare bygge är tillgängligt! (${VERSION} bygge ${BUILD}).\n"
        "Hämta på ${ADDRESS}"
    ),
    ...
    "noProfilesErrorText": (
        "Du har inga spelarprofiler, so du är fast med '${NAME}'.\n"
    ...
    "pleaseRateText": (
        "Om du gillar BombSquad, är vi tacksamma om du\n"
    ...
    "profileInfoText": (
        "Skapa profiler för dig och dina vänner för att\n"
    ...
    "ps3ControllersWindow": {
        "macInstructionsText": (
            "Stäng av strömmen på baksidan av din PS3, säkerställ att \n"
        ...
        "ouyaInstructionsText": (
            "För att använda PS3 styrenhet med din OUYA, koppla endast in USB kabeln.\n"
    ...
    "replayVersionErrorText": (
        "Tyvärr, denna repris skapades med en annan\n"
    ...
    "reportPlayerExplanationText": (
        "Använd den här e-post adressen för att rapportera fusk, olämpligt språk \n"
    ...
    "settingsWindowAdvanced": {
        ...
        "helpTranslateText": (
            "BombSquad's språköversättningar skapas gemensamt i\n"
    ...
    "signInWithGameCenterText": (
        "För att använda ett Game Center konto, \n" "logga in via Game Center appen."
    ),
    ...
    "store": {
        ...
        "bombSquadProDescriptionText": (
            'Dubblar dina "achievement ticket rewards"\n'
            "\n"
        ...
        "freeBombSquadProText": (
            "BombSquad är nu gratis, men eftersom du tidigare köpt spelet får du\n"
    ...
    "storeDescriptionText": (
        "Partyspelsgalenskap för åtta spelare!\n"
        "\n"
    ...
    "translations": {
        ...
        "gameDescriptions": {
            (
                ...
                "Var den utvalde under en tid för att vinna..\n"
        ...
        "playlistNames": {"Just Epic": "Endast Episkt", "Just Sports": "Endast Sport"},
        "promoCodeResponses": {"invalid promo code": "Ogiltig kampanjkod"},
        "scoreNames": {
            "Flags": "Flaggor",
            "Goals": "Mål",
            "Score": "Poäng",
        ...
        "serverResponses": {
            ...
            (
                ...
                "Är du säker på att du vill slå ihop dessa konton?\n"
                "\n"
                "${ACCOUNT1}\n"
                "${ACCOUNT2}\n"
                "\n"
            ...
            (
                ...
                "Mottagna ${COUNT} biljetter till att logga in.\n"
            ...
            (
                ...
                "Din kopia av spelet har modifierats.\n"
        ...
        "tips": {
            (
                ...
                "En perfekt timad spring-hopp-spin-slag kan döda i ett enda slag\n"
            ...
            (
                ...
                "Skapa spelarprofiler till dig själv och dina vänner med \n"
            ...
            (
                ...
                "Förbannelse-lådan förvandlar dig till en tickande bomb.\n"
            ...
            (
                ...
                "Oavsett utseendet är alla karaktärers förmågor identiska,\n"
            ...
            (
                ...
                "Håll ned valfri knapp för att springa. Du tar dig snabbare fram \n"
            ...
            (
                ...
                "Isbomber är inte särskilt kraftfulla, men de fryser den som\n"
            ...
            (
                ...
                "Om någon plockar upp dig, slå dem så släpper de taget.\n"
            ...
            (
                ...
                "Om du inte har tillräckligt med kontroller kan du installera 'BombSquad Remote' appen\n"
            ...
            (
                ...
                "Om en klisterbomb fastnar på dig, hoppa runt i cirklar.\n"
            ...
            (
                ...
                "Om du tar upp en förbannelse, är ditt enda hopp för att överleva\n"
            ...
            (
                ...
                "Om det är många spelare som ansluter och slutar, ställ in 'kasta ut inaktiva spelare'\n"
            ...
            (
                ...
                "Om din enhet blir för varm eller om du vill spara på batteri,\n"
            ...
            (
                ...
                "Om din framerate hoppar, försök sänka upplösningen\n"
            ...
            (
                ...
                "I Fånga Flaggan måste din egen flagga vara vid basen för att kunna göra poäng, om \n"
            ...
            (
                ...
                "Många saker kan plockas upp och kastas, inklusive andra spelare. Att kasta dina \n"
            ...
            (
                ...
                "Spelare kan ansluta eller lämna mitt i de flesta speltyperna,\n"
            ...
            (
                ...
                "Spelare kan ansluta och lämna mitt i de flesta spel\n"
            ...
            (
                ...
                "Powerups har endast tidsbegränsning i co-op spel.\n"
            ...
            (
                ...
                "Slag gör mer skada ju snabbare nävarna rör sig,\n"
            ...
            (
                ...
                "Spring fram och tillbak innan du kastar en bomb\n"
                "för att 'piska' den och kasta längre."
            ),
            ("Take out a group of enemies by\n" "setting off a bomb near a TNT box."): (
                "Slå ut en grupp fiender genom att\n"
            ...
            (
                ...
                "Huvudet är det mest känsliga området, så en klisterbomb\n"
            ...
            (
                ...
                "Denna nivå tar aldrig slut, men ett high score här\n"
            ...
            (
                ...
                "Kaststryka baseras på den riktning du trycker.\n"
            ...
            (
                ...
                "Trött på soundtracket? Ersätt den med din egna!\n"
            ...
            (
                ...
                "Du kan 'sikta' dina slag genom att snurra till vänster och höger.\n"
            ...
            (
                ...
                "Du kan avgöra när en bomb kommer smälla beroende på\n"
            ...
            (
                ...
                "Du behöver inte redigera din profil för att byta spelkaraktär. Tryck bara på \n"
            ...
            (
                ...
                "Du tar skada när du slår huvudet i saker, \n"
    ...
    "xbox360ControllersWindow": {
        ...
        "macInstructions2Text": (
            "För att använda kontrollen trådlöst behöver du en mottagare \n"
        ...
        "macInstructionsText": (
            "För att använda Xbox 360 kontroller behöver du\n"
            "installera Mac drivrutinen som är tillgänglig via\n"
            "länken nedanför. Den fungerar både med och utan sladd"
        ),
        "ouyaInstructionsText": (
            "Allt du behöver göra för att använda trådade Xbox 360-kontroller är att \n"
