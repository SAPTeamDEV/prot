...
values = {
    ...
    "alreadySignedInText": (
        "Your account is signed in from another device;\n"
    ...
    "macControllerSubsystemMFiNoteText": (
        "Made-for-iOS/Mac controller detected;\n"
    ...
    "remoteAppInfoShortText": (
        "${APP_NAME} is most fun when played with family & friends.\n"
    ...
    "remote_app": {
        ...
        "searching_caption": (
            "Tap on the name of a game to join it.\n"
        ...
        "description": (
            "Use your phone or tablet as a controller with BombSquad.\n"
    ...
    "reportPlayerExplanationText": (
        "Use this email to report cheating, inappropriate language, or other bad behavior.\n"
    ...
    "accountSettingsWindow": {
        ...
        "setAccountNameDesc": (
            "Select the name to display for your account.\n"
        ...
        "linkAccountsInstructionsNewText": (
            "To link two accounts, generate a code on the first\n"
        ...
        "resetProgressConfirmNoAchievementsText": (
            "This will reset your co-op progress and\n"
            "local high-scores (but not your tickets).\n"
            "This cannot be undone. Are you sure?"
        ),
        "resetProgressConfirmText": (
            "This will reset your co-op progress,\n"
        ...
        "signInInfoText": (
            "Sign in to collect tickets, compete online,\n"
    ...
    "addGameWindow": {"getMoreGamesText": "Get More Games...", "titleText": "Add Game"},
    "allowText": "Allow",
    ...
    "buttonText": "button",
    "canWeDebugText": (
        "Would you like BombSquad to automatically report\n"
    ...
    "configGamepadWindow": {
        ...
        "secondHalfText": (
            "Use this to configure the second half\n"
    ...
    "configKeyboardWindow": {
        ...
        "keyboard2NoteText": (
            "Note: most keyboards can only register a few keypresses at\n"
    ...
    "connectMobileDevicesWindow": {
        ...
        "bestResultsText": (
            "For best results you'll need a lag-free wifi network. You can\n"
        ...
        "explanationText": (
            "To use a smart-phone or tablet as a wireless controller,\n"
        ...
        "forIOSText": "for iOS:",
        "getItForText": (
            "Get ${REMOTE_APP_NAME} for iOS at the Apple App Store\n"
    ...
    "coopSelectWindow": {
        ...
        "activenessInfoText": (
            "This multiplier rises on days when you\n"
        ...
        "challengesInfoText": (
            "Earn prizes for completing mini-games.\n\n"
        ...
        "totalText": "total",
        "welcome1Text": (
            "Welcome to ${LEAGUE}. You can improve your\n"
            "league rank by earning star ratings, completing\n"
            "achievements, and winning trophies in tournaments."
        ),
        "welcome2Text": (
            "You can also earn tickets from many of the same activities.\n"
    ...
    "difficultyHardUnlockOnlyText": (
        "This level can only be unlocked in hard mode.\n"
    ...
    "editProfileWindow": {
        "accountProfileInfoText": (
            "This special profile has a name\n"
        ...
        "localProfileInfoText": (
            "Local player profiles have no icons and their names are\n"
        ...
        "upgradeProfileInfoText": (
            "This will reserve your player name worldwide\n"
    ...
    "failText": "Fail",
    "fatalErrorText": (
        "Uh oh; something is missing or broken.\n"
    ...
    "gameSettingsWindow": {"addGameText": "Add Game"},
    ...
    "gatherWindow": {
        ...
        "earnTicketsForRecommendingAmountText": (
            "Friends will receive ${COUNT} tickets if they try the game\n"
        ...
        "friendPromoCodeInstructionsText": (
            'To use it, open ${APP_NAME} and go to "Settings->Advanced->Enter Code".\n'
        ...
        "googlePlayReInviteText": (
            "There are ${COUNT} Google Play player(s) in your party\n"
        ...
        "wifiDirectDescriptionTopText": (
            "Wi-Fi Direct can be used to connect Android devices directly without\n"
    ...
    "getTicketsWindow": {
        ...
        "unavailableLinkAccountText": (
            "Sorry, purchases are not available on this platform.\n"
    ...
    "helpWindow": {
        ...
        "controllersInfoText": (
            "You can play ${APP_NAME} with friends over a network, or you\n"
        ...
        "controlsText": "Controls",
        "devicesInfoText": (
            "The VR version of ${APP_NAME} can be played over the network with\n"
        ...
        "devicesText": "Devices",
        "friendsGoodText": (
            "These are good to have.  ${APP_NAME} is most fun with several\n"
    ...
    "installDiskSpaceErrorText": (
        "ERROR: Unable to complete the install.\n"
    ...
    "internal": {
        ...
        "connectionFailedVersionMismatchText": (
            "Connection failed; host is running a different version of the game.\n"
        ...
        "incompatibleVersionHostText": (
            "Host is running a different version of the game.\n"
            "Make sure you are both up-to-date and try again."
        ),
        ...
        "incompatibleVersionPlayerText": (
            "${NAME} is running a different version of the game.\n"
            "Make sure you are both up-to-date and try again."
        ),
        ...
        "vrOrientationResetCardboardText": (
            "Use this to reset the VR orientation.\n"
    ...
    "mustInviteFriendsText": (
        "Note: you must invite friends in\n"
    ...
    "promoCodeWindow": {"codeText": "Code", "enterText": "Enter"},
    ...
    "replayVersionErrorText": (
        "Sorry, this replay was made in a different\n"
    ...
    "store": {
        ...
        "bombSquadProNewDescriptionText": (
            "• Removes in-game ads and nag-screens\n"
        ...
        "freeBombSquadProText": (
            "BombSquad is now free, but since you originally purchased it you are\n"
    ...
    "translations": {
        ...
        "inputDeviceNames": {"Keyboard": None, "Keyboard P2": None},
        "languages": {
            "Serbian": None,
            "Chinese": None,
            "Croatian": None,
        ...
        "leagueNames": {"Bronze": None, "Diamond": None, "Gold": None, "Silver": None},
        "mapsNames": {
            "Big G": None,
            "Bridgit": None,
            "Courtyard": None,
        ...
        "playlistNames": {"Just Epic": None, "Just Sports": None},
        "scoreNames": {
            "Flags": None,
            "Goals": None,
            "Score": None,
        ...
        "teamNames": {"Bad Guys": None, "Blue": None, "Good Guys": None, "Red": None},
        "tips": {
    ...
    "wiimoteSetupWindow": {
        ...
        "listenText": "Listen",
        "macInstructionsText": (
            "Make sure your Wii is off and Bluetooth is enabled\n"
        ...
        "thanksText": (
            "Thanks to the DarwiinRemote team\n" "For making this possible.\n"
        ),
    ...
    "xbox360ControllersWindow": {
        ...
        "macInstructions2Text": (
            "To use controllers wirelessly, you'll also need the receiver that\n"
