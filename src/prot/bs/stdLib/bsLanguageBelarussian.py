...
values = {
    "accountSettingsWindow": {
        ...
        "linkAccountsInstructionsNewText": (
            "Для таго, каб звязаць два акаўнта, згенерыруйце код на першым\n"
        ...
        "linkAccountsInstructionsText": (
            "Каб звязаць 2 акаўнта, стварыце код на першым\n"
        ...
        "signInInfoText": (
            "Увайдзіце, каб збіраць квіткі, удзельнічаць у спаборніцтвах \n"
        ...
        "testAccountWarningCardboardText": (
            'Увага: вы ўваходзіце з "тэст"-акаунта.\n'
    ...
    "buttonText": "Кнопка",
    "canWeDebugText": (
        "Ці жадаеце вы аўтаматычна паведамляць аб багах\n"
    ...
    "configGamepadSelectWindow": {
        ...
        "pressAnyButtonText": (
            "Націсніце любую кнопку на кантролеры,\n" " які вы жадаеце наладзіць..."
        ),
    ...
    "configGamepadWindow": {
        ...
        "secondHalfText": (
            "Выкарыстоўвайце гэта для наладжвання\n"
    ...
    "configKeyboardWindow": {
        ...
        "keyboard2NoteText": (
            "Амаль усе клавіятуры могуць перадаць толькі некалькі \n"
    ...
    "configTouchscreenWindow": {
        ...
        "swipeInfoText": (
            "Да кантролераў, працуючых са змахваннямі, неабходна \n"
    ...
    "connectMobileDevicesWindow": {
        ...
        "bestResultsText": (
            "Для лепшых вынікаў вам спатрэбіцца добрая WiFi сетка. Вы можаце\n"
        ...
        "explanationText": (
            "Для ўжывання смартфона ці планшэта ў якасці кантролера\n"
        ...
        "forIOSText": "для iOS:",
        "getItForText": (
            "Атрымайце ${REMOTE_APP_NAME} для iOS у Apple App Store\n"
    ...
    "coopSelectWindow": {
        ...
        "activenessInfoText": (
            "Гэты множнік павышаецца калі вы гуляеце\n"
            "і паніжаецца калі вы не гуляеце."
        ),
        "activityText": "Актыўнасць",
        "campaignText": "Кампанія",
        "challengesInfoText": (
            "Зарабляйце прызы для завяршэння міні-гульняў.\n"
            "\n"
        ...
        "welcome1Text": (
            "Рады бачыць вас у лізе ${LEAGUE}. Вы можаце палепшыць\n"
            "ваш узровень лігі, калі будзеце зарабляць рэйтынг,\n"
            "выконваць дасягненні і атрымліваць трафеі."
        ),
        "welcome2Text": (
            "Вы таксама можаце зарабляць білеты многімі з такіх жа\n"
    ...
    "editProfileWindow": {
        ...
        "globalProfileInfoText": (
            "Кожны глабальны профіль мае асабістае імя.\n"
        ...
        "localProfileInfoText": (
            "Лакальныя профілі не маюць аватараў, а іх імёны не абавязкова\n"
        ...
        "upgradeProfileInfoText": (
            "Гэта захавае вашае імя гульца і дазволіць\n" "выбраць аватар для профіля."
        ),
    ...
    "fireTVRemoteWarningText": (
        "* Для больш зручнай гульні карыстайцеся\n"
    ...
    "gatherWindow": {
        ...
        "appInviteInfoText": (
            "Запрасіце сяброў у гульню, і яны атрымаюць\n"
        ...
        "disconnectClientsText": (
            "Гэта адлучыць ${COUNT} гульцоў з вашага\n" "лоббі. Вы ўпэўнены?"
        ),
        "earnTicketsForRecommendingAmountText": (
            "Сябры атрымаюць ${COUNT} квіткоў, калі яны паспрабуюць гульню\n"
        ...
        "friendPromoCodeInfoText": (
            "Ён можа быць абменены на ${COUNT} квіткоў.\n"
            "\n"
        ...
        "friendPromoCodeInstructionsText": (
            'Каб скарыстацца ім, зайдзіце ў "Налады -> Дадатковыя -> Увесці прома-код" у ${APP_NAME}.\n'
        ...
        "googlePlayReInviteText": (
            "У вашым лоббі знаходзяцца ${COUNT} гульцоў з Google Play,\n"
        ...
        "inviteAFriendText": (
            "У сяброў няма гульні? Запрасіце іх паспрабаваць,\n"
        ...
        "wifiDirectDescriptionTopText": (
            "Wi-Fi Direct можа выкарыстоўвацца для злучэння Android прылад непасрэдна,\n"
    ...
    "getTicketsWindow": {
        ...
        "unavailableLinkAccountText": (
            "Прабачце, пакупкі недаступныя на гэтай платформе.\n"
    ...
    "helpWindow": {
        ...
        "controllersInfoText": (
            "Вы можаце гуляць у ${APP_NAME} з сябрамі праз сетку або, калі\n"
        ...
        "controlsText": "Прыёмы",
        "devicesInfoText": (
            "Вы можаце гуляць гуляць у ${APP_NAME} па сетцы, таму\n"
        ...
        "devicesText": "Прылады",
        "friendsGoodText": (
            "Вельмі добра іх мець. У ${APP_NAME} весялей гуляць з некалькімі\n"
        ...
        "powerupImpactBombsDescriptionText": (
            "Нямнога слабейшая за звычайную,\n" "але падрываецца пры ўдары."
        ),
    ...
    "installDiskSpaceErrorText": (
        "ПАМЫЛКА: Немагчыма закончыць усталёўку.\n"
    ...
    "internal": {
        ...
        "connectionFailedVersionMismatchText": (
            "Далучэнне немагчыма; хост карыстаецца іншай версіяй гульні.\n"
        ...
        "incompatibleVersionHostText": (
            "Хост працуе з іншай версіяй гульні. Пераканайцеся,\n"
            "што вы абодва абноўлены і паспрабуйце яшчэ раз."
        ),
        "incompatibleVersionPlayerText": (
            "${NAME} працуе з іншай версіяй гульні. Пераканайцеся,\n"
            "што вы абодва абноўлены і паспрабуйце яшчэ раз."
        ),
        ...
        "joinedPartyInstructionsText": (
            "Сябр далучыўся да вашага лоббі.\n"
        ...
        "vrOrientationResetCardboardText": (
            "Скарыстайцеся гэтым, каб скінуць VR арыентацыю.\n"
    ...
    "newTestBuildAvailableText": (
        "Новая тэставая зборка даступна! (${VERSION} build ${BUILD}).\n"
    ...
    "noProfilesErrorText": (
        "У вас няма ніводнага профіля, таму вас будуць называць '${NAME}'.\n"
    ...
    "pleaseRateText": (
        "Калі вам падабаецца ${APP_NAME}, калі ласка, знайдзіце\n"
    ...
    "ps3ControllersWindow": {
        "macInstructionsText": (
            "Адключыце харчаванне на задняй панэлі PS3, пераканайцеся, што Bluetooth\n"
        ...
        "ouyaInstructionsText": (
            "Каб выкарыстоўваць кантролер PS3 з OUYA, проста падключыце яго адзін раз\n"
    ...
    "remoteAppInfoShortText": (
        "Гуляць ў ${APP_NAME} значна цікавей з сям'ёй ці сябрамі.\n"
    ...
    "remote_app": {
        ...
        "connected": "Злучана.",
        "description": (
            "Выкарыстоўвайце ваш тэлефон ці планшэт у якасці кантролераў.\n"
        ...
        "searching_caption": (
            "Націсніце на імя гульні, каб падлучыцца.\n"
    ...
    "replayVersionErrorText": (
        "Прабачце, запіс быў зроблены ў старай версіі\n"
    ...
    "reportPlayerExplanationText": (
        "Напішыце на гэты email, каб паскардзіцца на махлярства ці іншыя дрэнныя паводзіны.\n"
    ...
    "settingsWindowAdvanced": {
        ...
        "helpTranslateText": (
            "Пераклад ${APP_NAME} з англійскай мовы - намаганне супольнасці\n"
    ...
    "store": {
        ...
        "bombSquadProDescriptionText": (
            "• Дублюе ўсе білеты, якія вы атрымліваеце\n"
        ...
        "freeBombSquadProText": (
            "BombSquad зараз бясплатны, але калі вы набылі яго раней, зараз вы атрымліваеце\n"
    ...
    "storeDescriptionText": (
        "Гульнявое Вар'яцтва з 8 Гульцамі!\n"
        "\n"
    ...
    "translations": {
        ...
        "gameDescriptions": {
            (
                ...
                "Каб перамагчы, стань абраным на некаторы час.\n"
        ...
        "playlistNames": {"Just Epic": "Толькі Эпічна", "Just Sports": "Толькі Спорт"},
        "scoreNames": {
            "Flags": "Сцягі",
            "Goals": "Галы",
            "Score": "Ачкі",
        ...
        "serverResponses": {
            ...
            (
                ...
                "Вы ўпэўнены, што жадаеце звязаць гэтыя акаўнты?\n"
                "\n"
                "${ACCOUNT1}\n"
                "${ACCOUNT2}\n"
                "\n"
            ...
            (
                ...
                "Атрымана ${COUNT} квіткоў за ўваход.\n"
            ...
            (
                ...
                "Ваша версія гульні была мадыфікавана.\n"
        ...
        "tips": {
            (
                ...
                'Своечасовая паслядоўнасць "Бег-Скачок-Кручэнне-Удар" можа забіць\n'
            ...
            (
                ...
                "Стварайце профілі для сябе і вашых сяброў з асабістымі імёнамі і\n"
            ...
            (
                ...
                "Скрыні Смерці хутка ператвараюць вас у бомбу.\n"
            ...
            (
                ...
                "Незалежна ад знешняга выгляду, здольнасці ўсіх персанажаў \n"
            ...
            (
                ...
                "Націсніце любую кнопку, каб бяжаць. Канечне, вы будзеце \n"
            ...
            (
                ...
                "Ледзяныя бомбы не вельмі моцныя, але яны спыняюць усіх\n"
            ...
            (
                ...
                "Калі хтосьці вас схапіў, бейце яго, і ён адпусціць.\n"
            ...
            (
                ...
                "Калі ў вас няма кантролераў, усталюйце прыкладанне ${REMOTE_APP_NAME} на \n"
            ...
            (
                ...
                "Калі вам не хапае кантролераў, усталюйце прыкладанне 'BombSquad Remote'\n"
            ...
            (
                ...
                "Калі вы злавілі бомбу-ліпучку, прыгайце і бегайце. Магчыма, вам пашанцуе, і вы \n"
            ...
            (
                ...
                "Калі вы падхапілі смяротны бонус, адзіная надзея - знайсці\n"
            ...
            (
                ...
                'Калі ў вашым лоббі гуляе многа людзей, уключыце "Аўтаматычнае выкідванне пры\n'
            ...
            (
                ...
                "Калi ваша прылада награваецца цi вы жадаеце захаваць запад батарэi,\n"
            ...
            (
                ...
                "Калi карцiнка  перарывiстая, паспрабуйце паменьшыць разрэшэнне\n"
            ...
            (
                ...
                "У Захопе Сцяга ваш сцяг павiнен быць на вашай базе, каб захапiць чужы, калi чужая \n"
            ...
            (
                ...
                "Многа рэчаý магчыма ýзняць i кiнуць, уключна другiх гулбцоý. Шпурлянне \n"
            ...
            (
                ...
                "Гульцы могуць далучацца i зыходзiць ý сярэдзiне многiх гульняý, \n"
            ...
            (
                ...
                "Удары робяць тым больш  урону, чым хутчэй вы бяжыце перад iмi,\n"
            ...
            (
                ...
                "Гэты ўзровень бясконцы, але высокія ачкі тут\n"
            ...
            (
                ...
                "Моц кідку залежыць ад накірунку, які націснут. Каб акуратна \n"
            ...
            (
                ...
                "Надакучыў саундтрэк? Змяніце яго на свой!\n"
            ...
            (
                ...
                "Вы можаце накіроўваць удары, круцячыся ў правы ці ў левы бок.\n"
            ...
            (
                ...
                "Час выбуху бомбы магчыма адгадаць па колеры іскраў ад кнота:\n"
            ...
            (
                ...
                "Вы атрымліваеце страты, калі б'ецеся галавой,\n"
    ...
    "xbox360ControllersWindow": {
        ...
        "macInstructions2Text": (
            "Каб выкарыстоўваць бесправадныя кантролеры, вам таксама патрэбен \n"
        ...
        "macInstructionsText": (
            "Для выкарыстання кантролераў Xbox 360, вы павінны будзеце ўсталяваць\n"
            "драйвер для Mac, даступны па спасылцы ніжэй.\n"
            "Гэта працуе як з праваднымі, так і з бесправаднымі кантролерамі."
        ),
        "ouyaInstructionsText": (
            "Для выкарыстання правадных кантролераў  Xbox 360 з BombSquad, проста\n"
