...
values = {
    "accountSettingsWindow": {
        ...
        "linkAccountsInstructionsNewText": (
            "برای اتصال دو حساب کاربری، ابتدا یک کد در حساب اول بسازید\n"
        ...
        "resetProgressConfirmNoAchievementsText": (
            "همه ی پیشرفت شما در بخش همکاری و بالاترین امتیازات شما پاک خواهد شد.\n"
            "(به استثنای بلیط های شما)\n"
            "این تغییرات خنثی نخواهد شد ، آیا مطمئنید ؟"
        ),
        "resetProgressConfirmText": (
            "تمام پیشرفت‌ها در بخش همکاری ، دستاوردها\n"
        ...
        "setAccountNameDesc": (
            "اسمی که میخواهید برای این حساب نمایش داده شود را انتخاب کنید\n"
            "شما میتوانید یکی از اسم های حساب های وصل شده استفاده کنید \n"
            "یا یک اسم جدید بسازید"
        ),
        "signInInfoText": (
            "به حساب خود وصل شوید تا بلیط جمع کنید ، آنلاین رقابت کنید \n"
    ...
    "alreadySignedInText": (
        "این حساب کاربری توسط یک دستگاه دیگر در حال استفاده می باشد.\n"
    ...
    "buttonText": "دکمه",
    "canWeDebugText": (
        "آیا مایلید که بازی، اتوماتیک خرابی ها \n"
    ...
    "configGamepadSelectWindow": {
        ...
        "pressAnyButtonText": (
            "یکی از دکمه های دسته ای که میخواهید\n" " تنظیم کنید را فشار دهید"
        ),
    ...
    "configGamepadWindow": {
        ...
        "secondHalfText": (
            'از این برای تنظیم نیمه ی دوم "دو دسته\n'
    ...
    "configKeyboardWindow": {
        ...
        "keyboard2NoteText": (
            "تذکر:بیشتر کیبوردها فقط چند دکمه را همزمان میپذیرند\n"
    ...
    "configTouchscreenWindow": {
        ...
        "swipeInfoText": (
            "کمی طول میکشد به این نوع حرکت عادت کنید\n"
    ...
    "connectMobileDevicesWindow": {
        ...
        "bestResultsText": (
            "برای بهترین نتایج شما به یک شبکه وای‌فای بدون لَگ نیاز دارید\n"
        ...
        "explanationText": (
            "برای استفاده کردن از یک گوشی هوشمند یا تبلت به عنوان دسته ی بی سیم\n"
        ...
        "forIOSText": "iOS برای",
        "getItForText": (
            "بگیرید فروشگاه برنامه اپل را برای اپلی‌ها از ${REMOTE_APP_NAME} برنامه\n"
    ...
    "coopSelectWindow": {
        ...
        "activenessInfoText": (
            "این افزاینده امتیاز بیشتر می‌شود در روزهایی که\n"
            "بازی میکنید و در روزهایی که بازی نمی‌کنید"
        ),
        "activityText": "فعالیت",
        "campaignText": "عملیات",
        "challengesInfoText": (
            ".برای پیروزی در مینی بازی ها جایزه بگیرید\n"
            "\n"
        ...
        "prizesText": "جایزه ها",
        "proMultInfoText": (
            "ارتقا داده اند ${PRO} بازیکنانی که بازی را به\n"
        ...
        "totalText": "در مجموع",
        "tournamentInfoText": (
            "بر سر امتیاز بیشتر با بازیکنان در\n"
            ".لیگ خود رقابت کنید\n"
            "\n"
        ...
        "welcome1Text": (
            "خوش آمدید. شما میتوانید ${LEAGUE} به لیگ\n"
            "با گرفتن امتیاز، کامل کردن دستاوردها یا گرفتن جام\n"
            ".در مسابقات رتبه ی خود را بهبود بخشید"
        ),
        "welcome2Text": (
            ".همچنین میتوانید از راه های مشابه بلیط جمع آوری کنید\n"
    ...
    "creditsWindow": {
        ...
        "songCreditText": (
            "اجرا شده و ${PERFORMER} توسط ${TITLE} آهنگ\n"
    ...
    "editProfileWindow": {
        ...
        "globalProfileInfoText": (
            "ضمانت میشود که پروفایل های جهانی بازیکنان نام های\n"
        ...
        "localProfileInfoText": (
            "پروفایل های محلی بازیکنان تندیس ندارند و ضمانت نمیشود\n"
        ...
        "upgradeProfileInfoText": (
            "این کار نام بازیکن شما را در جهان ذخیره میکند\n"
    ...
    "fireTVRemoteWarningText": (
        "برای یک تجربه ی بهتر، از دسته ها*\n"
    ...
    "gatherWindow": {
        ...
        "disconnectClientsText": (
            "بازیکن را از ${COUNT} این کار ارتباط\n" "بازی قطع میکند. مطمئنید؟"
        ),
        "earnTicketsForRecommendingAmountText": (
            ".بلیط خواهند گرفت اگر این بازی را امتحان کنند ${COUNT} دوستانتان\n"
        ...
        "friendPromoCodeInstructionsText": (
            ".را باز کنید و به قسمت تنظیمات>پیشرفته>وارد کردن کد بروید${APP_NAME}برای استفاده از کد، برنامه\n"
        ...
        "googlePlayReInviteText": (
            "بازیکن از گوگل پلی در گروه شما هستند${COUNT}\n"
        ...
        "inviteAFriendText": (
            "رفیقات این بازی رو ندارند؟ دعوتشون کن\n"
        ...
        "wifiDirectDescriptionBottomText": (
            "داشته باشند حتماً میتونید ازش استفاده کنندWi-Fi Direct اگر دستگاه هاتون قابلیت\n"
        ...
        "wifiDirectDescriptionTopText": (
            "استفاده کرد تا دستگاه های اندرویدی را مستقیماً بهم وصل کرد بدونWi-Fi Directمیشود از\n"
    ...
    "getTicketsWindow": {
        ...
        "unavailableLinkAccountText": (
            ".ببخشید،خرید به وسیله ی این دستگاه در دسترس نمیباشد\n"
    ...
    "helpWindow": {
        ...
        "controllersInfoText": (
            "بازی کنید و یا${APP_NAME}میتوانید توسط شبکه با دوستانتان\n"
        ...
        "devicesInfoText": (
            "نسخه وی آر ${APP_NAME} میتونه با شبکه با\n"
        ...
        "friendsGoodText": (
            "داشتن چنتا ازینا خیلی خوبه.  ${APP_NAME} حالش بیشتره وقتی با چن نفر\n"
    ...
    "internal": {
        ...
        "connectionFailedVersionMismatchText": (
            "ارتباط ناموفق بود؛ میزبان در حال اجرا یک نسخه متفاوت از بازی است.\n"
        ...
        "incompatibleNewerVersionHostText": (
            "میزبان در حال استفاده از نسخه جدید تری از بازی هست نسخه بازیتون رو به اخرین نسخه ارتقا بدین\n"
            "دوباره امتحان کنید"
        ),
        "incompatibleVersionHostText": (
            "میزبان در حال اجرا از نسخه دیگری از این بازی است.\n"
            "مطمئن شوید که شما هر دو تا بروز هستید و دوباره امتحان کنید."
        ),
        "incompatibleVersionPlayerText": (
            "${NAME} در حال اجرا از نسخه دیگری از این بازی است.\n"
            "مطمئن شوید که شما هر دو تا بروز هستید و دوباره امتحان کنید."
        ),
        ...
        "touchScreenJoinWarningText": (
            "You have joined with the touchscreen.\n"
        ...
        "vrOrientationResetCardboardText": (
            "برای تنظیم مجدد جهت گیری VR از این استفاده کنید.\n"
    ...
    "macControllerSubsystemMFiNoteText": (
        ".ساخته شده برای کنترلر آی‌اواِس/مک تشخیص داده شد\n"
    ...
    "newTestBuildAvailableText": (
        "تست جدید ساخته شده در دسترس است! (${VERSION} ساختن ${BUILD}).\n"
        "در مسیر ${ADDRESS}"
    ),
    "newText": "جدید",
    ...
    "pleaseRateText": (
        "If you're enjoying ${APP_NAME}, please consider taking a\n"
    ...
    "promoCodeWindow": {"codeText": "کد", "enterText": "ورود"},
    "promoSubmitErrorText": "خطا در ارسال کد،لطفا اتصال اینترنت را بررسی کنید",
    "ps3ControllersWindow": {
        "macInstructionsText": (
            "Switch off the power on the back of your PS3, make sure\n"
        ...
        "ouyaInstructionsText": (
            "To use a PS3 controller with your OUYA, simply connect it with a USB cable\n"
    ...
    "remoteAppInfoShortText": (
        ".خیلی جذاب تره وقتی با دوستانتون بازی می کنید ${APP_NAME} بازی\n"
    ...
    "remote_app": {
        ...
        "connected": ".متصل شد",
        "description": (
            "استفاده کنید از تبلت یا گوشی مبایل برای کنترول کردن بازی بمب اسکواد\n"
        ...
        "searching_caption": (
            "بر روی نام یک بازی برای پیوستن به آن ضربه بزنید.\n"
    ...
    "reportPlayerExplanationText": (
        "از این ایمیل برای گزارش تقلب، زبان نامناسب یا موارد نامناسب دیگر استفاده کنید.\n"
    ...
    "settingsWindowAdvanced": {
        ...
        "helpTranslateText": (
            "${APP_NAME}'s non-English translations are a community\n"
    ...
    "store": {
        ...
        "bombSquadProDescriptionText": (
            "• Doubles achievement ticket rewards\n"
            "• Removes in-game ads\n"
        ...
        "freeBombSquadProText": (
            "جوخه بمب حالا مجانیه، ولی چون شما زمانی خریدینش که پولی بود؛ ما داریم\n"
    ...
    "translations": {
        ...
        "gameDescriptions": {
            (
                ...
                "یکی از بهترین ها برای پیروزی در زمان بازی است.\n"
        ...
        "inputDeviceNames": {"Keyboard": "صفحه کلید", "Keyboard P2": "p2 صفحه کلید"},
        "languages": {
            "Arabic": "عربی",
            "Belarussian": "بلاروس",
            "Chinese": "چینی",
        ...
        "playlistNames": {"Just Epic": "فقط حرکت آهسته", "Just Sports": "فقط ورزشی"},
        "scoreNames": {
            "Flags": "پرچم ها",
            "Goals": "اهداف",
            "Score": "امتیاز",
        ...
        "serverResponses": {
            ...
            (
                ...
                "آیا مطمین هستید که میخواید این حساب بسته بشه؟\n"
                "\n"
                "${ACCOUNT1}\n"
                "${ACCOUNT2}\n"
                "\n"
            ...
            (
                ...
                "پیوند کردن ممنوع شد ${ACCOUNT} شامل\n"
            ...
            (
                ...
                "آیا مایلید که حساب کاربری ${ACCOUNT} را به حساب خودتان متصل کنید؟\n"
            ...
            (
                ...
                "بدست آمده ${COUNT} بلیت برای ورود به سیستم.\n"
            ...
            (
                ...
                "این نسخه از بازی دیگر توسط سرور پشتیبانی نمی شود.\n"
            ...
            (
                ...
                "آیا مایلبد حساب ${ACCOUNT} را از حساب خودتان جداسازی کنید؟\n"
            ...
            (
                ...
                "اخطار: شکایت هایی مبنی بر استفاده شما از ابزار های تقلب به دست ما رسیده!\n"
        ...
        "tips": {
            (
                ...
                "یه مشت جهشی پرشی چرخشی با زمان بندی درست ، با یه ضربه حریف رو نابود میکنه\n"
            ...
            (
                ...
                "برای خودت و کسانی که باهاشون بازی می کنی پروفایل بساز تا\n"
            ...
            (
                ...
                "جعبه ی مرگ تو رو تبدیل به یه بمب ساعتی می کنه\n"
            ...
            (
                ...
                "تمام کارکتر های بازی دارای توانایی های یکسانی هستند بنابراین شما فقط کافیه\n"
            ...
            (
                ...
                "موقع حرکت یه دکمه رو همزمان نگهدار مثلا مشت رو تا سرعت حرکت بیشتر شه\n"
            ...
            (
                ...
                "بمب های یخی برا نابودی خیلی قدرتمند نیستن ولی نزدیک هر کی منفجر بشه منجمد میشه \n"
            ...
            (
                ...
                "اگه کسی شما رو از زمین بلند کرد با مشت و پرش و کشیدن اجازه \n"
            ...
            (
                ...
                "اگر روی کنترلرها کوتاه هستید، برنامه '${REMOTE_APP_NAME}' را نصب کنید\n"
            ...
            (
                ...
                "اگر بمب چسبنده ای به شما چسبید به اطراف بپرید و بچرخید\n"
            ...
            (
                ...
                "اگه یه جعبه نابودگر رو به اشتباه گرفتین کارتون تمومه مگه اینکه ظرف چند\n"
            ...
            (
                ...
                'اگر تعداد زیادی از بازیکنان در حال رفت و آمد هستند، بازیکنان "بیروت انداختن بازیکنان غیرفعال" را روشن کنید\n'
            ...
            (
                ...
                "اگر دستگاه شما بیش از حد گرم می شود یا شما می خواهید برای حفظ قدرت باتری،\n"
            ...
            (
                ...
                "اگر دیدید که نرخ فریم تصویر کمی متلاطم است کاهش بدید رزولوشن \n"
            ...
            (
                ...
                "توی بازی رساندن پرچم ، باید پرچم تیم شما همون جا باقی بمونه\n"
            ...
            (
                ...
                "خیلی چیزها می تونن از زمین برداشته بشن ... حتی بازیکنهای دیگه\n"
            ...
            (
                ...
                "بازیکن ها میتونن هر زمان وسط بازی وارد بازی بشن\n"
            ...
            (
                ...
                "سر آسیب پذیر ترین قسمت بدن یه بازیکنه بطوریکه \n"
            ...
            (
                ...
                "این مرحله هیچ وقت تمام نمی شود\n"
            ...
            (
                ...
                "هر چیزی دستت باشه به اون سمتی پرتاب میشه که داری حرکت میکنی\n"
            ...
            (
                ...
                "! از موزیک بازی خوشت نمیاد ؟ خب عوضش کن\n"
            ...
            (
                ...
                "شما می تونید مشت های خودتون رو به جهت مشخصی وارد کنید با چرخیدن به چپ و راست\n"
            ...
            (
                ...
                "با دیدن رنگ جرقه ی بمب میشه فهمید چه موقع منفجر میشه\n"
                "!!!! زرد ... نارنجی ... قرمز ... بوم"
            ),
            ...
            (
                ...
                "شما آسیب می بینید زمانی که سرتون به چیزی برخورد میکنه پس بیشر احتیاط کنید\n"
    ...
    "wiimoteSetupWindow": {
        ...
        "listenText": "گوش بده",
        "macInstructionsText": (
            "اطمینان حاصل کنید که رشته خود خاموش است و بلوتوث را فعال کنید\n"
    ...
    "xbox360ControllersWindow": {
        ...
        "macInstructions2Text": (
            "برای استفاده از کنترلرها به صورت بی سیم، شما همچنین باید گیرنده را دریافت کنید\n"
        ...
        "macInstructionsText": (
            "برای استفاده از کنترلر Xbox 360، باید نصب کنید\n"
            "درایور Mac موجود در لینک زیر است.\n"
            "با کنترلر های سیمی و بی سیم کار می کند."
        ),
        "macInstructionsTextScale": 0.8,
        "ouyaInstructionsText": (
            "برای استفاده از کنترلر Xbox 360 با BombSquad، به سادگی\n"
