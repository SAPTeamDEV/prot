...
values = {
    "accountSettingsWindow": {
        ...
        "linkAccountsInstructionsNewText": (
            "Aby połączyć dwa konta, wygeneruj kod na pierwszym,\n"
        ...
        "linkAccountsInstructionsText": (
            "By połączyć dwa konta, wygeneruj kod\n"
        ...
        "setAccountNameDesc": (
            "Wybierz nazwę do wyświetlenia dla swojego konta.\n"
            "Możesz użyć nazwy z jednego z połączonych kont\n"
            " lub utworzyć unikalną niestandardową nazwę."
        ),
        "signInInfoText": (
            "Zapisz się, by zbierać kupony, rywalizować online\n"
        ...
        "testAccountWarningText": (
            'Ostrzeżenie: możesz się zapisać używając konta "test".\n'
    ...
    "allowText": "Zezwól",
    "alreadySignedInText": (
        "Twoje konto jest zalogowane z innego urządzenia;\n"
    ...
    "buttonText": "Przycisk",
    "canWeDebugText": (
        "Chcesz aby BombSquad automatycznie raportował błędy,\n"
    ...
    "configGamepadSelectWindow": {
        ...
        "pressAnyButtonText": (
            "Naciśnij dowolny przycisk kontrolera\n" "jeśli chcesz go skonfigurować..."
        ),
    ...
    "configGamepadWindow": {
        ...
        "secondHalfText": (
            "Użyj aby skonfigurować drugiego kontrolera,\n"
    ...
    "configKeyboardWindow": {
        ...
        "keyboard2NoteText": (
            "Uwaga: większość klawiatur pozwala na jednoczesne naciśnięcie\n"
    ...
    "configTouchscreenWindow": {
        ...
        "swipeInfoText": (
            "Kontrolowanie poprzez styl 'Swipe' wymaga przyzwyczajenia\n"
    ...
    "connectMobileDevicesWindow": {
        ...
        "bestResultsText": (
            "Dla lepszych efektów stwórz szybką sieć bezprzewodową.\n"
        ...
        "explanationText": (
            "Aby użyć smartfona lub tableta jako kontrolera w grze, zainstaluj w nich \n"
        ...
        "forIOSText": "dla iOS:",
        "getItForText": (
            "Pobierz ${REMOTE_APP_NAME} dla systemu iOS ze sklepu Apple, a \n"
    ...
    "coopSelectWindow": {
        ...
        "activenessInfoText": (
            "Ten mnożnik wzrasta w dniach, kiedy grasz\n"
            "i spada w dni, kiedy nie grasz."
        ),
        "activityText": "Aktywność",
        "campaignText": "Kampania",
        "challengesInfoText": (
            "Zdobywaj nagrody za wykonywanie mini-gier.\n"
            "\n"
        ...
        "prizesText": "Nagrody",
        "proMultInfoText": (
            "Gracze z aktualizacją ${PRO} otrzymują\n" "${PERCENT}% punktów więcej."
        ),
        "seeMoreText": "Więcej...",
        ...
        "totalText": "Suma",
        "tournamentInfoText": (
            "Graj o wysokie wyniki z innymi graczami z twojej ligi.\n"
            "\n"
        ...
        "welcome1Text": (
            "Witaj w ${LEAGUE}. Możesz podnieść swój ligowy\n"
            "ranking zdobywając gwiazdki, kompletując osiągnięcia\n"
            "i wygrywając trofea w turniejach."
        ),
        "welcome2Text": (
            "Możesz również zdobywać kupony z wielu tych samych działań.\n"
    ...
    "creditsWindow": {
        ...
        "songCreditText": (
            "${TITLE} wykonywana przez ${PERFORMER}.\n"
    ...
    "difficultyHardUnlockOnlyText": (
        "Ten poziom może zostać odblokowany tylko w trudnym trybie.\n"
    ...
    "editProfileWindow": {
        "accountProfileInfoText": (
            "To jest specjalny profil z nazwą i ikonką\n"
        ...
        "globalProfileInfoText": (
            "Profilowi globalnemu możesz wybrać unikalną nazwę.\n"
        ...
        "localProfileInfoText": (
            "Lokalny profil gracza nie możemieć ikonki i nie ma\n"
        ...
        "upgradeProfileInfoText": (
            "To zarezerwuje nazwę gracza tylko dla\n"
    ...
    "fatalErrorText": (
        "O nie, czegoś brakuje lub jest uszkodzone.\n"
    ...
    "gameSettingsWindow": {"addGameText": "Dodaj grę"},
    ...
    "gatherWindow": {
        "aboutDescriptionLocalMultiplayerExtraText": (
            "Pamiętaj: każde urządzenie podczas imprezy może posiadać\n"
            "więcej niż jednego gracza jeśli masz więcej kontrolerów."
        ),
        "aboutDescriptionText": (
            "Używaj tych zakładek aby zorganizować imprezę.\n"
            "\n"
        ...
        "appInviteInfoText": (
            "Zaproś przyjaciół by wypróbowali BombSquada, a dostaną \n"
        ...
        "disconnectClientsText": (
            "Spowoduje to rozłączenie ${COUNT} graczy\n"
            "będących na imprezie. Jesteś pewny?"
        ),
        "earnTicketsForRecommendingAmountText": (
            "Znajomi dostaną ${COUNT} kuponów jeżeli wypróbują grę\n"
        ...
        "friendPromoCodeInfoText": (
            "Może zostać wykupione do ${COUNT} kuponów.\n"
            "\n"
        ...
        "friendPromoCodeInstructionsText": (
            'Aby użyć, otwórz ${APP_NAME} i idź do "Ustawienia->Zaawansowane-> Wpisz kod".\n'
        ...
        "googlePlayReInviteText": (
            "Obecnie jest ${COUNT} graczy Google Play'a na imprezie,\n"
        ...
        "wifiDirectDescriptionBottomText": (
            "Jeśli wszystkie urządzenia posiadają panel 'Wi-Fi Direct', to powinny użyć go aby\n"
        ...
        "wifiDirectDescriptionTopText": (
            "Wi-Fi Direct może być używany do bezpośredniego łączenia urządzeń na\n"
    ...
    "getTicketsWindow": {
        ...
        "unavailableLinkAccountText": (
            "Niestety, zakupy nie są możliwe na tej platformie. \n"
    ...
    "helpWindow": {
        ...
        "controllersInfoText": (
            "Możesz zagrać w ${APP_NAME} ze znajomymi poprzez sieć lub na tym\n"
        ...
        "controllersInfoTextFantasia": (
            "Gracz może używać zdalnego kontrolera, jednak zalecane są\n"
        ...
        "controllersInfoTextMac": (
            "Jeden lub dwóch graczy może używać klawiatury, jednak najlepiej korzystać z\n"
        ...
        "controllersInfoTextOuya": (
            "Do gry w BombSquad możesz wykorzystać kontrolery OUYA, PS3, Xbox360\n"
        ...
        "controlsText": "Przyciski",
        "devicesInfoText": (
            "Wersja VR ${APP_NAME} może być używana w rozgrywce sieciowej wraz z\n"
        ...
        "friendsGoodText": (
            "Dobrze ich mieć. ${APP_NAME} sprawia największą frajdę\n"
    ...
    "installDiskSpaceErrorText": (
        "BŁĄD: Niemożliwe dokończenie instalacji.\n"
    ...
    "internal": {
        ...
        "connectionFailedVersionMismatchText": (
            "Połączenie nieudane; host pracuje na innej wersji gry.\n"
        ...
        "incompatibleVersionPlayerText": (
            "${NAME} pracuje na innej wersji gry.\n"
            "Upewnij się, że masz aktualne wersje gry i spróbuj ponownie."
        ),
        ...
        "touchScreenJoinWarningText": (
            "Dołączyłeś się wykorzystując ekran dotykowy.\n"
        ...
        "vrOrientationResetCardboardText": (
            "Użyj tego aby zresetować orientację VR.\n"
    ...
    "mustInviteFriendsText": (
        "Uwaga: aby zagrać sieciowo musisz\n"
    ...
    "noProfilesErrorText": (
        "Nie masz własnego profilu gracza, dlatego nazwano Cię: '${NAME}'.\n"
    ...
    "pleaseRateText": (
        "Jeśli polubiłeś ${APP_NAME}, proszę o poddanie go ocenie\n"
    ...
    "profileInfoText": (
        "Stwórz profile dla siebie i swoich znajomych\n"
    ...
    "ps3ControllersWindow": {
        "macInstructionsText": (
            "Wyłącz zasilanie konsoli PS3, upewnij się, że masz uruchomiony\n"
        ...
        "ouyaInstructionsText": (
            "Aby używać kontrolerów PS3 z konsolą OUYA, poprostu podłącz je kablem USB\n"
    ...
    "remoteAppInfoShortText": (
        "${APP_NAME} jest najfajniejszy gdy grasz z rodziną i przyjaciółmi. \n"
    ...
    "remote_app": {
        ...
        "connected": "Połączony.",
        "description": (
            "Użyj telefonu lub tabletu jako kontrolera w BombSquad.\n"
        ...
        "searching_caption": (
            "Kliknij na nazwę gry by do niej dołączyć.\n"
    ...
    "reportPlayerExplanationText": (
        "Użyj tego emaila by zgłosić oszukiwanie, nieprawidłowy język lub inne złe zachowanie.\n"
    ...
    "store": {
        ...
        "bombSquadProDescriptionText": (
            "• Zdobywanie podwójnych kuponów w grze\n"
        ...
        "bombSquadProNewDescriptionText": (
            "• Usuwa reklamy i wyskakujące okienka\n"
        ...
        "freeBombSquadProText": (
            "BombSquad jest teraz darmowy, ale kiedy go oficjalnie zakupisz wówczas\n"
    ...
    "translations": {
        ...
        "gameDescriptions": {
            (
                ...
                "Bądź wybrańcem przez określony czas aby wygrać.\n"
        ...
        "promoCodeResponses": {"invalid promo code": "nieprawidłowy kod promocyjny"},
        "scoreNames": {
            "Flags": "Flagi",
            "Goals": "Bramki",
            "Score": "Wynik",
        ...
        "serverResponses": {
            ...
            (
                ...
                "Na pewno chcesz połączyć te konta?\n"
                "\n"
                "${ACCOUNT1}\n"
                "${ACCOUNT2}\n"
                "\n"
            ...
            (
                ...
                "ŁĄCZENIE ODRZUCONE. ${ACCOUNT} zawiera\n"
            ...
            (
                ...
                "Połączyć konto ${ACCOUNT} z tym kontem?\n"
            ...
            (
                ...
                "Otrzymano ${COUNT} kuponów za zapisanie się. Wróć jutro aby otrzymać\n"
                "${TOMORROW_COUNT}."
            ),
            (
                ...
                "Funkcje serwerowe nie są dalej wspierane na tej wersji gry;\n"
            ...
            (
                ...
                "Rozłączyć konto ${ACCOUNT} z tego konta?\n"
            ...
            (
                ...
                "OSTRZEŻENIE: przeciwko Tobie zostały złożone skargi o oszukiwanie.\n"
            ...
            (
                ...
                "Twoja kopia gry została zmodyfikowana.\n"
        ...
        "tips": {
            (
                ...
                "Perfekcyjne w czasie wykonanie biegu, skoku, obrotu i uderzenia\n"
            ...
            (
                ...
                "Stwórz takie profile gracza (nazwa i wygląd) dla siebie i znajomych, które\n"
            ...
            (
                ...
                "Pudła z Klątwą zamienią Cię w tykającą bombę.\n"
            ...
            (
                ...
                "Pomimo różnego wyglądu, postacie posiadają te same umiejętności, więc ma\n"
            ...
            "Hold any button to run.  (Trigger buttons work well if you have them)": (
                "Przytrzymaj dowolny przycisk aby biec. (Triggery działają równie\n"
            ...
            (
                ...
                "Przytrzymaj dowolny przycisk aby biec. Wówczas osiągniesz szybciej\n"
            ...
            (
                ...
                "Lodowe bomby nie są potężne, ale potrafią zamrozić każdego kto\n"
            ...
            (
                ...
                "Jeśli ktoś Cię podniesie, uderz go wówczas Cię puści.\n"
            ...
            (
                ...
                "Jeśli brakuje Ci kontrolerów, zainstaluj aplikację '${REMOTE_APP_NAME}'\n"
            ...
            (
                ...
                "Jeśli brakuje Ci kontrolerów do gry, zainstaluj 'BombSquad Remote'\n"
            ...
            (
                ...
                "Jeśli przyklei się do Ciebie bomba przylepna, skacz i kręć się szalenie, to może ją\n"
            ...
            (
                ...
                "Jeśli zbierzesz 'Klątwę', to jedyną nadzieją aby\n"
                "przetrwać jest szybkie zebranie apteczki."
            ),
            "If you stay in one place, you're toast. Run and dodge to survive..": (
                "Jeśli będziesz się czaił w jednym miejscu to jesteś usmażony.\n"
            ...
            (
                ...
                "Jeśli doświadczasz dużej rotacji wśród graczy, najlepiej włącz 'auto wyrzucanie\n"
            ...
            (
                ...
                "Jeśli Twoje urządzenie mocno się przegrzewa powinieneś oszczędzić baterię\n"
            ...
            (
                ...
                "Jeśli ilość klatek na sekundę jest zbyt niska, spróbuj\n"
            ...
            (
                ...
                "W trybie 'Przechwycenia Flagi', Twoja flaga musi znajdować się w bazie aby zapunktować.\n"
            ...
            (
                ...
                "Można podnosić i rzucać wieloma rzeczami, włącznie z graczami. Zrzucanie\n"
            ...
            (
                ...
                "Gracze mogą dołączyć/opuścić grę w trakcie jej trwania,\n"
            ...
            (
                ...
                "Gracze mogą się dołączać/opuszczać grę w trakcie większości\n"
            ...
            (
                ...
                "Bonusy mają czasowe limity jedynie w rozgrywkach trybu Kooperacji.\n"
            ...
            (
                ...
                "Ciosy powodują większe obrażenia jeśli się energicznie porusza\n"
            ...
            (
                ...
                "Głowa jest najbardziej wrażliwym obszarem ciała, więc przyklejona\n"
            ...
            (
                ...
                "Ten poziom nigdy się nie kończy, ale jego wysoki wynik \n"
            ...
            (
                ...
                "Siła rzutu zależy od kierunku, który trzymasz. Aby delikatnie tylko\n"
            ...
            (
                ...
                "Zmęczony domyślną ścieżką dźwiękową? Zamień ją na swoją!\n"
            ...
            (
                ...
                "Możesz wycelować swoje uderzenia obracając się w lewo lub prawo.\n"
            ...
            (
                ...
                "Możesz sam kontrolować i określić czas kiedy bomba eksploduje\n"
            ...
            (
                ...
                "Nie musisz edytować swojego profilu aby zmienić postacie. Naciśnij górny\n"
            ...
            (
                ...
                "Przyjmujesz obrażenia jeśli uderzasz głową w różne\n"
    ...
    "trialPeriodEndedText": (
        "Wersja trial wygasła. Czy chcesz zakupić\n" "BombSquad i kontynuować grę?"
    ),
    ...
    "wiimoteLicenseWindow": {"titleText": "Prawa autorskie DarwiinRemote"},
    "wiimoteListenWindow": {
    ...
    "wiimoteSetupWindow": {
        ...
        "macInstructionsText": (
            "Upewnij się, że twój kontroler Wii jest wyłączony a\n"
        ...
        "thanksText": (
            "Podziękowania dla zespołu DarwiinRemote\n" "za wykonanie tej możliwości."
        ),
    ...
    "xbox360ControllersWindow": {
        ...
        "macInstructions2Text": (
            "Aby używać kontrolery bezprzewodowo, musisz posiadać odbiornik\n"
        ...
        "macInstructionsText": (
            "Aby użyć kontrolerów z konsoli Xbox360, musisz\n"
        ...
        "ouyaInstructionsText": (
            "Aby skorzystać z bezprzewodowych kontrolerów konsoli Xbox360,\n"
