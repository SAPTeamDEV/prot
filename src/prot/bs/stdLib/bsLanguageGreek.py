...
values = {
    "accountSettingsWindow": {
        ...
        "linkAccountsInstructionsNewText": (
            "Για να δεσμεύσετε δύο λογαριασμούς μεταξύ τους, δημιούργήστε έναν\n"
        ...
        "linkAccountsInstructionsText": (
            "Για να ενώσετε δυο λογαριασμούς, δημιουργήστε κωδικό\n"
        ...
        "resetProgressConfirmNoAchievementsText": (
            'Αυτό θα επαναφέρει τη πρόοδο σας στη "συνεργασία" και τις\n'
        ...
        "resetProgressConfirmText": (
            'Αυτό θα επαναφέρει τη πρόοδο σας στη "συνεργασία",\n'
        ...
        "setAccountNameDesc": (
            "Επιλέξτε το όνομα που θα φαίνεται στο λογαριασμό σας. Μπορείτε\n"
        ...
        "signInInfoText": (
            "Συνδεθείτε για να συλλέξετε εισητήρια, να συναγωνιστείτε στο διαδίκτυο\n"
    ...
    "alreadySignedInText": (
        "Ο λογαριασμός σας είναι συνδεδεμένος από άλλη συσκευή.\n"
    ...
    "buttonText": "κουμπί",
    "canWeDebugText": (
        "Θα θέλατε το BombSquad να στέλνει αυτόματη αναφορά σφαλμάτων,\n"
    ...
    "configGamepadSelectWindow": {
        ...
        "pressAnyButtonText": (
            "Πατήστε οποιοδήποτε πλήκτρο στο χειριστήριο\n"
    ...
    "configKeyboardWindow": {
        ...
        "keyboard2NoteText": (
            "Σημείωση: τα περισσότερα πληκτρολόγια μπορούν να υποστηρίξουν λίγα\n"
    ...
    "configTouchscreenWindow": {
        ...
        "swipeInfoText": (
            "Ο χειρισμός 'Swipe' παίρνει λίγο χρόνο μέχρι να τον συνηθίσετε αλλά\n"
    ...
    "connectMobileDevicesWindow": {
        ...
        "bestResultsText": (
            "Για καλύτερα αποτελέσματα θα πρέπει να έχετε wifi δίκτυο χωρίς\n"
        ...
        "explanationText": (
            "Για χρήση smart-phone ή tablet ως ασύρματο χειριστήριο,\n"
        ...
        "forIOSText": "για iOS:",
        "getItForText": (
            "Αποκτήστε το ${REMOTE_APP_NAME} για iOS στο App Store της Apple\n"
    ...
    "coopSelectWindow": {
        ...
        "prizesText": "Βραβεία",
        "proMultInfoText": (
            "Οι παίχτες με την ${PRO} αναβάθμιση\n"
        ...
        "totalText": "σύνολο",
        "tournamentInfoText": (
            "Ανταγωνιστείτε για υψηλά σκορ με\n"
        ...
        "welcome1Text": (
            "Καλωσήρθατε στη κατηγορία ${LEAGUE}. Μπορείτε να ανεβάσετε\n"
            "την κατάταξή σας κερδίζοντας βαθμολογίες αστεριών,\n"
            "ολοκληρώνοντας επιτεύγματα, και κερδίζοντας βραβεία σε τουρνουά."
        ),
        "welcome2Text": (
            "Μπορείτε ακόμα να κερδίσετε εισιτήρια με πολλές παρόμοιες δραστηριότητες.\n"
    ...
    "editProfileWindow": {
        "accountProfileInfoText": (
            "Αυτό το ειδικό προφίλ έχει όνομα και\n"
        ...
        "globalProfileInfoText": (
            "Τα παγκόσμια προφίλ παικτών εγγυώνται ότι εχουν μοναδικά\n"
        ...
        "localProfileInfoText": (
            "Τα τοπικά προφίλ παικτών δεν έχουν εικονίδια και τα ονόματά\n"
        ...
        "upgradeProfileInfoText": (
            "Αυτό θα κατοχυρώσει το όνομά του παίκτη σας παγκοσμίως\n"
    ...
    "failText": "Αποτυχία",
    "fatalErrorText": (
        "Ωχ; Κάτι λείπει ή έχει χαλάσει. Παρακαλώ,\n"
    ...
    "gameSettingsWindow": {"addGameText": "Προσθήκη Παιχνιδιού"},
    "gamesToText": "${WINCOUNT} - ${LOSECOUNT}",
    "gatherWindow": {
        "aboutDescriptionLocalMultiplayerExtraText": (
            "Θυμηθείτε: οποιαδήποτε συσκευή σε μια συγκέντρωση μπορεί να φιλοξενήσει\n"
            "περισσότερους από έναν παίκτες, αρκεί να υπάρχουν αρκετά χειριστήρια."
        ),
        "aboutDescriptionText": (
            "Χρησιμοποιήστε αυτές τις καρτέλες για να οργανώσετε μια συγκέντρωση.\n"
            "\n"
        ...
        "friendPromoCodeInstructionsText": (
            'Για να το αξιοποιήσετε, ανοίξτε το ${APP_NAME} και ακολουθήστε το "Ρυθμίσεις->Σύνθετες->Εισαγωγή Κωδικού".\n'
        ...
        "googlePlayReInviteText": (
            "Υπάρχουν ${COUNT} Google Play παίκτης/ες στη συγκέντρωσή\n"
        ...
        "inviteAFriendText": (
            "Οι φίλοι σας δεν έχουν το παιχνίδι? Προσκαλέστε τους\n"
        ...
        "wifiDirectDescriptionTopText": (
            "Το Wi-Fi Direct μπορεί να χρησιμοποιηθεί για την άμεση σύνδεση Android συσκευών χωρίς\n"
    ...
    "getTicketsWindow": {
        ...
        "unavailableLinkAccountText": (
            "Συγνώμη, οι αγορές δεν είναι διαθέσιμες σε αυτή την πλατφόρμα.\n"
    ...
    "helpWindow": {
        ...
        "controllersInfoText": (
            "Μπορείτε να παίξετε ${APP_NAME} με φίλους μέσω ενός δικτύου ή μπορείτε\n"
        ...
        "controlsText": "Χειρισμοί",
        "devicesInfoText": (
            "Η έκδοση VR του ${APP_NAME} μπορεί να παίξει μέσω δικτύου\n"
        ...
        "friendsGoodText": (
            "Καλό θα ήταν να έχετε. Το ${APP_NAME} είναι πιό διασκεδαστικό με πολλούς\n"
    ...
    "installDiskSpaceErrorText": (
        "ΣΦΑΛΜΑ: Αδύνατη η ολοκλήρωση της εγκατάστασης.\n"
    ...
    "internal": {
        ...
        "connectionFailedVersionMismatchText": (
            "Ανεπιτυχής σύνδεση. Ο οικοδεσπότης τρέχει μιά διαφορετική έκδοση του παιχνιδιού.\n"
        ...
        "incompatibleNewerVersionHostText": (
            "Ο οικοδεσπότης τρέχει μία νεότερη έκδοση το παιχνιδιού.\n"
            "Αναβαθμίστε στην πιο πρόσφατη έκδοση και ξαναπροσπαθήστε."
        ),
        "incompatibleVersionHostText": (
            "Ο οικοδεσπότης τρέχει μιά διαφορετική έκδοση του παιχνιδιού.\n"
            "Σιγουρευτείτε ότι και οι δύο έχετε την πιο πρόσφατη έκδοση και ξαναπροσπαθήστε."
        ),
        "incompatibleVersionPlayerText": (
            "Ο χρήστης ${NAME} τρέχει μιά διαφορετική έκδοση του παιχνιδιού.\n"
            "Σιγουρευτείτε ότι και οι δύο έχετε την πιο πρόσφατη έκδοση και ξαναπροσπαθήστε."
        ),
        ...
        "joinedPartyInstructionsText": (
            "Κάποιος εντάχθηκε στη συγκέντρωσή σας.\n"
        ...
        "touchScreenJoinWarningText": (
            "Έχετε ενταχθεί με την οθόνη αφής.\n"
    ...
    "macControllerSubsystemMFiNoteText": (
        "Εντοπίστηκε χειριστήριο φτιαγμένο-γιά-iOS/Mac.\n"
    ...
    "mustInviteFriendsText": (
        "Σημείωση: πρέπει να προσκαλέσετε φίλους από τον\n"
    ...
    "newTestBuildAvailableText": (
        "Μια νεότερη δοκιμαστική έκδοση είναι διαθέσιμη! (κύρια ${VERSION}, δοκιμαστική ${BUILD}).\n"
    ...
    "pleaseRateText": (
        "Εάν απολαμβάνετε το ${APP_NAME}, παρακαλώ σκεφτείτε να αφιερώσετε μιά στιγμή\n"
    ...
    "promoCodeWindow": {"codeText": "Κωδικός", "enterText": "Εισαγωγή"},
    "promoSubmitErrorText": "Σφάλμα κατά την υποβολή του κωδικού. Ελέγξτε την πρόσβασή σας στο διαδίκτυο",
    "ps3ControllersWindow": {
        "macInstructionsText": (
            "Απενεργοποιήστε το PS3 σας, σιγουρευτείτε ότι το Bluetooth\n"
        ...
        "ouyaInstructionsText": (
            "Για να χρησιμοποιήσετε ένα χειριστήριο PS3 με το OUYA σας, απλά συνδέστε το με ένα καλώδιο\n"
    ...
    "remote_app": {
        ...
        "connected": "Συνδέθηκε.",
        "description": (
            "Χρησιμοποίησε το τηλέφωνο ή το tablet σου ως χειριστήριο BombSquad!\n"
        ...
        "searching_caption": (
            "Πατήστε στο όνομα ένος παιχνδιού για να συνδεθείτε σε αυτό.\n"
            "Σιγουρευτείτε ότι βρίσκεστε στο ίδιο δίκτυο wifi με το παιχνίδι."
        ),
        "start": "Εκκίνηση",
        "version_mismatch": (
            "Οι εκδόσεις δεν ταιριάζουν.\n"
    ...
    "replayVersionErrorText": (
        "Συγνώμη, αυτή η επανάληψη δημιουργήθηκε σε μιά διαφορετική\n"
    ...
    "reportPlayerExplanationText": (
        "Χρησιμοποιήστε αυτό το email για να κάνετε αναφορά ζαβολιάς, απρεπούς λεξιλογίου ή άλλου είδους κακής συμπεριφοράς.\n"
    ...
    "settingsWindowAdvanced": {
        ...
        "helpTranslateText": (
            "Οι μη Αγγλικές μεταφράσεις του ${APP_NAME} είναι υποστιριζόμενες\n"
    ...
    "signInWithGameCenterText": (
        "Για να χρησιμοποιήσετε έναν λογαριασμό Game Center,\n"
    ...
    "store": {
        ...
        "bombSquadProNewDescriptionText": (
            "• Αφαιρεί τις διαφιμήσεις στο παιχνίδι και τις αναδυόμενες οθόνες\n"
        ...
        "freeBombSquadProText": (
            "Το BombSquad είναι πλέον δωρεάν, αλλά αφού το έχετε αγοράσει εξ' αρχής\n"
    ...
    "translations": {
        ...
        "gameDescriptions": {
            (
                ...
                "Παραμείνετε εκλεκτός για ένα χρονικό διάστημα ώστε να νικήσετε.\n"
        ...
        "playlistNames": {"Just Epic": "Μόνο Επικό", "Just Sports": "Μόνο Αγωνίσματα"},
        "scoreNames": {
            "Flags": "Σημαίες",
            "Goals": "Γκολ",
            "Score": "Βαθμοί",
        ...
        "serverResponses": {
            ...
            (
                ...
                "Είστε σίγουροι πως θέλετε να δεσμεύσετε μεταξύ τους αυτούς τους λογαριασμούς;\n"
                "\n"
                "${ACCOUNT1}\n"
                "${ACCOUNT2}\n"
                "\n"
            ...
            (
                ...
                "ΑΡΝΗΣΗ ΔΕΣΜΕΥΣΗΣ. Ο ${ACCOUNT} περιέχει\n"
            ...
            (
                ...
                "Δέσμευση του λογαριασμού ${ACCOUNT} σε αυτόν τον λογαριασμό;\n"
            ...
            (
                ...
                "Παραλάβατε ${COUNT} εισιτήρια επειδή συνδεθήκατε.\n"
            ...
            (
                ...
                "Η λειτουργικότητα των διακομιστών δεν υποστηρίζεται πλέον σε αυτή την έκδοση του παιχνιδιού.\n"
            ...
            (
                ...
                "Αποδέσμευση του ${ACCOUNT} από αυτόν τον λογαριασμό;\n"
            ...
            (
                ...
                "ΠΡΟΕΙΔΟΠΟΙΗΣΗ: Παράπονα παραβίασης (hacking) σημειώθηκαν εναντίον αυτού του λογαριασμού.\n"
            ...
            (
                ...
                "Το αντίγραφο του παιχνιδιού σας έχει τροποποιηθεί.\n"
        ...
        "tips": {
            (
                ...
                "Μια τέλεια συγχρονισμένη γροθιά τρεξίματος-άλματος-στροφής μπορεί να σκοτώσει\n"
            ...
            (
                ...
                "Δημιουργήστε προφίλ παικτών για εσάς και τους φίλους σας με τα\n"
            ...
            (
                ...
                "Τα κουτιά κατάρας σας μετατρέπουν σε ορολογιακή βόμβα.\n"
            ...
            (
                ...
                "Παρά την εμφάνισή τους, οι ιδιότητες όλων των χαρακτήρων είναι ίδιες,\n"
            ...
            (
                ...
                "Πατήστε κρατημένο οποιδήποτε κουμπί για να τρέξετε. Θα φτάνετε στον προορισμό σας\n"
            ...
            (
                ...
                "Οι βόμβες πάγου δεν είναι και τόσο ισχυρές, αλλά παγώνουν\n"
            ...
            (
                ...
                "Αν κάποιος σας σηκώσει, χτυπήστε τον και θα σας\n"
            ...
            (
                ...
                "Αν ξεμείνατε από χειριστήρια, εγκαταστήστε την εφαρμογή '${REMOTE_APP_NAME}'\n"
            ...
            (
                ...
                "Αν μια κολλώδη βόμβα κολλήσει πάνω σας, αρχίστε να πηδάτε και να τρέχετε σε κύκλους.\n"
            ...
            (
                ...
                "Άμα μαζέψετε κατάρα, η μόνη ελπίδα σας για επιβίωση είναι\n"
            ...
            (
                ...
                "Αν έχετε πολλούς παίκτες να εισέρχονται και να εξέρχονται, ενεργοποιήστε την 'αυτόματη-\n"
            ...
            (
                ...
                "Αν η συσκευή σας ζεσταίνεται υπερβολικά ή θα θέλατε να διατηρήσετε την ενέργεια\n"
            ...
            (
                ...
                "Αν το framerate σας είναι ασταθές, δοκιμάστε να μειώσετε την\n"
            ...
            (
                ...
                "Στην Κατάκτηση-Σημαίας, η δική σας σημαία πρέπει να είναι στη βάση της για να σκοράρετε. Αν η άλλη\n"
            ...
            (
                ...
                "Μπορείτε να σηκώσετε και να πετάξετε διάφορα, συμπεριλαμβανομένου και άλλους παίκτες. Ρίχνοντας τους εχθρούς σας\n"
            ...
            (
                ...
                "Οι παίκτες μπορούν να ενταχθούν και να αποχωρήσουν στην μέση των περισσότερων παιχνιδιών,\n"
            ...
            (
                ...
                "Οι γροθιές προκαλούν περισσότερη ζημιά με βάση την ταχύτητα με τη\n"
            ...
            (
                ...
                "Αυτό το επίπεδο δεν τελειώνει ποτέ, αλλά μία υψηλή βαθμολογία\n"
            ...
            (
                ...
                "Η δύναμη ριπής είναι βασισμένη στην κατεύθυνση που έχετε κρατημένη.\n"
            ...
            (
                ...
                "Βαρεθήκατε την ηχητική υπόκρουση; Αντικαταστήστε την με\n"
            ...
            (
                ...
                'Μπορείτε να "στοχεύσετε" τις γροθιές σας στρίβοντας αριστερά ή δεξιά. Αυτό είναι\n'
            ...
            (
                ...
                "Μπορείτε να μαντέψετε πότε μια βόμβα θα εκραγεί με βάση το χρώμα\n"
            ...
            (
                ...
                "Δέχεστε ζημιές όταν κουτουλάτε το κεφάλι σας οπουδήποτε, οπότε\n"
    ...
    "wiimoteSetupWindow": {
        ...
        "listenText": "Ακρόαση",
        "macInstructionsText": (
            "Σιγουρευτείτε ότι το Wii είναι κλειστό και το Bluetooth ενεργοποιημένο\n"
        ...
        "thanksText": (
            "Ευχαριστούμε την ομάδα DarwiinRemote\n" "που έκανε αυτό εφικτό."
        ),
    ...
    "xbox360ControllersWindow": {
        ...
        "macInstructions2Text": (
            "Για να χρησιμοποιήσετε χειριστήρια ασύρματα, θα χρειαστείτε επίσης\n"
        ...
        "macInstructionsText": (
            "Για να χρησιμοποιήσετε χειριστήρια Xbox 360, θα χρειαστεί\n"
            "να εγκαταστήσετε τον οδηγό Mac διαθέσιμο στον παρακάτω σύνδεσμο.\n"
            "Λειτουργεί και με ενσύρματα και ασύρματα χειριστήρια."
        ),
        "macInstructionsTextScale": 0.7,
        "ouyaInstructionsText": (
            "Για να χρησιμοποιήσετε ενσύρματα Xbox 360 χειριστήρια με το BombSquad,\n"
