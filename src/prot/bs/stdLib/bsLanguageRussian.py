...
values = {
    "accountSettingsWindow": {
        ...
        "linkAccountsInstructionsText": (
            "Для связки двух аккаунтов, создайте код на одном\n"
        ...
        "resetProgressConfirmText": (
            "Это сбросит весь ваш кооперативный\n"
        ...
        "testAccountWarningOculusText": (
            'Внимание: вы входите под акканутом "test".\n'
        ...
        "testAccountWarningText": (
            'Внимание: вы заходите под аккаунтом "test".\n'
    ...
    "addGameWindow": {"getMoreGamesText": "Еще игр...", "titleText": "Добавить игру"},
    "allowText": "Разрешить",
    "alreadySignedInText": (
        "На вашем аккаунте играют на другом устройстве;\n"
    ...
    "buttonText": "кнопка",
    "canWeDebugText": (
        "Хотите, чтобы BombSquad автоматически сообщал разработчику\n"
    ...
    "configGamepadSelectWindow": {
        ...
        "pressAnyButtonText": (
            "Нажмите любую кнопку на контроллере,\n" " который хотите настроить..."
        ),
    ...
    "configGamepadWindow": {
        ...
        "secondHalfText": (
            "Используйте это для настройки второй половины\n"
    ...
    "configKeyboardWindow": {
        ...
        "keyboard2NoteText": (
            "Примечание: большинство клавиатур могут зарегистрировать только\n"
    ...
    "configTouchscreenWindow": {
        ...
        "swipeInfoText": (
            "К контроллерам, работающим со смахиванием, нужно привыкнуть,\n"
    ...
    "connectMobileDevicesWindow": {
        ...
        "bestResultsText": (
            "Для наилучшего результата вам понадобится сеть Wi-Fi без задержек.\n"
        ...
        "explanationText": (
            "Для настройки смартфона или планшета в качестве контроллера\n"
        ...
        "forIOSText": "для iOS:",
        "getItForText": (
            "Скачайте приложение ${REMOTE_APP_NAME} для iOS в Apple App Store\n"
    ...
    "coopSelectWindow": {
        ...
        "prizesText": "Призы",
        "proMultInfoText": (
            "Здесь игроки с обновлением ${PRO}\n"
        ...
        "welcome1Text": (
            "Добро пожаловать в ${LEAGUE}. Вы можете\n"
            "повысить свою лигу получая звёзды, получая \n"
            "достижения и выигрывая трофеи в турнирах."
        ),
        "welcome2Text": (
            "Вы также можете заработать билеты от многих из тех же видов деятельности.\n"
    ...
    "difficultyHardUnlockOnlyText": (
        "Этот уровень может быть открыт только в сложном режиме.\n"
        "Думаете, сможете!?!?!"
    ),
    ...
    "editProfileWindow": {
        "accountProfileInfoText": (
            "У этого особенного профиля есть имя\n"
        ...
        "globalProfileInfoText": (
            "Глобальным профилям игроков гарантированы уникальные\n"
        ...
        "localProfileInfoText": (
            "У локальных игровых профилей нет иконок и им не гарантированы\n"
        ...
        "upgradeProfileInfoText": (
            "Это зарезервирует ваше имя игрока\n" "и позволит вам добавить иконку."
        ),
    ...
    "failText": "Провал",
    "fatalErrorText": (
        "Ой, что-то потерялось или сломалось.\n"
    ...
    "gameSettingsWindow": {"addGameText": "Добавить игру"},
    ...
    "gatherWindow": {
        "aboutDescriptionLocalMultiplayerExtraText": (
            "Помните: любое устройство в совместной игре поддерживает\n"
            "несколько игроков, если у вас хватает контроллеров."
        ),
        "aboutDescriptionText": (
            "Используйте эти закладки, чтобы создать лобби.\n"
            "\n"
        ...
        "appInviteInfoText": (
            "Пригласите друзей поиграть в BombSquad и они\n"
        ...
        "disconnectClientsText": (
            "Это отключит ${COUNT} игроков\n" "в вашем лобби. Вы уверены?"
        ),
        "earnTicketsForRecommendingAmountText": (
            "Друзья получат ${COUNT} билетов, если они активируют ваш код\n"
        ...
        "friendPromoCodeInstructionsText": (
            "Для активации в ${APP_NAME} зайдите в\n"
        ...
        "googlePlayReInviteText": (
            "В вашем лобби ${COUNT} игроков Google Play.\n"
        ...
        "inviteAFriendText": (
            "Друзья еще не играют? Пригласи их\n"
        ...
        "wifiDirectDescriptionBottomText": (
            "Если у всех устройств есть панель 'Wi-Fi Direct', они могут использовать ее, чтобы найти\n"
        ...
        "wifiDirectDescriptionTopText": (
            "Wi-Fi Direct может быть использован для соединения устройств Android напрямую без\n"
    ...
    "getTicketsWindow": {
        ...
        "unavailableLinkAccountText": (
            "Извините, но на этой платформе покупки недоступны.\n"
    ...
    "helpWindow": {
        ...
        "controllersInfoText": (
            "Вы можете играть в ${APP_NAME} с друзьями по сети, или вы все можете\n"
        ...
        "controllersInfoTextFantasia": (
            "Один игрок может использовать пульт дистанционного управления,\n"
        ...
        "controllersInfoTextMac": (
            "Один-два игрока могут играть с клавиатуры, но BombSquad лучше всего работает\n"
        ...
        "controllersInfoTextOuya": (
            "С BombSquad можно использовать контроллеры OUYA, PS3, Xbox 360, а также\n"
        ...
        "friendsGoodText": (
            "Бывают полезны. В ${APP_NAME} веселее играть с несколькими игроками;\n"
    ...
    "installDiskSpaceErrorText": (
        "ОШИБКА: не удалось завершить установку. Может быть\n"
    ...
    "internal": {
        ...
        "touchScreenJoinWarningText": (
            "Вы присоединились с сенсорным экраном.\n"
        ...
        "vrOrientationResetCardboardText": (
            "Используйте это, чтобы сбросить ориентации VR.\n"
    ...
    "macControllerSubsystemMFiNoteText": (
        "Сделано для iOS контроллера/Мак обнаружил;\n"
    ...
    "mustInviteFriendsText": (
        "Примечание: вы должны пригласить друзей\n"
    ...
    "newTestBuildAvailableText": (
        "Доступна новая тестовая версия! (${VERSION} сборка ${BUILD}).\n"
        "Обновить: ${ADDRESS}"
    ),
    "newText": "Новый",
    ...
    "noProfilesErrorText": (
        "У вас нет профиля игрока, так что вас будут звать '${NAME}'.\n"
    ...
    "ownFlagAtYourBaseWarning": (
        "Чтобы набрать очки, ваш собственный\n" "флаг должен быть на вашей базе!"
    ),
    ...
    "pleaseRateText": (
        "Если вам нравится игра ${APP_NAME}, пожалуйста, подумайте о том,\n"
    ...
    "profileInfoText": (
        "Создайте профили для себя и своих друзей, чтобы\n"
    ...
    "ps3ControllersWindow": {
        "macInstructionsText": (
            "Выключите питание на задней панели PS3, убедитесь, что Bluetooth\n"
        ...
        "ouyaInstructionsText": (
            "Чтобы использовать контроллер PS3 с OUYA, просто подключите его один раз\n"
    ...
    "remoteAppInfoShortText": (
        "Играть в ${APP_NAME} с семьей или друзьями гораздо веселее.\n"
    ...
    "remote_app": {
        ...
        "connected": "Соединено.",
        "description": (
            "Используйте Ваш телефон или планшет как контроллер BombSquad.\n"
        ...
        "searching_caption": (
            "Нажмите на название игры для входа.\n"
    ...
    "replayVersionErrorText": (
        "К сожалению, эта запись была сделана в другой\n"
    ...
    "reportPlayerExplanationText": (
        "Пожалуйтесь по этому адресу на читеров, грубиянов или кто плохо себя ведет.\n"
    ...
    "settingsWindowAdvanced": {
        ...
        "helpTranslateText": (
            "Переводы игры ${APP_NAME} с английского совершён общественными\n"
    ...
    "store": {
        ...
        "bombSquadProDescriptionText": (
            "• Удваивает билеты заработанные за достижения\n"
        ...
        "freeBombSquadProText": (
            "BombSquad теперь бесплатная игра, но если вы приобрели ее ранее, то вы\n"
    ...
    "translations": {
        ...
        "gameDescriptions": {
            (
                ...
                "Чтобы победить, стань избранным на некоторое время.\n"
        ...
        "inputDeviceNames": {"Keyboard": "Клавиатура", "Keyboard P2": "Клавиатура P2"},
        "languages": {
            "Arabic": "Арабский",
        ...
        "promoCodeResponses": {"invalid promo code": "недействительный промо-код"},
        "scoreNames": {
            "Flags": "Флаги",
            "Goals": "Голы",
            "Score": "Очки",
        ...
        "serverResponses": {
            ...
            (
                ...
                "СВЯЗКА ЗАПРЕЩЕНА. ${ACCOUNT} содержит \n"
            ...
            (
                ...
                "Связать этот ${ACCOUNT} аккаунт с этим?\n"
            ...
            (
                ...
                "Получено ${COUNT} билетов за вход.\n"
            ...
            (
                ...
                "Функциональность сервера больше не поддерживается в этой версии игры;\n"
            ...
            (
                ...
                "Отвязать ${ACCOUNT} от этого аккаунта?\n"
            ...
            (
                ...
                "ПРЕДУПРЕЖДЕНИЕ: жалобы на хакерство были выданы на вашу учетную запись.\n"
            ...
            (
                ...
                "Ваша версия игры была модифицирована.\n"
        ...
        "tips": {
            (
                ...
                "Своевременная последовательность бег-прыжок-поворот-удар может убить\n"
            ...
            (
                ...
                "Создайте профили игроков для себя и своих друзей с собственными\n"
            ...
            (
                ...
                "Ящики с проклятием превращают вас в тикающую бомбу.\n"
            ...
            (
                ...
                "Независимо от внешности, способности всех персонажей идентичны,\n"
            ...
            (
                ...
                "Для бега удерживайте любую кнопку. Бегать, конечно, быстрее,\n"
            ...
            (
                ...
                "Ледяные бомбы не очень мощные, но они замораживают\n"
            ...
            (
                ...
                "Если кто-то вас схатил, бейте, и вас отпустят.\n"
            ...
            (
                ...
                "Если вам не хватает контроллеров, установите приложение '${REMOTE_APP_NAME}' \n"
            ...
            (
                ...
                "Если не хватает контроллеров, установите приложение 'BombSquad Remote' на\n"
            ...
            (
                ...
                "Если к вам прилипла липкая бомба, прыгайте и крутитесь. Может повезет\n"
            ...
            (
                ...
                "Если подхватили проклятие, то единственная надежда на выживание\n"
            ...
            (
                ...
                'Если у вас много игроков, которые приходят и уходят, включите "автоматически выкидывать\n'
            ...
            (
                ...
                "Если ваше устройство нагревается или вы хотите сохранить заряд батареи,\n"
            ...
            (
                ...
                "Если картинка прерывистая, попробуйте уменьшить разрешение\n"
            ...
            (
                ...
                "В Захвате флага, чтобы набрать очки, свой собственный флаг должен быть на базе.\n"
            ...
            (
                ...
                "Можно много чего поднять и бросить, включая других игроков. Швыряние врагов\n"
            ...
            (
                ...
                "Игроки могут присоединяться и уходить посреди игры,\n"
            ...
            (
                ...
                "Игроки могут присоединяться и выходить в середине большинства игр,\n"
            ...
            (
                ...
                "Усилители ограничены по времени только в кооперативных играх.\n"
            ...
            (
                ...
                "Удары наносят тем больше ущерба, чем быстрее двигаются кулаки,\n"
            ...
            (
                ...
                "Этот уровень бесконечен, но высокие очки здесь\n"
            ...
            (
                ...
                "Сила броска зависит от направления, которое нажато. Чтобы аккуратно\n"
            ...
            (
                ...
                "Надоел саундтрек? Замените его собственным!\n"
            ...
            (
                ...
                "Вы можете 'нацеливать' удары, крутясь влево или вправо.\n"
            ...
            (
                ...
                "Когда взорвется бомба можно судить по цвету искр фитиля:\n"
            ...
            (
                ...
                "Чтобы поменять персонажа не обязательно редактировать ​профиль. Просто нажмите\n"
            ...
            (
                ...
                "Вы получаете повреждения, когда ударяетесь головой,\n"
    ...
    "trialPeriodEndedText": (
        "Ваш пробный период закончился. Хотите приобрести\n"
    ...
    "waveText": "Волна",
    "wellSureText": "Сойдет!",
    "wiimoteLicenseWindow": {"titleText": "Авторские права DarwiinRemote"},
    "wiimoteListenWindow": {
    ...
    "wiimoteSetupWindow": {
        ...
        "listenText": "Слушать",
        "macInstructionsText": (
            "Убедитесь, что ваш Wii выключен, а на вашем Маке включен\n"
    ...
    "xbox360ControllersWindow": {
        ...
        "macInstructionsText": (
            "Для использования контроллеров Xbox 360 необходимо\n"
            "установить драйвер Mac, доступный по ссылке ниже.\n"
            "Он работает и с проводными и беспроводными контроллерами."
        ),
        "ouyaInstructionsText": (
            "Для использования проводных контроллеров Xbox 360 в BombSquad,\n"
