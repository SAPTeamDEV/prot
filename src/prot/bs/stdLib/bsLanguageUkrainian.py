...
values = {
    "accountSettingsWindow": {
        ...
        "linkAccountsInstructionsNewText": (
            "Щоб зв'язати два облікові записи, згенеруйте код на\n"
        ...
        "resetProgressConfirmNoAchievementsText": (
            "Це скине весь ваш кооперативний прогрес\n"
        ...
        "testAccountWarningOculusText": (
            'Увага: ви входите під "тестовим" аккаунтом.\n'
        ...
        "testAccountWarningText": (
            'Увага: ви увійшли під "тестовим" аккаунтом.\n'
    ...
    "addGameWindow": {"getMoreGamesText": "Ще ігри...", "titleText": "Додати гру"},
    "allowText": "Дозволити",
    "alreadySignedInText": (
        "На вашому акаунті грають на іншому пристрої;\n"
    ...
    "buttonText": "кнопка",
    "canWeDebugText": (
        "Хочете, щоб BombSquad автоматично повідомляв розробнику\n"
    ...
    "configGamepadSelectWindow": {
        ...
        "pressAnyButtonText": (
            "Натисніть будь-яку кнопку на контролері,\n" "  який хочете налаштувати..."
        ),
    ...
    "configGamepadWindow": {
        ...
        "secondHalfText": (
            "Використовуйте це для настройки другої половини\n"
    ...
    "configKeyboardWindow": {
        ...
        "keyboard2NoteText": (
            "Примітка: більшість клавіатур можуть зареєструвати тільки кілька \n"
    ...
    "configTouchscreenWindow": {
        ...
        "swipeInfoText": (
            "До контролерів, які працюють зі змахування, потрібно звикнути,\n"
    ...
    "connectMobileDevicesWindow": {
        ...
        "bestResultsText": (
            "Для найкращого результату вам знадобиться мережу Wi-Fi без затримок.\n"
        ...
        "explanationText": (
            "Для налаштування смартфона або планшета в якості контролера\n"
        ...
        "forIOSText": "для iOS:",
        "getItForText": (
            "Завантажте додаток ${REMOTE_APP_NAME} для iOS в Apple App Store\n"
    ...
    "coopSelectWindow": {
        ...
        "totalText": "всього",
        "tournamentInfoText": (
            "Добийтеся високого результату з\n"
        ...
        "welcome1Text": (
            "Ласкаво просимо в ${LEAGUE}. Ви можете\n"
            "підвищити свою лігу отримуючи зірки, отримуючи\n"
            "досягнення і виграючи трофеї в турнірах."
        ),
        "welcome2Text": (
            "Ви також можете заробити квитки від багатьох однакових видів діяльності.\n"
    ...
    "difficultyHardUnlockOnlyText": (
        "Цей рівень може бути відкритий тільки у складному режимі.\n"
        "Ви цього не зробили !!!!!"
    ),
    ...
    "editProfileWindow": {
        ...
        "globalProfileInfoText": (
            "Глобальні профілі гравців гарантовано мають унікальні\n"
        ...
        "localProfileInfoText": (
            "Локальні ігрові профілі не мають іконки і їхні імена\n"
    ...
    "failText": "Провал",
    "fatalErrorText": (
        "Ой, щось загубилося або зламалося.\n"
    ...
    "gameSettingsWindow": {"addGameText": "Додати гру"},
    "gamesToText": "${WINCOUNT}: ${LOSECOUNT}",
    "gatherWindow": {
        "aboutDescriptionLocalMultiplayerExtraText": (
            "Пам'ятайте: будь-який пристрій у спільній грі підтримує\n"
            "кілька гравців, якщо у вас вистачає контролерів."
        ),
        "aboutDescriptionText": (
            "Використовуйте ці закладки, щоб створити лобі.\n"
            "\n"
        ...
        "disconnectClientsText": (
            "Це відключить ${COUNT} гравців\n" "У вашому лобі. Ви впевнені?"
        ),
        "earnTicketsForRecommendingAmountText": (
            "Друзі отримають ${COUNT} квитки, якщо вони спробують гру \n"
        ...
        "friendPromoCodeInstructionsText": (
            'Для активації в ${APP_NAME} зайдіть в "Налаштування->Додатково->Ввести код".\n'
        ...
        "googlePlayReInviteText": (
            "У вашому лобі ${COUNT} гравців Google Play.\n"
        ...
        "wifiDirectDescriptionBottomText": (
            "Якщо у всіх пристроїв є панель 'Wi-Fi Direct', вони можуть використовувати її, щоб знайти\n"
        ...
        "wifiDirectDescriptionTopText": (
            "Wi-Fi Direct може бути використаний для з'єднання пристроїв Android безпосередньо без\n"
    ...
    "getTicketsWindow": {
        ...
        "unavailableLinkAccountText": (
            "Вибачте, але на цій платформі покупки недоступні.\n"
    ...
    "helpWindow": {
        ...
        "controllersInfoText": (
            "Ви можете грати в ${APP_NAME} з друзями по мережі, або ви всі можете\n"
        ...
        "controlsText": "Управління",
        "devicesInfoText": (
            "У VR-версію ${APP_NAME} можна грати по мережі зі звичайною \n"
        ...
        "friendsGoodText": (
            "Бувають корисні. В ${APP_NAME} веселіше грати з кількома гравцями;\n"
    ...
    "installDiskSpaceErrorText": (
        "ПОМИЛКА: не вдалося завершити встановлення. \n"
    ...
    "internal": {
        ...
        "connectionFailedVersionMismatchText": (
            "З'єднання невдале; хост використовує іншу версію гри.\n"
        ...
        "touchScreenJoinWarningText": (
            "Ви приєдналися з сенсорним екраном.\n"
        ...
        "vrOrientationResetCardboardText": (
            "Використовуйте це, щоб скинути орієнтацію VR.\n"
    ...
    "mustInviteFriendsText": (
        "Примітка: ви повинні запросити друзів\n"
    ...
    "newTestBuildAvailableText": (
        "Доступна нова тестова версія! (${VERSION} збірка ${BUILD}).\n"
        "Оновити: ${ADDRESS}"
    ),
    "newText": "Новий",
    ...
    "pleaseRateText": (
        "Якщо вам подобається гра ${APP_NAME}, будь ласка, подумайте про те,\n"
    ...
    "promoCodeWindow": {"codeText": "Код", "enterText": "Відправити"},
    "promoSubmitErrorText": "Помилка відправки коду, перевірте своє інтернет-з'єднання",
    "ps3ControllersWindow": {
        "macInstructionsText": (
            "Вимкніть живлення на задній панелі PS3, переконайтеся, що Bluetooth\n"
        ...
        "ouyaInstructionsText": (
            "Щоб використовувати контролер PS3 з OUYA, просто підключіть його один раз\n"
    ...
    "remoteAppInfoShortText": (
        "Грати в ${APP_NAME} з сім'єю або друзями набагато веселіше.\n"
    ...
    "remote_app": {
        ...
        "connected": "Пов'язано.",
        "description": (
            "Використовуйте Ваш телефон або планшет як контролер BombSquad.\n"
        ...
        "searching_caption": (
            "Натисніть на назву гри для входу.\n"
    ...
    "replayVersionErrorText": (
        "На жаль, цей повтор було зроблено в інший\n"
    ...
    "reportPlayerExplanationText": (
        "Поскаржіться за цією адресою на чітера, грубіяна або того хто погано поводиться.\n"
    ...
    "settingsWindowAdvanced": {
        ...
        "helpTranslateText": (
            "Переклади гри ${APP_NAME} з англійської зроблені спільнотою. \n"
    ...
    "store": {
        ...
        "freeBombSquadProText": (
            "BombSquad тепер безкоштовна гра, але якщо ви придбали її раніше, то ви\n"
    ...
    "translations": {
        ...
        "gameDescriptions": {
            (
                ...
                "Щоб перемогти, стань обраним на деякий час.\n"
        ...
        "inputDeviceNames": {"Keyboard": "Клавіатура", "Keyboard P2": "Клавіатура P2"},
        "languages": {
            "Arabic": "Арабська",
        ...
        "playlistNames": {"Just Epic": "Тільки епічний", "Just Sports": "Тільки спорт"},
        "scoreNames": {
            "Flags": "Прапори",
            "Goals": "Голи",
            "Score": "Очки",
        ...
        "serverResponses": {
            ...
            (
                ...
                "Об'єднання не дозволено. ${ACCOUNT} містить \n"
            ...
            (
                ...
                "Отримано ${COUNT} квитків за вхід.\n"
            ...
            (
                ...
                "Функціональність сервера більше не підтримується в цій версії гри;\n"
            ...
            (
                ...
                "Відв'язати ${ACCOUNT} від цього акаунта?\n"
            ...
            (
                ...
                "ПОПЕРЕДЖЕННЯ: скарги на хакерство були видані на ваш обліковий запис.\n"
            ...
            (
                ...
                "Ваша версія гри була модифікована.\n"
        ...
        "tips": {
            (
                ...
                "Своєчасна послідовність біг-стрибок-поворот-удар може вбити\n"
            ...
            (
                ...
                "Створіть профілі гравців для себе і своїх друзів з власними\n"
            ...
            (
                ...
                "Ящики з прокляттям перетворюють вас в цокаючу бомбу.\n"
            ...
            (
                ...
                "Незалежно від зовнішності, здатності всіх персонажів ідентичні,\n"
            ...
            (
                ...
                "Для бігу утримуйте будь-яку кнопку. Бігати, звичайно, швидше,\n"
            ...
            (
                ...
                "Крижані бомби не дуже потужні, але вони заморожують\n"
            ...
            (
                ...
                "Якщо хтось вас схопив, бийте, і вас відпустять.\n"
            ...
            (
                ...
                "Якщо вам не вистачає контролерів, встановіть програму '${REMOTE_APP_NAME}'\n"
            ...
            (
                ...
                "Якщо до вас прилипла липка бомба, стрибайте і крутитесь. може пощастить\n"
            ...
            (
                ...
                "Якщо підхопили прокляття, то єдина надія на виживання\n"
            ...
            (
                ...
                'Якщо у вас багато гравців, які приходять і йдуть, включіть "автоматично викидати \n'
            ...
            (
                ...
                "Якщо ваш пристрій нагрівається або ви хочете зберегти заряд батареї,\n"
            ...
            (
                ...
                "Якщо картинка переривчаста, спробуйте зменшити розширення\n"
            ...
            (
                ...
                "У Захопленні прапору, щоб набрати очки, свій власний прапор повинен бути на базі.\n"
            ...
            (
                ...
                "Можна багато чого підняти і кинути, включаючи інших гравців. Жбурляння ворогів\n"
            ...
            (
                ...
                "Гравці можуть приєднуватися і йти посеред гри,\n"
            ...
            (
                ...
                "Удари наносять більше шкоди, чим швидше рухаються кулаки,\n"
            ...
            (
                ...
                "Цей рівень безкінечний, але високі очки тут\n"
            ...
            (
                ...
                "Сила кидка залежить від напрямку. Щоб акуратно кинути \n"
            ...
            (
                ...
                "Набрид саундтрек? Замініть його власним!\n"
            ...
            (
                ...
                "Ви можете 'націлювати' удари, крутись вліво або вправо.\n"
            ...
            (
                ...
                "Коли вибухне бомба можна визначити за кольором іскор гніту:\n"
            ...
            (
                ...
                "Ви отримуєте пошкодження, коли вдаряється головою,\n"
    ...
    "waveText": "Хвиля",
    "wellSureText": "Зійде!",
    "wiimoteLicenseWindow": {"titleText": "Авторські права DarwiinRemote"},
    "wiimoteListenWindow": {
    ...
    "xbox360ControllersWindow": {
        ...
        "macInstructions2Text": (
            "Для використання контролерів по бездротовому зв'язку, вам також\n"
        ...
        "macInstructionsText": (
            "Для використання контролерів Xbox 360 необхідно\n"
            "встановити драйвер Mac, доступний за посиланням нижче.\n"
            "Він працює і з провідними і бездротовими контролерами."
        ),
        "ouyaInstructionsText": (
            "Для використання провідних контролерів Xbox 360 в BombSquad,\n"
