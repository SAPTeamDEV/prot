...
values = {
    "accountSettingsWindow": {
        ...
        "linkAccountsInstructionsNewText": (
            "Om 2 accounts te verbinden, genereer je een code met het \n"
        ...
        "linkAccountsInstructionsText": (
            "Om twee accounts te koppelen, genereer je bij een\n"
        ...
        "setAccountNameDesc": (
            "Selecteer de naam om weer te geven voor uw account.\n"
            "U kan de naam gebruiken van een van de verbonden accounts\n"
            "of maak een unieke naam aan."
        ),
        "signInInfoText": (
            "Log in om tickets te verzamelen, online te concurreren,\n"
        ...
        "testAccountWarningCardboardText": (
            'Let op: je logt in met een "test" account.\n'
        ...
        "testAccountWarningOculusText": (
            'Waarschuwing: U bent ingelogd met een "test" account.\n'
        ...
        "testAccountWarningText": (
            'Waarschuwing: u ben ingelogd met een "test" account.\n'
    ...
    "allowText": "Toestaan",
    "alreadySignedInText": (
        "Uw account is al ingelogd op een ander apparaat;\n"
    ...
    "buttonText": "knop",
    "canWeDebugText": (
        "Wilt u dat BombSquad automatisch bugs, crashes,\n"
    ...
    "configGamepadSelectWindow": {
        ...
        "pressAnyButtonText": (
            "Druk op een knop van de controller\n" "  die u wilt configureren..."
        ),
    ...
    "configGamepadWindow": {
        ...
        "secondHalfText": (
            "Gebruik dit om de tweede helft te configureren\n"
    ...
    "configKeyboardWindow": {
        ...
        "keyboard2NoteText": (
            "Opmerking: de meeste toetsenborden kunnen maar enkele\n"
    ...
    "configTouchscreenWindow": {
        ...
        "swipeInfoText": (
            "De 'veeg' stijl controls is even een beetje wennen, maar maakt\n"
    ...
    "connectMobileDevicesWindow": {
        ...
        "bestResultsText": (
            "Voor het beste resultaat heb u een vertraging-vrij wifi netwerk nodig. u\n"
        ...
        "explanationText": (
            "Om een smartphone of tablet te gebruiken als een draadloze controller,\n"
        ...
        "forIOSText": "voor iOS:",
        "getItForText": (
            "Krijg de ${REMOTE_APP_NAME} voor iOS in de Apple App Store\n"
    ...
    "coopSelectWindow": {
        ...
        "prizesText": "Prijzen",
        "proMultInfoText": (
            "Spelers met de ${PRO} opwaardering\n"
    ...
    "creditsWindow": {
        ...
        "songCreditText": (
            "${TITLE} Uitgevoerd door ${PERFORMER}\n"
    ...
    "difficultyHardUnlockOnlyText": (
        "Dit level kan alleen in moeilijke modus vrij gespeeld worden.\n"
        "Durf je het aan!?!?!"
    ),
    ...
    "editProfileWindow": {
        "accountProfileInfoText": (
            "Dit speciale profiel heeft een naam en een pictogram gabaseerd op je profiel. \n"
            "\n"
            "${ICONS}\n"
            "\n"
        ...
        "globalProfileInfoText": (
            "Globale speler profielen hebben gegarandeerd een unieke\n"
        ...
        "localProfileInfoText": (
            "Lokale speler profielen hebben geen pictogrammen en hun namen zijn\n"
        ...
        "upgradeProfileInfoText": (
            "Hier door krijg je een wereld wijde speler naam\n"
    ...
    "failText": "Faal",
    "fatalErrorText": (
        "Uh oh; er mist iets of is kapot.\n"
    ...
    "gameSettingsWindow": {"addGameText": "Voeg Spel Toe"},
    ...
    "gatherWindow": {
        "aboutDescriptionLocalMultiplayerExtraText": (
            "Onthoud: elk apparaat in een partij kan meer\n"
            "dan een speler hebben als u genoeg controllers hebt."
        ),
        "aboutDescriptionText": (
            "Gebruik deze tabbladen om een partij samen te stellen.\n"
            "\n"
        ...
        "appInviteInfoText": (
            "Nodig vrienden uit om BombSquad te proberen en ze\n"
        ...
        "disconnectClientsText": (
            "Hierdoor verbreekt de verbinding met ${COUNT} spelers(s)\n"
            "van uw partij. Weet u het zeker?"
        ),
        "earnTicketsForRecommendingAmountText": (
            "Vrienden ontvangen ${COUNT} tickets als ze het spel proberen\n"
        ...
        "friendPromoCodeInstructionsText": (
            "Om het te gebruiken, open je ${APP_NAME} en ga je naar 'Instellingen-> Geavanceerd-> Voer code in'.\n"
        ...
        "googlePlayReInviteText": (
            "Er zijn ${COUNT} Google Play speler(s) in uw partij\n"
        ...
        "inviteAFriendText": (
            "Hebben je vrienden dit spel niet?\n"
        ...
        "wifiDirectDescriptionBottomText": (
            "Als alle apparaten een 'Wi-Fi Direct' paneel hebben, dan zou het mogelijk moeten zijn\n"
        ...
        "wifiDirectDescriptionTopText": (
            "Wi-Fi Direct kan gebruikt worden om directe verbinding te maken tussen Android apparaten zonder\n"
    ...
    "getTicketsWindow": {
        ...
        "unavailableLinkAccountText": (
            "Sorry, aankopen zijn niet beschikbaar op dit platform.\n"
    ...
    "helpWindow": {
        ...
        "controllersInfoText": (
            "U kan ${APP_NAME} spelen met vrienden via een netwerk, of u\n"
        ...
        "controllersInfoTextFantasia": (
            "Een speler kan de afstandbediening gebruiken als controller,\n"
        ...
        "controllersInfoTextMac": (
            "Een of twee spelers kunnen gebruik maken van het toetsenbord, maar Bombsquad is het beste met gamepads.\n"
        ...
        "controllersInfoTextOuya": (
            "U kunt OUYA controllers, PS3 controllers, Xbox 360 controllers, \n"
        ...
        "controlsText": "Besturing",
        "devicesInfoText": (
            "De VR versie van ${APP_NAME} kan gespeeld worden via het netwerk met\n"
        ...
        "friendsGoodText": (
            "Deze zijn goed om te hebben. ${APP_NAME} is het leukste met\n"
    ...
    "installDiskSpaceErrorText": (
        "FOUT: Niet in staat om de installatie te voltooien.\n"
    ...
    "internal": {
        ...
        "connectionFailedVersionMismatchText": (
            "Verbinding mislukt; host gebruikt een andere versie van het spel.\n"
        ...
        "incompatibleVersionHostText": (
            "Host gebruikt een andere versie van het spel; kan niet verbinden.\n"
            "Zorg er voor dat u allebei up-to-date bent en probeer het opnieuw."
        ),
        "incompatibleVersionPlayerText": (
            "${NAME} gebruikt een andere versie van het spel en kan niet verbinden.\n"
            "Zorg er voor dat u allebei up-to-date bent en probeer het opnieuw."
        ),
        ...
        "touchScreenJoinWarningText": (
            "U doet mee met een aanraakscherm.\n"
        ...
        "vrOrientationResetCardboardText": (
            "Hiermee reset je de VR oriëntatie.\n"
    ...
    "macControllerSubsystemMFiNoteText": (
        "Gemaakt-voor-iOS/Mac controller gedetecteerd;\n"
    ...
    "mustInviteFriendsText": (
        "Let op: U moet vrienden uitnodigen in\n"
    ...
    "newTestBuildAvailableText": (
        "Er is een nieuwere testversie beschikbaar! (${VERSION} build ${BUILD}).\n"
    ...
    "noProfilesErrorText": (
        "U heeeft geen speler profielen, dus zit u vast aan '${NAME}'.\n"
    ...
    "pleaseRateText": (
        "Als u geniet van ${APP_NAME}, zou u dan een moment willen\n"
    ...
    "profileInfoText": (
        "Maak profielen voor jezelf en je vrienden\n"
    ...
    "ps3ControllersWindow": {
        "macInstructionsText": (
            "Schakel de stroom aan de achterkant van uw PS3, zorg ervoor\n"
        ...
        "ouyaInstructionsText": (
            "Om een PS3 controller met uw OUYA gebruiken, sluit u deze simpelweg aan een USB-kabel\n"
    ...
    "remoteAppInfoShortText": (
        "${APP_NAME} is het leuks met familie en vrienden.\n"
    ...
    "remote_app": {
        ...
        "searching_caption": (
            "Tik op de naam van het spel om mee te doen.\n"
    ...
    "replayVersionErrorText": (
        "Sorry, deze herhaling is opgenomen in een vorige\n"
    ...
    "reportPlayerExplanationText": (
        "Gebruik deze email voor het rapporteren van valsspelen, ongepast taalgebruik, of ander slecht gedrag.\n"
        "Beschrijf hieronder:"
    ),
    ...
    "settingsWindowAdvanced": {
        ...
        "helpTranslateText": (
            "${APP_NAME}'s niet-Engelse vertalingen is een gezamenlijke\n"
    ...
    "signInWithGameCenterText": (
        "Om een Game Center account te gebruiken,\n" "logt u in bij de Game Center app."
    ),
    ...
    "store": {
        ...
        "bombSquadProDescriptionText": (
            "• Verdubbelt prestatie ticket beloningen\n"
        ...
        "bombSquadProNewDescriptionText": (
            "• Verwijdert reclames en nare schermpjes binnen het spel\n"
        ...
        "freeBombSquadProText": (
            "BombSquad is nu gratis, maar sinds u het spel origineel gekocht heeft\n"
    ...
    "storeDescriptionText": (
        "8 Speler Feest Spel Krankzinnigheid!\n"
        "\n"
    ...
    "translations": {
        ...
        "gameDescriptions": {
            (
                ...
                "Ben de uitverkorene voor een bepaalde tijd om te winnen.\n"
        ...
        "inputDeviceNames": {"Keyboard": "Keyboard", "Keyboard P2": "Keyboard P2"},
        "languages": {
            "Arabic": "Arabisch",
        ...
        "promoCodeResponses": {"invalid promo code": "ongeldige promotie code"},
        "scoreNames": {
            "Flags": "Vlaggen",
            "Goals": "Doelpunten",
            "Score": "Score",
        ...
        "serverResponses": {
            ...
            (
                ...
                "Bent u zeker dat u deze accounts wilt koppelen?\n"
                "\n"
                "${ACCOUNT1}\n"
                "${ACCOUNT2}\n"
                "\n"
            ...
            (
                ...
                "LINKENDE ONTKENNING. ${ACCOUNT} bevat\n"
            ...
            (
                ...
                "Verbind account ${ACCOUNT} aan dit account?\n"
            ...
            (
                ...
                "${COUNT} tickets ontvangen door in te loggen.\n"
            ...
            (
                ...
                "Serverfunctionaliteit wordt niet langer ondersteund in deze versie van het spel;\n"
            ...
            (
                ...
                "Koppel ${ACCOUNT} los van dit account?\n"
            ...
            (
                ...
                "WAARSCHUWING: klachten over hacking zijn afgegeven tegen uw account.\n"
            ...
            (
                ...
                "Uw versie van het spel is aangepast.\n"
        ...
        "tips": {
            (
                ...
                "Een perfect getimede ren-spring-draai-slag kan doden in een enkele slag\n"
            ...
            (
                ...
                "Creëer speler profielen voor uzelf en uw vrienden met\n"
            ...
            (
                ...
                "Vloek dozen veranderen u in een tikkende tijd bom.\n"
            ...
            (
                ...
                "Ondanks hun uiterlijk, de vaardigheden van alle personages zijn identiek,\n"
            ...
            (
                ...
                "Houd een willekeurige knop in om te rennen. Je beweegt hierdoor sneller\n"
            ...
            (
                ...
                "Ijs bommen zijn niet erg krachtig, maar ze bevriezen\n"
            ...
            (
                ...
                "Als iemand u op pakt, sla dan en ze laten los.\n"
            ...
            (
                ...
                "Als je controllers te kort komt, installeer dan de '${REMOTE_APP_NAME}' app\n"
            ...
            (
                ...
                "Als u een tekort hebt aan controller, installeer dan de 'BombSquad Remote' app\n"
            ...
            (
                ...
                "Als er een plak-bom aan u vast zit, spring rond en draai rondjes. U zou\n"
            ...
            (
                ...
                "Als u een vloek op pakt, is uw enige kans op overleven om\n"
            ...
            (
                ...
                "Als u veel spelers hebt die komen en gaan, zet dan 'verstoot-afwezige spelers' aan\n"
            ...
            (
                ...
                "Als uw apparaat te warm wordt of je als je bettarij wilt besparen,\n"
            ...
            (
                ...
                "Als uw framerate schokkerig is, probeer dan de resolutie of visuele instellingen\n"
            ...
            (
                ...
                "In Verover-de-Vlag, moet uw eigen vlag in uw basis zijn om te scoren, als het andere\n"
            ...
            (
                ...
                "Veel dingen kunnen opgepakt worden en gegooid, inclusief andere spelers. Vijanden\n"
            ...
            (
                ...
                "Spelers kunnen meedoen en stoppen midden in de meeste spellen.\n"
            ...
            (
                ...
                "Spelers kunnen meedoen en weggaan midden in de meeste spellen,\n"
            ...
            (
                ...
                "Powerups hebben alleen een tijd limiet in coöperatieve spellen.\n"
            ...
            (
                ...
                "Uw klappen doen meer schade als uw vuisten in beweging zijn,\n"
            ...
            (
                ...
                "Ren heen en weer voordat u een bom gooit\n"
                "om deze 'op te zwiepen' en verder te gooien."
            ),
            ("Take out a group of enemies by\n" "setting off a bomb near a TNT box."): (
                "Schakel hele groepen vijanden uit door een bom\n"
            ...
            (
                ...
                "Het hoofd is de meest zwakke plek. Dus een plak-bom\n"
            ...
            (
                ...
                "Aan dit level komt geen einde, maar haalt u een 'high score'\n"
            ...
            (
                ...
                "Werp kracht is gebaseerd op de richting die u stuurt.\n"
            ...
            (
                ...
                "Verveeld van de muziek? Vervang het met uw eigen!\n"
            ...
            (
                ...
                "U kan uw klappen 'mikken' door linksom of rechtsom te tollen.\n"
            ...
            (
                ...
                "U kunt beoordelen of een bom gaat ontploffen door goed naar\n"
            ...
            (
                ...
                "Je bent niet verplicht om je profiel aan te passen om het uiterlijk van je\n"
            ...
            (
                ...
                "U loopt schade op als u uw hoofd tegen voorwerpen knalt,\n"
    ...
    "trialPeriodEndedText": (
        "De proeftijd is voorbij. Wil je BombSquad\n"
    ...
    "wiimoteSetupWindow": {
        ...
        "listenText": "Luister",
        "macInstructionsText": (
            "Zorg er voor dat de Wii uit staat en Bluetooth is ingeschakeld\n"
        ...
        "thanksText": (
            "Met dank aan het DarwiinRemote team\n" "die dit mogelijk hebben gemaakt."
        ),
        "thanksTextScale": 0.8,
    ...
    "xbox360ControllersWindow": {
        ...
        "macInstructions2Text": (
            "Om de draadloze controller te gebruik heeft u ook de ontvanger nodig\n"
        ...
        "macInstructionsText": (
            "Om een Xbox 360 controllers te gebruiken met de Mac dient\n"
        ...
        "ouyaInstructionsText": (
            "Om bedrade Xbox 360 controllers te gebruiken kunt u deze\n"
