...
values = {
    ...
    "accountSettingsWindow": {
        ...
        "linkAccountsInstructionsNewText": (
            "Tl link j twice. owfj w off jeoifjwocjowiejfowef\n"
        ...
        "linkAccountsInstructionsText": (
            "Tz lknf twz aoc coj, goi woc woef \n"
        ...
        "resetProgressConfirmNoAchievementsText": (
            "Thzz wflzz resta yrsr co-opz proglfzlz\n"
            "and hghzl scrdz.  Itz cntljdf be zunfzz.\n"
            "Arz yoz srz?"
        ),
        "resetProgressConfirmText": (
            "Thzlz wlz rzlt yrlzz co-pz plglrz,\n"
        ...
        "testAccountWarningCardboardText": (
            "Wrrjowifj a f;aoiwejc owj efaoiwjef owjef oaje wf\n"
        ...
        "testAccountWarningText": (
            "Wrznnzn: yzz asdfa aofijs fo asd; ofiasdfo jasdo\n"
    ...
    "configGamepadSelectWindow": {
        ...
        "pressAnyButtonText": (
            "Przss anzz butzzon on zzt gamzzzepad\n" " yozu waznt tzzo confijfgure..."
        ),
    ...
    "configGamepadWindow": {
        ...
        "secondHalfText": (
            "Usz tzzs tossc  onzzgure the zecond slf\n"
    ...
    "configKeyboardWindow": {
        ...
        "keyboard2NoteText": (
            "Nozf: mzost keybfdasdfrds canf oly rezzzfter a fewz kfjwoesses at\n"
    ...
    "connectMobileDevicesWindow": {
        ...
        "bestResultsText": (
            "Fór bést részlts yóz'll nééd a lag-fréé wifi nétwórk. Yóz can\n"
        ...
        "explanationText": (
            "Tz usé á smárt-phzné zr táblét ás á wiréléss gámépád,\n"
        ...
        "forIOSText": "fór íOzS:",
        "getItForText": (
            "Gét ${REMOTE_APP_NAME} fzr iOS ót thz Applé App Stúre\n"
    ...
    "creditsWindow": {
        ...
        "creditsText": (
            "  COdifid fjaosdjf aona dofii by Eric Froemling\n"
            "  \n"
    ...
    "difficultyHardUnlockOnlyText": (
        "Th cowej fwojco wefj aweoiejroa doif aoef.\n"
    ...
    "editProfileWindow": {
        "accountProfileInfoText": (
            "Thi foic oiwe ofijaoijc oppoyw ofiuwo\n"
        ...
        "globalProfileInfoText": (
            "Gllfoij coijw pefj acpoiwj poijf oienaowieoia oifof\n"
        ...
        "localProfileInfoText": (
            "Lfjoci fplkw oijcwofj woeif owci owiej foiwjeofi wjeff\n"
        ...
        "upgradeProfileInfoText": (
            "Thofi cowie jfojroie osejo voeja;ofowfe\n"
    ...
    "failText": "Fáilz",
    "fatalErrorText": (
        "Uz Hofwco wije fowiejf weoifw oef.\n"
    ...
    "gameSettingsWindow": {"addGameText": "Adf Gámé"},
    ...
    "gatherWindow": {
        "aboutDescriptionLocalMultiplayerExtraText": (
            "Rmgrar z: anzl flje oa aosdfj oaisjdf oaif jewf\n"
            "ocn cncontjalf iznf foyocu ltafh aconcotrlz."
        ),
        "aboutDescriptionText": (
            "Uzl thafl tbs tz assmdlb a pratlzf\n"
            "\n"
        ...
        "appInviteInfoText": (
            "Ivnir afoc weoif acj w;oejf ;owej owef\n"
        ...
        "disconnectClientsText": (
            "Thz wlzl dicntjf thz ${COUNT} pljflaf (s)\n"
            "inc yrrz prthra.  Arz yrz fsrru?"
        ),
        "earnTicketsForRecommendingAmountText": (
            "Fofofj oicow  ${COUNT} ocwjoe f cow ef woefje\n"
        ...
        "friendPromoCodeInfoText": (
            "It ooijc wolf woiwjeoef ${COUNT} ocjowef.\n"
            "\n"
        ...
        "friendPromoCodeInstructionsText": (
            'To Us ocj , ofijwe ${APP_NAME} oafn aco"segoingaf- aocij weoifjwoe fowiejoijcowijcoiwjef.\n'
        ...
        "internetText": "Off",
        "inviteAFriendText": (
            "FO jwfo wcej owiejf woijf;aowei jf;aowiej;w\n"
        ...
        "wifiDirectDescriptionBottomText": (
            "Ifz allz dvicoew hfz a 'WOFJFJ JDf pnc, thoo asdhousdfl lboeij woife oiuzeufnd\n"
        ...
        "wifiDirectDescriptionTopText": (
            "Wjf a can def ajsfd lajsd flakjsdflsdljoiwjef oiwjef oaje ofijwe foijwfe\n"
    ...
    "getTicketsWindow": {
        ...
        "unavailableLinkAccountText": (
            "Srryrc, cpofj caodn oiwrj coi weo joweijwoief.\n"
    ...
    "helpWindow": {
        ...
        "controllersInfoText": (
            "Yz can fj plsjdf ${APP_NAME} osfasfoiajwefoa soadfove rhte nwgo\n"
        ...
        "controllersInfoTextFantasia": (
            "Onfe ojfr twjo ploayers cjan usje tjhe keyoiboard, bjut BombjjSquad ifs bfest width gamjepads.\n"
        ...
        "controllersInfoTextOuya": (
            "Yzz czf usfd OUYA contdsfasdf, PS3 conconafdsf, XBox 360 coancofffnf,\n"
        ...
        "devicesInfoText": (
            "Thz VR vojeora fo ${APP_NAME} afsdcn ab asdfpladf oasdjfaoveornt\n"
        ...
        "devicesText": "Dvnlfz",
        "friendsGoodText": (
            "Frizjdzofs gozn gnno godr poof.  ${APP_NAME} za funzzgoo da sevvrzsll playerszgo\n"
    ...
    "installDiskSpaceErrorText": (
        "ERROR: Unzlbj ao ppc pwef oj oinosjs.\n"
    ...
    "internal": {
        ...
        "connectionFailedVersionMismatchText": (
            "Cnndcat flld; hfdfj orurn sd adoifdoifj oawe ve;woirodfj osdf the gaz.\n"
        ...
        "incompatibleVersionHostText": (
            "Hstn iz rningf a difefer ver ejoaf of thz gmz; vn't cndnocet.\n"
            "Mkf woeic woefj owe cwefowfo woeowei oijtwf."
        ),
        "incompatibleVersionPlayerText": (
            "${NAME} iz nfowij f and ifid fioew af versino af oidf c acnat aonncect.\n"
        ...
        "touchScreenJoinWarningText": (
            "Yz hv jofndsf woijt iafh doctoucohdsf.\n"
        ...
        "vrOrientationResetCardboardText": (
            "Us this to weoojeif co VR owfjow ego\n"
    ...
    "newTestBuildAvailableText": (
        "A nwlf tat blfjl is aviflflzblz! (${VERSION} blzd ${BUILD}).\n"
        "Gzt iz tat ${ADDRESS}"
    ),
    "newText": "Ncw",
    ...
    "noProfilesErrorText": (
        "Yoú hávz nó pláyerz prófilzs, só yóu're stzck wíth '${NAME}'.\n"
    ...
    "pleaseRateText": (
        "If yóu're énjoyíng ${APP_NAME}, pléase cónsider táking z\n"
    ...
    "profileInfoText": (
        "Créate prófilzs fór yourself and your friends to assign\n"
    ...
    "ps3ControllersWindow": {
        "macInstructionsText": (
            "Swízch zff zhe pzwer zn zhe báck zf yzur PS3, máke sure\n"
        ...
        "ouyaInstructionsText": (
            "Tó usz a PS3 cóntróllzr wsth yóur ÓUYA, ssmply cónnzct st wsth a USB cablz\n"
    ...
    "remoteAppInfoShortText": (
        "${APP_NAME} iz cow eofi co wefjowiej fowiejfowef\n"
    ...
    "remote_app": {
        ...
        "connected": "Ctnntoicc.",
        "description": (
            "Usf coi cyao o acj wof joic oaijojef a;owi ocaobOBm.\n"
        ...
        "searching_caption": (
            "Tpa co w toia noa cowef owiejower.\n"
    ...
    "replayVersionErrorText": (
        "Srrz, tzh replalz wz mddd inzl ad fidfffr\n"
    ...
    "reportPlayerExplanationText": (
        "Uf woc ow efow efiwjco owe,we woi woiej ofijwoe fowe,wd fowidj owejfowief.\n"
        "Pef woc woejfowifw:"
    ),
    ...
    "settingsWindowAdvanced": {
        ...
        "helpTranslateText": (
            "${APP_NAME} lngalsdf transaldflksdfj arz fjocdmaosdf\n"
    ...
    "signInWithGameCenterText": (
        "To loci wo gamg wofiw efoiwjef.\n" "coaej goajb oaj Game foc etapp."
    ),
    ...
    "store": {
        ...
        "freeBombSquadProText": (
            "Bfjaoefj ij foawje foijcowje oifjwo jf woaifjo waf\n"
    ...
    "storeDescriptionText": (
        "asdfj fwofjwe fwjfjwf asdlfjsdf fdjatoijw;ojfpwoef wefjwoefjwfe.\n"
        "\n"
    ...
    "translations": {
        ...
        "gameDescriptions": {
            (
                ...
                "Bé thé chósen ónz fór a léngth éf tíme tó wzn.\n"
        ...
        "inputDeviceNames": {"Keyboard": "Kblflzfz", "Keyboard P2": "Kzboardz P2z"},
        "languages": {
            "Arabic": "Aroijwe",
        ...
        "playlistNames": {"Just Epic": "Jst Pcpc", "Just Sports": "Jspsf Zprttz"},
        "promoCodeResponses": {"invalid promo code": "invlidf promoz cdfd"},
        "scoreNames": {
            "Flags": "Flágz",
            "Goals": "Góálz",
            "Score": "Sczórz",
        ...
        "serverResponses": {
            ...
            (
                ...
                "Ac woef oi eowic woiej fowije foijcwe?\n"
                "\n"
                "${ACCOUNT1}\n"
                "${ACCOUNT2}\n"
                "\n"
            ...
            (
                ...
                "LINKING FOFJWEF.  ${ACCOUNT} o iwjof\n"
            ...
            (
                ...
                "Lcjwe fwofj o ${ACCOUNT} to cowejfweof?\n"
            ...
            (
                ...
                "Rclfjoc ${COUNT} otjoa ojofj oweijf.\n"
            ...
            (
                ...
                "Sowejr cowj fwoe co wefj owe f c woefijw ego wejfoiwjejwfjoweiwfe;\n"
            ...
            (
                ...
                "Uncljwf ${ACCOUNT} cowed wthosijf?\n"
            ...
            (
                ...
                "WARNOEF: com owe fw epfojwe. cj weo fjwefo wejfo wef jocij eowiefwef.\n"
            ...
            (
                ...
                "Yr coijw epowf oief oaefoiwfowjef\n"
        ...
        "tips": {
            (
                ...
                "Á perfectly timed running-jumping-zpin-punch cán kill in á zingle hit\n"
            ...
            (
                ...
                "Creáte pláyer prófilez fór yóurzelf ánd yóur friendz with\n"
            ...
            (
                ...
                "Curze bóxez turn yóu intó á ticking time bómb.\n"
            ...
            (
                ...
                "Dezpite their lóókz, áll chárácterz' ábilitiez áre identicál,\n"
            ...
            (
                ...
                "Hóld dówn ány buttón tó run. Yóu'll get plácez fázter\n"
            ...
            (
                ...
                "Ice bómbz áre nót very pówerful, but they freeze\n"
            ...
            (
                ...
                "If zómeóne pickz yóu up, punch them ánd they'll let gó.\n"
            ...
            (
                ...
                "Iffz oc wo acoiw oifj woc ojef '${REMOTE_APP_NAME}' ars\n"
            ...
            (
                ...
                "If yóu áre zhórt ón cóntróllerz, inztáll the 'BómbZquád Remóte' ápp\n"
            ...
            (
                ...
                "If yóu get á zticky-bómb ztuck tó yóu, jump áróund ánd zpin in circlez. Yóu might\n"
            ...
            (
                ...
                "If yóu pick up á curze, yóur ónly hópe fór zurvivál iz tó\n"
            ...
            (
                ...
                "If yóu've gót lótz óf pláyerz cóming ánd góing, turn ón 'áutó-kick-idle-pláyerz'\n"
            ...
            (
                ...
                "Iw fowj eoaj wecojaw ;eofja ;woefj ;aowiejoawjef;oajw;eofja; wef\n"
            ...
            (
                ...
                "If yóur frámeráte iz chóppy, try turning dówn rezólutión\n"
            ...
            (
                ...
                "In Cápture-the-Flág, yóur ówn flág muzt be át yóur báze tó zcóre, If the óther\n"
            ...
            (
                ...
                "Mány thingz cán be picked up ánd thrówn, including óther pláyerz.  Tózzing\n"
            ...
            (
                ...
                "Plref can join and flasdj afl ion the mdc aosdfoasdf,\n"
            ...
            (
                ...
                "Pláyerz cán jóin ánd leáve in the middle óf mózt gámez,\n"
            ...
            (
                ...
                "Pówerupz ónly háve time limitz in có-óp gámez.\n"
            ...
            (
                ...
                "Punchez dó móre dámáge the fázter yóur fiztz áre móving,\n"
            ...
            (
                ...
                "Thiz level never endz, but á high zcóre here\n"
            ...
            (
                ...
                "Thrów ztrength iz bázed ón the directión yóu áre hólding.\n"
            ...
            (
                ...
                "Trrd fo toasdoasdfm? Ararap cale fasoif;osda!\n"
            ...
            (
                ...
                "Yóu cán 'áim' yóur punchez by zpinning left ór right.\n"
            ...
            (
                ...
                "Yóu cán judge when á bómb iz góing tó explóde bázed ón the\n"
            ...
            (
                ...
                "Yóu dón't need tó edit yóur prófile tó chánge chárácterz; Juzt prezz the tóp\n"
            ...
            (
                ...
                "Yóu táke dámáge when yóu wháck yóur heád ón thingz,\n"
    ...
    "trialPeriodEndedText": (
        "Yozr tríal púrizd hás úndzd. Wóuld yóu lúke\n"
    ...
    "wiimoteLicenseWindow": {
        "licenseText": (
            "Copyríght (c) 2007, DarwíínRúmotú Túam\n"
            "All ríghtz rúzúrvúd.\n"
            "\n"
    ...
    "wiimoteSetupWindow": {
        ...
        "thanksText": (
            "Thznks té thz DérwiinRémote táam\n" "Fúr máking thés pzsséble."
        ),
        "thanksTextScale": 0.8,
    ...
    "xbox360ControllersWindow": {
        ...
        "macInstructions2Text": (
            "Tá uzá cántrállárz wirálázzly, yáu'll alzá náád thá rácáivár that\n"
