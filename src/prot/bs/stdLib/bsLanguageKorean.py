...
values = {
    ...
    "addGameWindow": {"getMoreGamesText": "다른 게임 보기...", "titleText": "게임 추가"},
    "allowText": "허용",
    "alreadySignedInText": (
        "귀하의 계정은 다른 기기에서 로그인되었습니다. \n" "계정을 전환하거나 다른 기기에서 게임을 종료하고 \n" "다시 시도하십시오."
    ),
    ...
    "connectMobileDevicesWindow": {
        ...
        "bestResultsText": (
            "최선의 결과를 얻으려면 랙이 없는 Wi-Fi 네트워크가 필요합니다. \n"
            "다른 무선 장치들을 끄거나 Wi-Fi 라우터 근처에서 플레이하거나\n"
            "게임 호스트를 이더넷 네트워크에 직접 연결해서\n"
            "Wi-Fi 랙을 줄일 수 있습니다."
        ),
        "explanationText": (
            "스마트폰 또는 태블릿을 무선 컨트롤러로 사용하려면\n"
        ...
        "forIOSText": "iOS:",
        "getItForText": (
            "${REMOTE_APP_NAME} 앱의 iOS 버전은 Apple App Store에서, Android\n"
    ...
    "coopSelectWindow": {
        ...
        "welcome1Text": (
            "${LEAGUE}에 환영합니다. 별 등급을 획득하고\n"
            "업적을 완료하며 토너먼트에서 트로피를 획득해서\n"
            "리그 등급을 올릴 수 있습니다."
        ),
        "welcome2Text": (
            "또한 많은 동일한 활동에서 티켓을 획득할 수 있습니다.\n"
    ...
    "gatherWindow": {
        ...
        "friendPromoCodeInstructionsText": (
            "사용하려면 ${APP_NAME} 앱을 열고 '설정->고급->코드 입력'으로 이동합니다.\n"
        ...
        "googlePlayReInviteText": (
            "새 초대를 시작하면 파티 내의 Google Play 플레이어\n"
        ...
        "wifiDirectDescriptionTopText": (
            "Wi-Fi 다이렉트는 Wi-Fi 네트워크 없이 직접 안드로이드 장치들을 연결하는 데\n"
    ...
    "helpWindow": {
        ...
        "controllersInfoText": (
            "네트워크를 통해 친구들과 함께 ${APP_NAME}를 즐기거나\n"
        ...
        "controlsText": "컨트롤",
        "devicesInfoText": (
            "일반 버전을 이용해 네트워크에서 ${APP_NAME}의 VR 버전을 \n"
        ...
        "devicesText": "기기",
        "friendsGoodText": (
            "친구들이 있으면 좋습니다.  ${APP_NAME}는 여러 친구가 함께 즐길 때\n"
    ...
    "internal": {
        ...
        "incompatibleVersionHostText": (
            "호스트가 다른 게임 버전을 실행하고 있습니다.\n" "모두 최신 버전인지 확인한 후 다시 시도해보세요."
        ),
        "incompatibleVersionPlayerText": (
            "${NAME} 님이 다른 게임 버전을 실행하고 있습니다.\n" "모두 최신 버전인지 확인한 후 다시 시도해보세요."
        ),
    ...
    "newTestBuildAvailableText": (
        "새 테스트 빌드가 나왔습니다! (${VERSION} 빌드 ${BUILD}).\n" "${ADDRESS}에서 다운로드 하세요"
    ),
    "newText": "새",
    ...
    "promoCodeWindow": {"codeText": "코드", "enterText": "입력"},
    "promoSubmitErrorText": "코드 제출 오류. 인터넷 연결 상태를 확인하세요",
    "ps3ControllersWindow": {
        "macInstructionsText": (
            "PS3의 전원을 끄고, 블루투스를 켠 뒤 컨트롤러를 USB로 연결하면 페어링이 됩니다.\n"
        ...
        "ouyaInstructionsText": (
            "PS3 컨트롤러를 OUYA에서 사용하시려면, 우선 USB 케이블로 연결하여 페어링을 하면 됩니다.\n"
    ...
    "remoteAppInfoShortText": (
        "${APP_NAME}는 친구 또는 가족과 같이 할 때 더 재미있습니다.\n"
        "컨트롤러 몇개를 연결하거나 또는\n"
    ...
    "remote_app": {
        ...
        "connected": "연결됨.",
        "description": (
            "스마트폰 또는 태블릿을 BombSquad의 컨트롤러로 사용하세요.\n"
    ...
    "reportPlayerExplanationText": (
        "치팅, 부적절한 언어 또는 기타 나쁜 행위를 신고하려면 이 이메일을 사용하세요.\n" "아래에 기재해주십시오."
    ),
    ...
    "scoreText": "점수",
    "scoreUnits": {"millisecondsText": "밀리초", "pointsText": "점수", "secondsText": "초"},
    ...
    "settingsWindowAdvanced": {
        ...
        "helpTranslateText": (
            "${APP_NAME}의 비영어권 번역은 커뮤니티에서 지원된\n"
    ...
    "store": {
        ...
        "freeBombSquadProText": (
            "현재 봄스쿼드는 무료이지만, 당신은 무료로 전환되기 전 구매를 하였으므로\n"
    ...
    "translations": {
        ...
        "inputDeviceNames": {"Keyboard": "키보드", "Keyboard P2": "키보드 P2"},
        "languages": {
            "Arabic": "아랍어",
            "Belarussian": "벨로루시어",
            "Chinese": "중국어",
        ...
        "playlistNames": {"Just Epic": "에픽 전용", "Just Sports": "스포츠 전용"},
        "scoreNames": {
            "Flags": "깃발",
            "Goals": "골",
            "Score": "점수",
        ...
        "tips": {
            ...
            (
                ...
                "끈적이 폭탄이 당신에게 붙으면 마구 점프하고 빙빙 도세요. 폭탄을 흔들어 떨어트릴 수\n"
            ...
            (
                ...
                "많은 플레이어가 들어왔다 나갔다 하면 설정에서 '부재 중-플레이어-자동-추방'을\n"
            ...
            (
                ...
                "깃발-탈환에서 점수를 획득하려면 자신의 깃발이 자신의 기지에 있어야 해요.\n"
            ...
            (
                ...
                "다른 플레이어를 포함해서 많은 것을 집고 던질 수 있어요. 적들을 절벽 밖으로\n"
            ...
            (
                ...
                "대부분의 게임에서 플레이어들이 중간에 들어오고 나갈 수 있어요.\n"
    ...
    "waveText": "웨이브",
    "wellSureText": "확인!",
    "wiimoteLicenseWindow": {"titleText": "DarwiinRemote 저작권"},
    "wiimoteListenWindow": {
    ...
    "wiimoteSetupWindow": {
        ...
        "listenText": "등록하기",
        "macInstructionsText": (
            "Wiii를 꺼 놓고 블루투스를 킨 후 '등록하기' 버튼을 누르시오.\n"
    ...
    "xbox360ControllersWindow": {
        ...
        "macInstructions2Text": (
            "컨트롤러를 무선으로 이용하기 위해선 윈도우즈용 Xbox 360 무선 컨트롤러와\n"
            "같이 있는 무선 리시버가 필요합니다.\n"
        ...
        "macInstructionsText": (
            "Xbox 360 컨트롤러를 사용하기 위해선 하단 링크의 맥용 드라이버를\n"
            "설치하신 후 사용하실 수 있습니다.\n"
            "유선 컨트롤러와 무선 컨트롤러 둘다 지원합니다."
        ),
        "ouyaInstructionsText": (
            "Xbox 360 컨트롤러를 BombSquad에 사용하기 위해선 기기의\n"
