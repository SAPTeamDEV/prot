...
values = {
    "accountSettingsWindow": {
        ...
        "linkAccountsInstructionsNewText": (
            "Pro spojení dvou účtů na jednom z nich\n"
        ...
        "linkAccountsInstructionsText": (
            "Pokud chcete propojit účty, na jednom z nich generujte kód\n"
        ...
        "setAccountNameDesc": (
            "Vyberte si jméno pro váš účet.\n"
            "Můžete použít jedno ze svých již\n"
            "použitých nebo si vytvořit nové."
        ),
        "signInInfoText": (
            "Přihlašte se, abyste mohli sbírat kupóny, soupeřit online,\n"
        ...
        "testAccountWarningCardboardText": (
            'Varování: Přihlašujete se s "testovacím" účtem.\n'
        ...
        "testAccountWarningOculusText": (
            'Varování: Přihlašujete se pod "testovacím" účtem.\n'
        ...
        "testAccountWarningText": (
            'Upozornění: jste přihlášení k "test" účtu. \n'
    ...
    "allowText": "Povolit",
    "alreadySignedInText": (
        "Tento účet je používán v jiném zařízení;\n"
    ...
    "buttonText": "tlačitko",
    "canWeDebugText": (
        "Chtěli byste, aby BombSquad automaticky hlásil \n"
    ...
    "configGamepadSelectWindow": {
        ...
        "pressAnyButtonText": (
            "Stiskněte libovolné tlačítko na ovladači,\n" " který chcete nastavovat..."
        ),
    ...
    "configGamepadWindow": {
        ...
        "secondHalfText": (
            "Použijte tohle k nastavení druhé poloviny\n"
    ...
    "configKeyboardWindow": {
        ...
        "keyboard2NoteText": (
            "Poznámka: většina klávesnic může registrovat jen pár stisklých\n"
    ...
    "configTouchscreenWindow": {
        ...
        "swipeInfoText": (
            "Na 'Přejížděcí' styl ovládání se trochu déle zvyká, ale\n"
    ...
    "connectMobileDevicesWindow": {
        ...
        "bestResultsText": (
            "Pro nejlepší výsledky budete potřebovat wifi síť bez lagů.\n"
        ...
        "explanationText": (
            "Pro použití chytrého telefonu nebo tabletu jako bezdrátový ovladač,nainstalujte si aplikaci  ${REMOTE_APP_NAME}.\n"
        ...
        "forIOSText": "pro iOS:",
        "getItForText": (
            "Získejte ${REMOTE_APP_NAME} pro I OS v App Store,\n"
    ...
    "coopSelectWindow": {
        ...
        "campaignText": "Kampaň",
        "challengesInfoText": (
            "Vyhrajte ceny za dokončování mini-her.\n"
            "\n"
    ...
    "difficultyHardUnlockOnlyText": (
        "Tento level může být odemčen pouze v těžkém módu.\n"
    ...
    "disableXInputDescriptionText": (
        "Povolí více než 4 ovladače ale nemusí\n" "fingovat dobře."
    ),
    ...
    "editProfileWindow": {
        "accountProfileInfoText": (
            "Toto je speciální profil se jménem\n"
        ...
        "globalProfileInfoText": (
            "U globálních herních profilů je garantováno, že Vaše\n"
        ...
        "localProfileInfoText": (
            "Lokální herní profily nemají žádné ikony a u jejich jmen \n"
        ...
        "upgradeProfileInfoText": (
            "Toto rezervuje Vaše uživatelské jméno celosvětově,\n"
    ...
    "failText": "Fail",
    "fatalErrorText": (
        "Ou nou,něco chybí nebo se něco rozbilo.\n"
    ...
    "gameSettingsWindow": {"addGameText": "Přidat Hru"},
    "gamesToText": "${WINCOUNT} Her k ${LOSECOUNT}",
    "gatherWindow": {
        "aboutDescriptionLocalMultiplayerExtraText": (
            "Pamatujte: jakékoli zařízení v partě může mít více\n"
            "než jednoho hráče, když máte dostatek ovladačů."
        ),
        "aboutDescriptionText": (
            "Použijte tyto záložky pro vytvoření party.\n"
            "\n"
        ...
        "appInviteInfoText": (
            "Pozvěte přátele ke hraní BombSquad a získají\n"
        ...
        "disconnectClientsText": (
            "Tímto se odpojí ${COUNT} hráč/ů\n" "ve Vaší partě. Jste si jistí?"
        ),
        "earnTicketsForRecommendingAmountText": (
            "Přátelé získají ${COUNT} tiketů když zkusí tuto hru\n"
        ...
        "friendPromoCodeInstructionsText": (
            'Pro použití otevřete ${APP_NAME} a jděte do ,,Nastavení->Pokročilé->Vložit kód"\n'
        ...
        "googlePlayReInviteText": (
            "Máte v partě ${COUNT} Google Play hráčů.\n"
        ...
        "inviteAFriendText": (
            "Že vaši přátelé ještě tuto hru nehrají? Pozvěte je,\n"
        ...
        "wifiDirectDescriptionBottomText": (
            "Jestližem mají všechna zařízení funkci 'Wi-Fi Direct', je možné ji použít k nalezení\n"
        ...
        "wifiDirectDescriptionTopText": (
            "Wi-Fi Direct může být použit pro propojení zařízení Android přímo,\n"
    ...
    "getTicketsWindow": {
        ...
        "unavailableLinkAccountText": (
            "Omlouváme se, ale nákupy nejsou na této platformě možné.\n"
    ...
    "helpWindow": {
        ...
        "controllersInfoText": (
            "Můžete hrát ${APP_NAME} s přáteli přes síť nebo můžete, pokud máte\n"
        ...
        "controlsText": "Ovládání",
        "devicesInfoText": (
            "VR verze ${APP_NAME} může být hrána přes síť s normální\n"
        ...
        "friendsGoodText": (
            "Je dobré je mít. ${APP_NAME} je největší zábava s více hráči\n"
    ...
    "installDiskSpaceErrorText": (
        "CHYBA: Není možné dokončit instalaci.\n"
    ...
    "internal": {
        ...
        "connectionFailedVersionMismatchText": (
            "Připojení selhalo; Hostitel používá jinou verzi hry.\n"
        ...
        "joinedPartyInstructionsText": (
            "Někdo se připojil do tvojí party. \n" "Stiskni 'Hrát' pro start hry"
        ),
        ...
        "touchScreenJoinWarningText": (
            "Připojili jste se s dotykovou obrazovkou.\n"
        ...
        "vrOrientationResetCardboardText": (
            "Použitjte toto pro reset orientace VR.\n"
    ...
    "mustInviteFriendsText": (
        "Poznámka: Musíte pozvat přátele\n"
    ...
    "newTestBuildAvailableText": (
        "Novější testovací build je dostupný! (${VERSION} build ${BUILD}).\n"
    ...
    "noProfilesErrorText": (
        "Nemáte žádné herní profily, takže Vám bylo podstrčeno jméno '${NAME}'.\n"
    ...
    "pleaseRateText": (
        "Jestliže Vás ${APP_NAME} baví, zvažte prosím, jestli si nechcete udělat\n"
    ...
    "ps3ControllersWindow": {
        "macInstructionsText": (
            "Vypněte na zadní straně své PS3, ujistěte se, že\n"
        ...
        "ouyaInstructionsText": (
            "Pro použití ovladače s Vaším OUYA, ho prostě jednou připojte přes USB kabel\n"
    ...
    "remoteAppInfoShortText": (
        "${APP_NAME} je zábavnější hrát s rodinou & přáteli.\n"
    ...
    "remote_app": {
        ...
        "connected": "Připojen.",
        "description": (
            "Použijte Váš telefon či tablet jako ovladač pro BombSquad.\n"
        ...
        "searching_caption": (
            "Pro připojení se dotkněte jména hry.\n"
    ...
    "replayVersionErrorText": (
        "Omlouváme se, ale tento záznam byl vytvořen\n"
    ...
    "reportPlayerExplanationText": (
        "Použijte tento email pro nahlášení podvádění, nevhodného vyjadřování či jiného špatného chování.\n"
        "Prosím popište níže:"
    ),
    ...
    "settingsWindowAdvanced": {
        ...
        "helpTranslateText": (
            "Jiné než anglické verze ${APP_NAME} jsou komunitně\n"
    ...
    "signInWithGameCenterText": (
        "Pro použití účtu Game Center se přihlaste\n" "s pomocí aplikace Game Center."
    ),
    ...
    "store": {
        ...
        "bombSquadProDescriptionText": (
            "• Zdvojnásobuje kupóny získané za achievementy\n"
    ...
    "translations": {
        ...
        "gameDescriptions": {
            (
                ...
                "Staňte se vyvoleným po dlouhý čas, abyste vyhráli.\n"
        ...
        "inputDeviceNames": {"Keyboard": "Klávesnice", "Keyboard P2": "Klávesnice P2"},
        "languages": {
            "Arabic": "Arabsky",
        ...
        "playlistNames": {"Just Epic": "Jen Epické", "Just Sports": "Jen Sporty"},
        "scoreNames": {
            "Flags": "Vlajky",
            "Goals": "Góly",
            "Score": "Skóre",
        ...
        "serverResponses": {
            ...
            (
                ...
                "Jste si jisti, že chcete propojit tyto účty?\n"
                "\n"
                "${ACCOUNT1}\n"
                "${ACCOUNT2}\n"
                "\n"
            ...
            (
                ...
                "Propojení zamítnuto. ${ACCOUNT} obsahuje\n"
            ...
            (
                ...
                "Chcete spojit účet ${ACCOUNT} s tímto účtem?\n"
            ...
            (
                ...
                "Získali jste ${COUNT} kupónů za přihlášení.\n"
            ...
            (
                ...
                "Server běží na novější verzi a tu vaši nepodporuje,\n"
            ...
            (
                ...
                "Odpojit ${ACCOUNT} od tohoto účtu?\n"
            ...
            (
                ...
                "VAROVÁNÍ: Byla proti vám vznešena obvinění z podvádění ve hře.\n"
        ...
        "tips": {
            (
                ...
                "Perfektně načasovaný Běh-výskok-otočka-úder může zabít na jednu ránu\n"
            ...
            (
                ...
                "Vytvořte herní profily pro Vás i Vaše přátele s Vašimi\n"
            ...
            (
                ...
                "Prokletí vás změní v časovanou bombu.\n"
            ...
            (
                ...
                "Kromě vzhledu mají všechny postavy stejné vlastnosti\n"
            ...
            (
                ...
                "Držte jakékoliv tlačítko pro sprint. Budete rychlejší.¨\n"
            ...
            (
                ...
                "Ledové Bomby nejsou moc silné, ale zmrazí vše, \n"
            ...
            (
                ...
                "Pokuď vás někdo chytne, udeřte ho a on vás pustí.\n"
            ...
            (
                ...
                "Pokud jste krátký na řadičích, nainstalujte '${REMOTE_APP_NAME}' app \n"
            ...
            (
                ...
                "Pokuď nemáte ovladač, nainstalujte si aplikaci 'BombSquad Remote'\n"
            ...
            (
                ...
                "Když se k Vám přilepí Lepivá Bomba, skákejte jako diví a točte se v kruzích.\n"
            ...
            (
                ...
                "Pokud seberete prokletí, vaší jedinou nadějí na přežití\n"
            ...
            (
                ...
                "Jestliže máte hodně hráčů, kteří přichází a odchází, zapněte 'automatické vyhazování neaktivních hráčů'\n"
            ...
            (
                ...
                "Pokud se vaše zařízení zahřívá nebo byste chtěli šetřit baterii,\n"
            ...
            (
                ...
                "Pokud se vám začne sekat obraz, zkuste si snížit\n"
            ...
            (
                ...
                "V Seberte Vlajku, Vaše vlajka musí být na vaší základně, abyste mohli skórovat.\n"
            ...
            (
                ...
                "Spousty věcí může být sebráno a hozeno, včetně ostatních hráčů.\n"
            ...
            (
                ...
                "Hráči se mohou připojit a odpojit i v průběhu hry\n"
            ...
            (
                ...
                "Čím rychleji se pohybujete, tím větší zranění Vaše pěsti vytvoří,\n"
            ...
            (
                ...
                "Tento level nikdy nezkončí, ale zdejší vysoké skóre\n"
            ...
            (
                ...
                "Síla hodu je založena na směru který držíte.\n"
            ...
            (
                ...
                "Unavuje vás SoundTrack? Nastavte si svůj vlastní!\n"
            ...
            (
                ...
                "Můžete 'mířit' svoje údery  točením se doleva nebo doprava.\n"
            ...
            (
                ...
                "Můžete usoudit kdy se bomba chystá vybouchnout podle\n"
            ...
            (
                ...
                "Když se o něco bouchnete hlavou.. můžete se zranit\n"
    ...
    "wiimoteSetupWindow": {
        ...
        "macInstructionsText": (
            "Ujistěte se, že je Vaše Wii vyplé a Bluetooth je na vašem\n"
    ...
    "xbox360ControllersWindow": {
        ...
        "macInstructions2Text": (
            "Pro bezdrátové použití ovladače také potřebujete příjmač, který\n"
        ...
        "macInstructionsText": (
            "Pro použití ovladače Xbox 360, potřebujete nainstalovat\n"
            "Mac Driver který naleznete na odkazu napsaném níže.\n"
            "Funguje s drátovou i s bezdrátovou verzí ovladače."
        ),
        "ouyaInstructionsText": (
            "Pro použití kabelových Xbox 360 ovladačů pro BombSquad, je jednoduše\n"
