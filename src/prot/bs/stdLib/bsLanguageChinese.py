...
values = {
    ...
    "addGameWindow": {"getMoreGamesText": "获取更多游戏模式…", "titleText": "添加比赛"},
    "allowText": "允许",
    ...
    "connectMobileDevicesWindow": {
        ...
        "bestResultsText": (
            "零延迟无线网可助你取得最佳成绩。要想降低无线网延迟，\n"
            "你可以关闭其他无线设备，\n"
            "或者在无线路由器附近玩，\n"
            "再或者将游戏主机连接以太网。"
        ),
        "explanationText": (
            "如果想把智能手机或平板设备作为控制器，请安装\n"
        ...
        "forIOSText": "苹果iOS",
        "getItForText": (
            "iOS 用户可从 ${REMOTE_APP_NAME} 取得炸弹小分队遥控器\n"
    ...
    "gameSettingsWindow": {"addGameText": "添加比赛"},
    ...
    "gatherWindow": {
        ...
        "appInviteInfoText": (
            "邀请好友一起玩BombSquad，新玩家可获得 ${COUNT}免费点券。\n" "每成功邀请到一位好友，您可获得${YOU_COUNT}点券。"
        ),
        ...
        "friendPromoCodeInstructionsText": (
            '要使用代码，可打开 ${APP_NAME}，按"设置->高级->输入促销代码"操作。\n'
        ...
        "wifiDirectDescriptionBottomText": (
            "如果所有设备都设有 Wi-Fi Direct 面板，那他们应该可以使用通过它来找到彼此，\n"
    ...
    "scoreText": "得分",
    "scoreUnits": {"millisecondsText": "毫秒", "pointsText": "分", "secondsText": "秒"},
    ...
    "store": {
        ...
        "freeBombSquadProText": (
            "BombSquad现在是免费的，由于最初您是通过购买所得，您将获得\n"
    ...
    "translations": {
        ...
        "inputDeviceNames": {"Keyboard": "键盘", "Keyboard P2": "键盘P2"},
        "languages": {
            "Arabic": "阿拉伯语",
            "Belarussian": "白俄罗斯语",
            "Chinese": "简体中文",
        ...
        "playlistNames": {"Just Epic": "仅限史诗级", "Just Sports": "仅限运动类"},
        "scoreNames": {
            "Flags": "旗帜",
            "Goals": "进球",
            "Score": "得分",
    ...
    "waveText": "波",
    "wellSureText": "确定！",
    "wiimoteLicenseWindow": {"titleText": "DarwiinRemote版权所有"},
    "wiimoteListenWindow": {
    ...
    "xbox360ControllersWindow": {
        ...
        "macInstructionsText": (
            "如要使用Xbox 360手柄，您需要安装\n" "通过以下链接所获得的Mac驱动程序。\n" "该驱动程序与有线和无线手柄二者兼容。"
        ),
        "ouyaInstructionsText": (
            "如要在BombSquad中使用有线Xbox 360手柄，只需\n"
