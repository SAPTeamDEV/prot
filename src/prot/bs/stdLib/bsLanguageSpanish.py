...
values = {
    "accountSettingsWindow": {
        ...
        "linkAccountsInstructionsNewText": (
            "Para enlazar dos cuentas, genera un código en la primera cuenta\n"
        ...
        "linkAccountsInstructionsText": (
            "Para enlazar dos cuentas, genera un código en una\n"
        ...
        "resetProgressConfirmNoAchievementsText": (
            "Esto reiniciará tu progreso en el modo\n"
        ...
        "resetProgressConfirmText": (
            "Esto reiniciará tus logros, récords\n"
        ...
        "setAccountNameDesc": (
            "Selecciona el nombre a mostrar para tu cuenta. \n"
            "Puedes usar el nombre de tu cuenta asociada\n"
            "o crear un nombre personalizado."
        ),
        "signInInfoText": (
            "Inicia sesión para obtener tickets, competir en línea\n"
        ...
        "testAccountWarningCardboardText": (
            'Advertencia: inicias sesión con una cuenta "de prueba".\n'
        ...
        "testAccountWarningOculusText": (
            'Cuidado: Está ingresando con una cuenta "De prueba".\n'
        ...
        "testAccountWarningText": (
            "Advertencia: te estás registrando con una cuenta de\n"
    ...
    "allowText": "Permitir",
    "alreadySignedInText": (
        "Tu cuenta está registrada en otro dispositivo;\n"
    ...
    "buttonText": "botón",
    "canWeDebugText": (
        "¿Te gustaría que BombSquad enviara errores, accidentes, e\n"
    ...
    "configGamepadWindow": {
        ...
        "secondHalfText": (
            "Utiliza esta opción para configurar\n"
    ...
    "configKeyboardWindow": {
        ...
        "keyboard2NoteText": (
            "Nota: la mayoría de teclados sólo pueden registrar algunas\n"
    ...
    "configTouchscreenWindow": {
        ...
        "swipeInfoText": (
            "Controles de estilo 'deslizante' toman un poco de practica, pero\n"
    ...
    "connectMobileDevicesWindow": {
        ...
        "bestResultsText": (
            "Para mejores resultados necesitas una red inalámbrica rápida. Puedes\n"
        ...
        "explanationText": (
            "Para utilizar tus dispositivos móviles como controles, \n"
        ...
        "forIOSText": "para iOS:",
        "getItForText": (
            "Consigue ${REMOTE_APP_NAME} para iOS en el App Store de Apple\n"
    ...
    "coopSelectWindow": {
        ...
        "activenessInfoText": (
            "Este multiplicador aumenta en los días que juegas\n"
            "y disminuye cuando no juegas."
        ),
        "activityText": "Actividad",
        "campaignText": "Campaña",
        "challengesInfoText": (
            "Gana premios por completar los mini-juegos.\n"
            "\n"
        ...
        "prizesText": "Premios",
        "proMultInfoText": (
            "Los jugadores con la mejora ${PRO}\n"
        ...
        "totalText": "total",
        "tournamentInfoText": (
            "Compite por puntajes altos con\n"
        ...
        "welcome1Text": (
            "Bienvenido/a a ${LEAGUE}. Puedes mejorar tu\n"
    ...
    "creditsWindow": {
        ...
        "songCreditText": (
            "${TITLE} interpretada por ${PERFORMER}\n"
    ...
    "difficultyHardUnlockOnlyText": (
        "Este nivel solo puede ser desbloqueado en modo difícil.\n"
    ...
    "editProfileWindow": {
        "accountProfileInfoText": (
            "Este perfil de jugador especial tiene un nombre\n"
        ...
        "globalProfileInfoText": (
            "Los perfiles globales tienen un nombre único\n"
        ...
        "localProfileInfoText": (
            "Los perfiles locales no tienen iconos y  no hay garantía\n"
    ...
    "gameSettingsWindow": {"addGameText": "Agrega juego"},
    ...
    "gatherWindow": {
        "aboutDescriptionLocalMultiplayerExtraText": (
            "Recuerda: cualquier dispositivo en la fiesta puede\n"
            "tener mas de un jugador si tienen controles suficientes."
        ),
        "aboutDescriptionText": (
            "Usa estas pestañas para crear una fiesta.\n"
            "\n"
        ...
        "appInviteInfoText": (
            "Invita amigos a probar BombSquad y recibirán\n"
        ...
        "disconnectClientsText": (
            "Esto desconectará a ${COUNT} jugador(es) de\n" "tu fiesta. ¿Estás seguro?"
        ),
        "earnTicketsForRecommendingAmountText": (
            "Tus amigos recibirán ${COUNT} boletos si prueban el juego\n"
        ...
        "friendPromoCodeInstructionsText": (
            'Para usarlo, abre ${APP_NAME} y ve a "Ajustes-> Avanzado-> Ingresar código"\n'
        ...
        "googlePlayReInviteText": (
            "Hay ${COUNT} jugadores de Google Play en tu fiesta\n"
        ...
        "inviteAFriendText": (
            "¿Tus amigos no tienen el juego? Invítalos a\n"
        ...
        "wifiDirectDescriptionBottomText": (
            "Si todo los dispositivos disponen de 'Wi-fi Directo', deberían poder utiizarlo para\n"
        ...
        "wifiDirectDescriptionTopText": (
            "Wi-Fi Directo puede ser utilizado para conectar dispositivos Android sin\n"
    ...
    "getTicketsWindow": {
        ...
        "unavailableLinkAccountText": (
            "Lo sentimos, las compras no están disponibles en esta plataforma.\n"
    ...
    "helpWindow": {
        ...
        "controllersInfoText": (
            "Puedes jugar ${APP_NAME} con tus amigos en una red, o todos pueden\n"
        ...
        "controllersInfoTextFantasia": (
            "Un jugador puede usar el mando a distancia para jugar, pero\n"
        ...
        "controllersInfoTextMac": (
            "Uno o dos jugadores pueden usar el teclado, pero BombSquad es mejor\n"
        ...
        "controllersInfoTextOuya": (
            "Puedes usar controles OUYA, controles de PS3, controles de Xbox\n"
        ...
        "devicesInfoText": (
            "La version VR de ${APP_NAME} se puede jugar en red con la versión \n"
        ...
        "friendsGoodText": (
            "Cuantos más, mejor. ${APP_NAME} es más divertido con muchos \n"
        ...
        "powerupIceBombsDescriptionText": (
            "Más débil que las bombas habituales\n"
    ...
    "installDiskSpaceErrorText": (
        "ERROR: Incapaz de completar la instalación\n"
    ...
    "internal": {
        ...
        "connectionFailedVersionMismatchText": (
            "Conexión fallida; Host corre una versión diferente del juego.\n"
        ...
        "incompatibleNewerVersionHostText": (
            "El host esta corriendo una versión nueva del juego.\n"
            "Actualiza a la última versión y vuelve a intentarlo."
        ),
        "incompatibleVersionHostText": (
            "Host corre una versión diferente del juego; imposible conectar.\n"
            "Asegúrese de que ambos están actualizados y vuelva a intentar."
        ),
        "incompatibleVersionPlayerText": (
            "${NAME} está corriendo una versión diferente del juego y no se ha podido conectar.\n"
            "Asegúrese de que ambos están actualizados y vuelva a intentar."
        ),
        ...
        "vrOrientationResetCardboardText": (
            "Usa esto para reiniciarr la orientación del VR.\n"
    ...
    "macControllerSubsystemMFiNoteText": (
        "Control hecho para iOS/Mac detectado;\n"
    ...
    "newTestBuildAvailableText": (
        "¡Una nueva build de prueba está disponible! (${VERSION} build ${BUILD}).\n"
        "Obténla en ${ADDRESS}"
    ),
    "newText": "Nuevo",
    ...
    "noProfilesErrorText": (
        "No haz creado ningún perfil, por lo que tendrás que llamarte '${NAME}'.\n"
    ...
    "pleaseRateText": (
        "Si te gusta ${APP_NAME}, por favor tomate un momento\n"
    ...
    "profileInfoText": (
        "Crear perfiles para ti y tus amigos para que\n"
    ...
    "ps3ControllersWindow": {
        "macInstructionsText": (
            "Apaga tu PS3, asegúrate que el Bluetooth esté activado en\n"
        ...
        "ouyaInstructionsText": (
            "Para usar un control de PS3 con tu OUYA, tienes que conectar lo una sola vez con\n"
    ...
    "remoteAppInfoShortText": (
        "${APP_NAME} es más divertido cuando se juega con la familia y amigos .\n"
    ...
    "remote_app": {
        ...
        "connected": "Conectado.",
        "description": (
            "Usa tu teléfono o tableta como control para BombSquad.\n"
        ...
        "searching_caption": (
            "Toca el nombre de la partida para unirte.\n"
    ...
    "replayVersionErrorText": (
        "Lo sentimos, esta repetición fue hecha en una\n"
    ...
    "reportPlayerExplanationText": (
        "Usa este email para reportar trampas, lenguaje ofensivo, u otro mal comportamiento.\n"
    ...
    "settingsWindowAdvanced": {
        ...
        "helpTranslateText": (
            "Las traducciones de ${APP_NAME} son un esfuerzo\n"
    ...
    "signInWithGameCenterText": (
        "Para usar una cuenta de Game Center,\n"
    ...
    "store": {
        ...
        "bombSquadProDescriptionText": (
            "• Doble de tickets recibidos en el juego.\n"
        ...
        "bombSquadProNewDescriptionText": (
            "•Quita los anuncios y las pantallas molestas\n"
        ...
        "freeBombSquadProText": (
            "BombSquad ahora es gratis, pero ya que compraste el juego recibirás\n"
    ...
    "translations": {
        ...
        "gameDescriptions": {
            (
                ...
                "Sé el elegido por el tiempo designado para ganar.\n"
            ...
            "Kill a set number of enemies to win.": (
                "Elimina a un número determinado \n" "de enemigos para ganar."
            ),
        ...
        "inputDeviceNames": {"Keyboard": "Teclado", "Keyboard P2": "Teclado P2"},
        "languages": {
            "Arabic": "Árabe",
        ...
        "playlistNames": {"Just Epic": "Solo Épico", "Just Sports": "Solo Deportes"},
        "promoCodeResponses": {"invalid promo code": "Código promocional inválido"},
        "scoreNames": {
            "Flags": "Banderas",
            "Goals": "Goles",
            "Score": "Puntuación",
        ...
        "serverResponses": {
            ...
            (
                ...
                "VINCULACÍON DENEGADO. ${ACCOUNT} contiene\n"
            ...
            (
                ...
                "Has recibido ${COUNT} tickets recibidos por iniciar sesión.\n"
            ...
            (
                ...
                "La funcionalidad del servidor ya no es compatible en esta versión del juego;\n"
            ...
            (
                ...
                "¿Desenlazar ${ACCOUNT} de esta cuenta?\n"
            ...
            (
                ...
                "ADVERTENCIA: se han emitido reclamaciones de piratería contra tu cuenta.\n"
            ...
            (
                ...
                "Tu copia del juego fue modificada.\n"
        ...
        "tips": {
            (
                ...
                "Un 'corre-salta-gira-golpea' puede destrozar de un solo impacto\n"
            ...
            (
                ...
                "Crea perfiles para ti y tus amigos con nombres\n"
            ...
            (
                ...
                "La maldición te convierte en una bomba de tiempo.\n"
            ...
            (
                ...
                "A pesar de su apariencia, las habilidades de todos los personajes\n"
            ...
            (
                ...
                "Mantén pulsado cualquier botón para correr. Llegarás a lugares rápido\n"
            ...
            (
                ...
                "Las Bombas de hielo no son muy potentes, pero congelan lo\n"
            ...
            (
                ...
                "Si alguien te levanta, golpéalos y ve como te sueltan.\n"
            ...
            (
                ...
                "Si no tienes suficientes controles, instala la aplicación '${REMOTE_APP_NAME}'\n"
            ...
            (
                ...
                "Te faltan controles? Instala la aplicación 'BombSquad Remote'\n"
            ...
            (
                ...
                "Si te adhieres a una bomba pegajosa, salta y da muchas vueltas. Es posible que sacudas\n"
            ...
            (
                ...
                "Si levantas una maldición, tu única esperanza es\n"
            ...
            (
                ...
                "Si tienes muchos jugadores yendo y viniendo, activa 'expulsar jugadores inactivos'\n"
            ...
            (
                ...
                "Si tu dispositivo se pone caliente o te gustaria conservar bateria,\n"
            ...
            (
                ...
                "Si la imagen va lenta, intenta reducir la resolución\n"
            ...
            (
                ...
                "En Captura la Bandera, la tuya debe estar en tu base para que anotes.\n"
            ...
            (
                ...
                "Muchas cosas se pueden recoger y lanzar, incluyendo a otros jugadores.\n"
            ...
            (
                ...
                "Jugadores pueden unirse e irse en medio de casi todos los juegos,\n"
            ...
            (
                ...
                "Los jugadores pueden unirse y abandonar en el transcurso del juego,\n"
            ...
            (
                ...
                "Los poderes sólo tienen tiempo límite en juego cooperativo.\n"
            ...
            (
                ...
                "Cuanto más rápido se mueven tu puños, tus golpes tienen\n"
            ...
            (
                ...
                "Corre de un lado a otro antes de lanzar una\n"
                "bomba de 'latigazo' para lanzarla lejos."
            ),
            ("Take out a group of enemies by\n" "setting off a bomb near a TNT box."): (
                "Elimina un gran cantidad de enemigos\n"
            ...
            (
                ...
                "La cabeza es la zona más vulnerable, una bomba pegajosa\n"
            ...
            (
                ...
                "Este nivel no tiene fin, pero un alto puntaje aquí\n"
            ...
            (
                ...
                "La fuerza de tiro se basa en la dirección que estás sosteniendo.\n"
            ...
            (
                ...
                "¿Cansado de la pista de audio? ¡Reemplázala con tu música!\n"
            ...
            (
                ...
                "Puedes 'dirigir' tus golpes girando a la izquierda o derecha. Esto\n"
            ...
            (
                ...
                "Puedes juzgar si una bomba va a explotar según el color de\n"
            ...
            (
                ...
                "No necesitas editar tu perfil para cambiar de personaje; sólo presiona el botón\n"
            ...
            (
                ...
                "Te haces daño si golpeas tu cabeza contra cosas, así\n"
    ...
    "trialPeriodEndedText": (
        "Tu periodo de prueba se terminó. ¿Deseas\n"
    ...
    "tutorial": {
        ...
        "phrase07Text": (
            "¿Has visto? No nos estábamos moviendo, por eso casi \n"
    ...
    "wiimoteLicenseWindow": {"titleText": "Marca registrada DarwiinRemote"},
    "wiimoteListenWindow": {
    ...
    "wiimoteSetupWindow": {
        ...
        "listenText": "Escuchar",
        "macInstructionsText": (
            "Asegúrate de que tu Wii esté apagado y el Bluetooth esté activado en\n"
    ...
    "xbox360ControllersWindow": {
        ...
        "macInstructions2Text": (
            "Para usar controles inalámbricos, necesitarás el receptor que\n"
        ...
        "macInstructionsText": (
            "Para usar controles de Xbox 360, necesitarás instalar\n"
        ...
        "ouyaInstructionsText": (
            "Para usar controles con cable de Xbox 360 con BombSquad, simplemente\n"
