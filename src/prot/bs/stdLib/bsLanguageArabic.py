...
values = {
    "accountSettingsWindow": {
        ...
        "linkAccountsInstructionsNewText": (
            "لربط حسابين،- انشئ رمز من الجهاز المراد انشاء الحساب فية*\n"
        ...
        "linkAccountsInstructionsText": (
            "لربط حسابين, انتج كود على احد الحسابين \n"
        ...
        "resetProgressConfirmNoAchievementsText": (
            "سوف يحذف هذا الخيار تقدمك في الحملات التعاونية ولم يحذف تذاكرك\n"
            "لا يمكن إلغاء هذا الخيار\n"
            "هل أنت متأكد ؟"
        ),
        "resetProgressConfirmText": (
            ":عند موافقتك على هذا الاخيار سوف يتم\n"
        ...
        "signInInfoText": (
            "قم بتسجيل دخولك لتجمع بطاقات, وتتحدى الاعبين حول العالم\n"
        ...
        "testAccountWarningOculusText": (
            "تحذير: انت تقوم بتسجيل الدخول باستخدام حساب تجريبي.\n"
    ...
    "allowText": "السماح",
    "alreadySignedInText": (
        "تم تسجيل الدخول من حسابك من جهاز آخر.\n"
    ...
    "buttonText": "زر",
    "canWeDebugText": (
        "هل ترغب ان تقوم فرقة القنبلة تلقائيا بالتبليغ عن المشاكل والاخطاء التقنية \n"
    ...
    "configTouchscreenWindow": {
        ...
        "swipeInfoText": (
            "'انتقاد' الضوابط أسلوب تأخذ قليلا التعود على ولكن\n"
    ...
    "connectMobileDevicesWindow": {
        ...
        "appStoreText": "المتجر",
        "bestResultsText": (
            "لتحقيق أفضل النتائح ستحتاج اتصال انترنت سريع .. يمكنك \n"
            "زيادة السرعة بايقاف الاجهزة الاخرة المتصلة بالشبكة، أو اللعب \n"
            "قرب موزع الشبكة، أو الاتصال بمخدم اللعبة باستخدام الكابل \n"
            "المباشر الى الشبكة"
        ),
        "explanationText": (
            "لاستخدام الهاتف الذكي أو الكمبيوتر اللوحي باعتبارها وحدة تحكم لاسلكية،\n"
        ...
        "getItForText": (
            "احصل على ${REMOTE_APP_NAME} لنظام التشغيل يوس في أبل أب ستور\n"
    ...
    "coopSelectWindow": {
        ...
        "activenessInfoText": (
            "هذا المضاعف يرتفع في أيام عندما كنت\n"
            "واللعب وقطرات على أيام عندما كنت لا."
        ),
        "activityText": "نشاط",
        "campaignText": "حملة",
        "challengesInfoText": (
            "كسب الجوائز لاستكمال الألعاب المصغرة.\n"
            "\n"
        ...
        "prizesText": "الجوائز",
        "proMultInfoText": (
            "اللاعبين الذين لديهم الترقية ${PRO}\n"
        ...
        "welcome1Text": (
            "مرحبا بك في ${LEAGUE}. يمكنك تحسين الخاص بك\n"
            "ترتيب الدوري من خلال كسب تقييمات النجوم، والانتهاء\n"
            "والإنجازات، والفوز بالجوائز في البطولات."
        ),
        "welcome2Text": (
            "يمكنك أيضا الحصول على تذاكر من العديد من الأنشطة نفسها.\n"
    ...
    "difficultyHardUnlockOnlyText": (
        "هذا المستوى لا يمكن إلا أن تكون مقفلة في الوضع الصعب.\n"
    ...
    "editProfileWindow": {
        "accountProfileInfoText": (
            "يحتوي هذا الملف الشخصي الخاص على اسم\n"
        ...
        "globalProfileInfoText": (
            "Global player profiles are guaranteed to have unique\n"
        ...
        "localProfileInfoText": (
            "ملامح لاعب المحلي ليس لديهم رموز وأسمائهم\n"
        ...
        "upgradeProfileInfoText": (
            "هذا سيحفظ اسم لاعب في جميع أنحاء العالم\n" "وتسمح لك بتعيين رمز مخصص لها."
        ),
    ...
    "fireTVRemoteWarningText": (
        "* للحصول على تجربة أفضل، واستخدام\n"
        "لعبة تحكم أو تثبيت\n"
    ...
    "gatherWindow": {
        ...
        "disconnectClientsText": (
            "سيؤدي هذا إلى فصل المشغل ${COUNT}\n" "في حزبكم. هل أنت واثق؟"
        ),
        "earnTicketsForRecommendingAmountText": (
            "سيتلقى الأصدقاء تذاكر بقيمة ${COUNT} إذا حاولوا اللعبة\n"
        ...
        "friendPromoCodeInstructionsText": (
            'لاستخدامها ، افتح ${APP_NAME} وانتقل إلى "الإعدادات-> متقدم-> إدخال الرمز".\n'
        ...
        "googlePlayReInviteText": (
            "هناك ${COUNT} غوغل بلاي بلاير (s) في حفلك\n"
        ...
        "internetText": "انترنت",
        "inviteAFriendText": (
            "الأصدقاء ليس لديهم اللعبة؟ يمكنك دعوتهم إلى\n"
        ...
        "wifiDirectDescriptionBottomText": (
            'إذا كانت جميع الأجهزة تحتوي على لوحة "واي-في ديريكت"، فيجب أن تكون قادرة على استخدامها للعثور عليها\n'
        ...
        "wifiDirectDescriptionTopText": (
            "واي فاي المباشر يمكن استخدامها لتوصيل أجهزة الروبوت مباشرة دون\n"
    ...
    "getTicketsWindow": {
        ...
        "unavailableLinkAccountText": (
            "عذرا، لا تتوفر عمليات الشراء على هذا النظام الأساسي.\n"
    ...
    "helpWindow": {
        ...
        "controllersInfoText": (
            "يمكنك تشغيل ${APP_NAME} مع الأصدقاء عبر شبكة، أو أنت\n"
        ...
        "controlsText": "ضوابط",
        "devicesInfoText": (
            "يمكن تشغيل إصدار فر الذي يبلغ ${APP_NAME} عبر الشبكة\n"
        ...
        "devicesText": "الأجهزة",
        "friendsGoodText": (
            "هذه هي جيدة لديك. ${APP_NAME} أكثر متعة مع العديد\n"
    ...
    "internal": {
        ...
        "connectionFailedVersionMismatchText": (
            "فشل الاتصال؛ المضيف هو تشغيل نسخة مختلفة من اللعبة.\n"
        ...
        "incompatibleNewerVersionHostText": (
            "يقوم المضيف بتشغيل إصدار أحدث من اللعبة.\n"
            "تحديث إلى أحدث إصدار وحاول مرة أخرى."
        ),
        "incompatibleVersionHostText": (
            "المضيف هو تشغيل نسخة مختلفة من اللعبة.\n"
            "تأكد من أنك على حد سواء ما يصل إلى تاريخ وحاول مرة أخرى."
        ),
        "incompatibleVersionPlayerText": (
            "يعمل ${NAME} على إصدار مختلف من اللعبة.\n"
            "تأكد من أنك على حد سواء ما يصل إلى تاريخ وحاول مرة أخرى."
        ),
    ...
    "macControllerSubsystemMFiNoteText": (
        "تم العثور على وحدة التحكم التي تم إنشاؤها لنظام التشغيل يوس / ماك؛\n"
    ...
    "newTestBuildAvailableText": (
        "يتوفر اختبار اختبار أحدث! (${VERSION} بناء ${BUILD}).\n" "احصل على ${ADDRESS}"
    ),
    "newText": "الجديد",
    ...
    "ownFlagAtYourBaseWarning": (
        "يجب على العلم الخاص بك ان يكون في قاعدتك\n" "!لتسجل نقطة"
    ),
    ...
    "pleaseRateText": (
        "اذا كنت تستمتع بلعبة${APP_NAME}, يرجى اتخاذ لحظة وتقييمه\n"
    ...
    "promoCodeWindow": {"codeText": "رمز", "enterText": "ادخل"},
    "promoSubmitErrorText": "خطأ في إرسال الكود: تحقق من اتصالك بالإنترنت",
    "ps3ControllersWindow": {
        "macInstructionsText": (
            "إيقاف الطاقة على الجزء الخلفي من PS3 الخاص بك، تأكد\n"
        ...
        "ouyaInstructionsText": (
            "لاستخدام وحدة تحكم PS3 مع أويا الخاص بك، ببساطة توصيله مع كابل أوسب\n"
    ...
    "remoteAppInfoShortText": (
        "${APP_NAME} أكثر متعة عندما يتم تشغيله مع العائلة والأصدقاء.\n"
    ...
    "remote_app": {
        ...
        "description": (
            "استخدام الهاتف أو الكمبيوتر اللوحي كمحكم مع بومبسكاد.\n"
        ...
        "searching_caption": (
            "اضغط على اسم لعبة للانضمام إليه.\n"
    ...
    "replayVersionErrorText": (
        "عذرا، تم إجراء هذا الإعادة في صورة مختلفة\n"
    ...
    "reportPlayerExplanationText": (
        "استخدم هذه الرسالة الإلكترونية للإبلاغ عن الغش أو اللغة غير الملائمة أو أي سلوك سيئ آخر.\n"
        "يرجى وصف ما يلي:"
    ),
    ...
    "store": {
        ...
        "bombSquadProNewDescriptionText": (
            "• يزيل الإعلانات في اللعبة والشاشات تذمر\n"
        ...
        "freeBombSquadProText": (
            "بومبسكاد هو الآن مجانا، ولكن منذ كنت أصلا اشتريت أنت\n"
    ...
    "translations": {
        ...
        "gameDescriptions": {
            (
                ...
                "يكون اختيار واحد لفترة من الوقت للفوز.\n" "قتل اختيار واحد لتصبح عليه."
            ),
        ...
        "playlistNames": {"Just Epic": "مجرد ملحمة", "Just Sports": "الرياضة فقط"},
        "scoreNames": {
            "Flags": "أعلام",
            "Goals": "الأهداف",
            "Score": "أحرز هدفاً",
        ...
        "serverResponses": {
            ...
            (
                ...
                "هل تريد بالتأكيد ربط هذه الحسابات؟\n"
                "\n"
                "$ {ACCOUNT1}\n"
                "$ {ACCOUNT2}\n"
                "\n"
            ...
            (
                ...
                "هل تريد ربط الحساب ${ACCOUNT} بهذا الحساب؟\n"
            ...
            (
                ...
                "تم استلام ${COUNT} من التذاكر لتسجيل الدخول.\n"
            ...
            (
                ...
                "لم تعد معتمدة وظيفة الخادم في هذا الإصدار من اللعبة.\n"
            ...
            (
                ...
                "هل تريد إلغاء ربط ${ACCOUNT} من هذا الحساب؟\n"
            ...
            (
                ...
                "تحذير: تم إصدار شكاوى تتعلق بالقرصنة ضد حسابك.\n"
        ...
        "tips": {
            (
                ...
                "A توقيت تماما تشغيل القفز تدور لكمة يمكن أن تقتل في ضربة واحدة\n"
            ...
            (
                ...
                "إنشاء ملفات تعريف لاعب لنفسك وأصدقائك مع\n"
            ...
            (
                ...
                "صناديق لعنة تتحول لك في قنبلة موقوتة.\n"
            ...
            (
                ...
                "على الرغم من مظهرها، وقدرات جميع الشخصيات متطابقة،\n"
            ...
            (
                ...
                "اضغط باستمرار على أي زر لتشغيله. ستحصل على الأماكن بشكل أسرع\n"
            ...
            (
                ...
                "القنابل الثلجية ليست قوية جدا، لكنها تجمد\n"
            ...
            (
                ...
                "إذا كان شخص ما يختار لك، لكمة لهم وأنها سوف ترك.\n"
            ...
            (
                ...
                "إذا كنت قصيرا على وحدات التحكم، فثبت تطبيق '${REMOTE_APP_NAME}'\n"
            ...
            (
                ...
                "إذا كنت تحصل على قنبلة لزجة عالقة لك، والقفز حولها وتدور في الدوائر. يمكنك\n"
            ...
            (
                ...
                "إذا كنت تلتقط لعنة، الأمل الوحيد للبقاء على قيد الحياة هو\n"
            ...
            (
                ...
                "إذا كنت قد حصلت على الكثير من اللاعبين القادمة والذهاب، بدوره على 'لصناعة السيارات في ركلة الخمول لاعبين'\n"
            ...
            (
                ...
                "إذا كان جهازك يحصل دافئ جدا أو كنت ترغب في الحفاظ على طاقة البطارية،\n"
            ...
            (
                ...
                "إذا كان إطار الإطارات متقطع، فجرب رفض الدقة\n"
            ...
            (
                ...
                "في القبض على العلم العلم الخاص بك يجب أن يكون في قاعدة الخاص بك ليسجل، إذا كان الآخر\n"
            ...
            (
                ...
                "العديد من الأشياء يمكن التقاطها وألقيت، بما في ذلك لاعبين آخرين. القذف\n"
            ...
            (
                ...
                "يمكن للاعبين الانضمام وترك في منتصف معظم المباريات،\n"
            ...
            (
                ...
                "الرأس هو المنطقة الأكثر ضعفا، لذلك قنبلة لزجة\n"
            ...
            (
                ...
                "هذا المستوى لا تنتهي أبدا، ولكن على درجة عالية هنا\n"
            ...
            (
                ...
                "وتستند قوة رمي على الاتجاه الذي عقد.\n"
            ...
            (
                ...
                "تعبت من الموسيقى التصويرية؟ استبدالها بنفسك!\n"
            ...
            (
                ...
                "يمكنك 'تهدف' اللكمات الخاصة بك عن طريق الغزل اليسار أو اليمين.\n"
            ...
            (
                ...
                "يمكنك الحكم عندما قنبلة سوف تنفجر على أساس\n"
            ...
            (
                ...
                "كنت تأخذ الضرر عندما كنت اجتز رأسك على الأشياء،\n"
    ...
    "wiimoteLicenseWindow": {"titleText": "داروين ريموت حقوق التأليف والنشر"},
    "wiimoteListenWindow": {
    ...
    "wiimoteSetupWindow": {
        ...
        "listenText": "استمع",
        "macInstructionsText": (
            "الخاص بك مطفئا والبلوتوث مفعلا في الماك الخاص بك Wii تأكد ان\n"
    ...
    "xbox360ControllersWindow": {
        ...
        "macInstructions2Text": (
            "لاستخدام وحدات تحكم لاسلكيا، سوف تحتاج أيضا المتلقي ذلك\n"
        ...
        "macInstructionsText": (
            "لاستخدام وحدات تحكم الاكس بوكس 360، ستحتاج إلى تثبيت\n"
            "برنامج تشغيل ماك متوفر على الرابط أدناه.\n"
            "وهو يعمل مع كل من وحدات تحكم السلكية واللاسلكية."
        ),
        "ouyaInstructionsText": (
            "سلكية مع اللعبة Xbox 360 لإستخدام يد تحكم \n"
