...
values = {
    "accountSettingsWindow": {
        ...
        "linkAccountsInstructionsText": (
            "For at forbinde to konti, opret en kode på en\n"
        ...
        "signInInfoText": (
            "Log in for at optjene tickets, konkurrere online \n"
        ...
        "testAccountWarningOculusText": (
            'Advarsel: Du logger ind med en "test" bruger. \n'
        ...
        "testAccountWarningText": (
            'Advarsel: Du logger nu ind med en "test" bruger.\n'
    ...
    "buttonText": "Knap",
    "canWeDebugText": (
        "Er det okay at BombSquad automatisk rapporterer fejl, \n"
    ...
    "completeThisLevelToProceedText": (
        "Du bliver nødt til at gennemføre\n" "dette level for at fortsætte!"
    ),
    ...
    "configGamepadSelectWindow": {
        ...
        "pressAnyButtonText": (
            "Tryk på en hvilkårlig knap på controller\n" "som du gerne vil konfigurere."
        ),
    ...
    "configGamepadWindow": {
        ...
        "secondHalfText": (
            "Brug denne til at konfigurere den anden\n"
    ...
    "configKeyboardWindow": {
        ...
        "keyboard2NoteText": (
            "Bemærk: De fleste tastaturer kan kun registrere nogle få tryk\n"
    ...
    "configTouchscreenWindow": {
        ...
        "swipeInfoText": (
            "'Swipe'-kontrol tager lidt tid at vænne sig til, men\n"
    ...
    "connectMobileDevicesWindow": {
        ...
        "bestResultsText": (
            "For at få de bedste resultater skal du bruge et lag-frit wifi-netværk.\n"
        ...
        "explanationText": (
            "For at bruge en smartphone eller tablet som en trådløs controller,\n"
        ...
        "forIOSText": "til iOS:",
        "getItForText": (
            "Få ${REMOTE_APP_NAME} til iOS i Apple App Store eller til\n"
    ...
    "editGameListWindow": {
        ...
        "editGameText": "Rediger spil",
        "gameListText": "Spilliste",
        "listNameText": "Listenavn",
        "nameText": "Navn",
        "removeGameText": "Fjern spil",
        "saveText": "Gem liste",
    },
    "editProfileWindow": {
    ...
    "editSoundtrackWindow": {
        "cantDeleteDefaultText": "Kan ikke slette standard lydspor.",
        ...
        "editSoundtrackText": "Rediger lydspor",
        "editText": "Rediger",
    ...
    "fireTVRemoteWarningText": (
        "*For at få den bedste oplevelse, brug spilcontrollere eller installer\n"
        "'BombSquad Remote' app'en på din telefon eller tablet."
    ),
    ...
    "gameListWindow": {
        "cantDeleteDefaultText": "Kan ikke slette standard spilliste!",
        "cantEditDefaultText": "Kan ikke redigere i standardspillisten! Kopier den eller lav en ny.",
        "deleteConfirmText": ("Slet spilleliste:\n" "\n" "${LIST}?"),
        "deleteText": "Slet",
        "duplicateText": "Kopier",
        "editText": "Rediger",
        "gameListText": "Spilliste",
    ...
    "gameSettingsWindow": {"addGameText": "Tilføj spil"},
    ...
    "helpWindow": {
        ...
        "canHelpText": "BombSquad kan hjælpe.",
        "controllersInfoTextFantasia": (
            "BombSquad understøtter de fleste USB- og Bluetooth-gamepads ligesom xBox 360-controllere\n"
        ...
        "controllersInfoTextMac": (
            "En eller to spillere kan bruge tastaturet, men Bombsquad er bedst med gamepads. \n"
        ...
        "controllersInfoTextOuya": (
            "Du kan bruge OUYA-controllere, PS3-controllere, xBox 360-controllere,\n"
        ...
        "controlsSubtitleText": "Din flinke BombSquad-spiller har nogle grundlæggende handlinger:",
        "controlsSubtitleTextScale": 0.7,
        "controlsText": "Styring",
        "controlsTextScale": 1.4,
        "friendsGoodText": (
            "Disse er gode at have. BombSquad er sjovest at spille med flere spillere,\n"
        ...
        "runInfoText": (
            "- Spurt -\n"
            "Hold hvilken som helst knap nede.\n"
            "Udløselsesknapper virker godt, hvis du har dem. Spurt gør så du bevæger\n"
            "dig hurtigere, men det gør det også sværere at dreje, så hold øje med skrænter."
        ),
    ...
    "internal": {
        ...
        "hasMenuControlText": "${NAME} har kontrol over menuen",
    ...
    "killsText": "Drab",
    "languageSetText": (
        "Sproget et nu sat til ${LANGUAGE}.\n"
    ...
    "newTestBuildAvailableText": (
        "En ny testversion er tilgængelig! (${VERSION} build ${BUILD}).\n"
        "Få den på ${ADDRESS}"
    ),
    ...
    "noProfilesErrorText": (
        "Du har ingen spillerprofiler, så du kan kun bruge '${NAME}'.\n"
    ...
    "profileInfoText": (
        "Opret profiler for dig selv og dine venner for at\n"
    ...
    "ps3ControllersWindow": {
        "macInstructionsText": (
            "Sluk for strømmen bag på din PS3, og sørg for at Bluetooth er\n"
        ...
        "ouyaInstructionsText": (
            "For at bruge din PS3-controller med din OUYA skal du bare forbinde den med\n"
    ...
    "settingsWindowAdvanced": {
        ...
        "helpTranslateText": (
            "BombSquads sprogoversættelser er lavet af BombSquads\n"
    ...
    "store": {
        ...
        "bombSquadProDescriptionText": (
            "Double billetter optjent in-game\n"
            "\n"
        ...
        "freeBombSquadProText": (
            "Bombsquad er nu gratis, men da du oprindeligt købte det, du er\n"
    ...
    "storeDescriptionText": (
        "Vanvittigt spil med op plads til op til 8 spillere!\n"
        "\n"
    ...
    "translations": {
        ...
        "gameDescriptions": {
            (
                ...
                "Vær den udvalgte i et forudbestemt stykke tid for at vinde.\n"
        ...
        "inputDeviceNames": {"Keyboard": "Tastatur", "Keyboard P2": "Tastatur P2"},
        "languages": {
            "Chinese": "Kinesisk",
            "Croatian": "Kroatisk",
            "Czech": "tjekkisk",
        ...
        "playlistNames": {"Just Epic": "Bare Epicisk", "Just Sports": "Bare Sport"},
        "promoCodeResponses": {"invalid promo code": "Ugyldig kampagnekode"},
        "scoreNames": {
            "Flags": "Flag",
            "Goals": "Mål",
            "Score": "Score",
        ...
        "serverResponses": {
            ...
            (
                ...
                "Modtog ${COUNT} tickets fordi du logger ind.\n"
            ...
            (
                ...
                "Din kopi af spillet er blevet modifiseret. \n"
        ...
        "tips": {
            (
                ...
                "Et perfekt løbe-hoppe-dreje-slag kan dræbe på et enkelt slag og\n"
            ...
            (
                ...
                "Lav spillerprofiler til dig selv og dine venner med jeres foretrukne navne\n"
            ...
            (
                ...
                "Forbandelseskasserne laver dig om til en tikkende bombe.\n"
            ...
            (
                ...
                "Selvom de ser anderledes ud, er alle spillernes evner\n"
            ...
            ): "Hold en vilkårlig knap nede for at løbe. Du bevæger dig hurtigere, men du drejer ikke så godt, så pas på kanter.",
            (
                "Ice bombs are not very powerful, but they freeze\n"
                "whoever they hit, leaving them vulnerable to shattering."
            ): "Isbomber er ikke særligt kraftfulde, men de fryser, dem de rammer. Hvilket gør den ramte nem at slå i stykker.",
            (
                "If someone picks you up, punch them and they'll let go.\n"
                "This works in real life too."
            ): (
                "Slå til dem, der løfter dig op – så giver de slip med det samme.\n"
            ...
            (
                ...
                "Hvis du har få controllere, så installer 'BombSquad Remote' app'en på\n"
            ...
            (
                ...
                "Hvis du er blevet ramt af en klistrebombe, så hop rundt og drej i cirkler. Du kan muligvis\n"
            ...
            (
                ...
                "Hvis du samler en forbandelse op, er dit eneste håb for overlevelse\n"
            ...
            (
                ...
                "Hvis der kommer og går mange spillere, så slå automatisk udsmidning af inaktive spillere til under\n"
            ...
            (
                ...
                "Hvis enheden bliver for varmt eller du gerne vil spare på batteriet,\n"
            ...
            (
                ...
                "Hvis din FPS er dårlig, så prøv at skru ned for din opløsning\n"
            ...
            (
                ...
                "I Find Fanen skal dit eget flag være i din base, for at du kan score. Hvis det andet\n"
            ...
            (
                ...
                "Mange ting kan samles op og kastes med – også andre spillere. Det, at kaste dine\n"
            ...
            (
                ...
                "Spillere kan deltage og forlade i midten af de fleste spil,\n"
            ...
            (
                ...
                "Spillere kan tilslutte og forlade midt i de fleste spil\n"
            ...
            (
                ...
                "Powerups er tidsbegrænsede i co-op spil.\n"
            ...
            (
                ...
                "Slag gør mere skade, jo hurtigere dine knytnæver bevæger\n"
            ...
            (
                ...
                "Denne bane ender aldrig, men en høj score vil\n"
            ...
            (
                ...
                "Kastekraft er baseret på den retningsknap, du holder nede. For at kaste\n"
            ...
            (
                ...
                "Træt af soundtracket? Udskift det med dine egne!\n"
            ...
            (
                ...
                "Du kan 'sigte' dine slag ved at dreje til venstre eller højre. Dette er\n"
            ...
            (
                ...
                "Du kan se hvornår en bombe vil springe, hvis du kigger\n"
            ...
            (
                ...
                "Du behøver ikke at redigere din profil for at ændre brugere: Bare tryk på\n"
            ...
            (
                ...
                "Du tager skade, hvis du støder dit hoved mod ting,\n"
    ...
    "trialPeriodEndedText": (
        "Din prøveperiode er slut. Vil du købe\n"
    ...
    "xbox360ControllersWindow": {
        ...
        "macInstructions2Text": (
            "For at bruge controllere trådløst, skal du også bruge modtageren\n"
        ...
        "macInstructionsText": (
            "For at bruge Xbox 360-controllere skal du installere en\n"
        ...
        "ouyaInstructionsText": (
            "For at bruge Xbox 360-controllere til BombSquad, tilslut dem din enheds USB-port.\n"
