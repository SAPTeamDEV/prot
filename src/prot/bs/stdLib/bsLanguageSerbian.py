...
values = {
    "accountSettingsWindow": {
        ...
        "linkAccountsInstructionsNewText": (
            "Да би спојио два налога, генерирај код на првом\n"
        ...
        "linkAccountsInstructionsText": (
            "Da povežeš dva profila, generiši kod sa jednog \n"
        ...
        "setAccountNameDesc": (
            "Изабери има које ће се приказивати на твом налогу.\n"
            "Можеш користити име са једног од твоји повезаних\n"
            "налога или да направиш сопствено име."
        ),
        "signInInfoText": (
            "Улогуј се да зарађујеш тикете, такмичиш на мрежи\n"
    ...
    "allowText": "Дозволи",
    "alreadySignedInText": (
        "Овај профил је тренутно пријављен на другом уређају;\n"
    ...
    "buttonText": "дугме",
    "canWeDebugText": (
        "Да ли желиш да BombSquad аутоматски шање извештај о кваровима,\n"
    ...
    "configGamepadSelectWindow": {
        ...
        "pressAnyButtonText": (
            "Притисни било које дугме на контролеру\n" "које желиш да прилагодиш..."
        ),
    ...
    "configGamepadWindow": {
        ...
        "secondHalfText": (
            "Користи ово да наместиш другу половину\n"
    ...
    "configKeyboardWindow": {
        ...
        "keyboard2NoteText": (
            "Обавештење: Већiна тастатура може да региструје само неколико притиска\n"
    ...
    "configTouchscreenWindow": {
        ...
        "swipeInfoText": (
            '"Повлаченје" стил контрола је мање коришћен али \n'
    ...
    "connectMobileDevicesWindow": {
        ...
        "bestResultsText": (
            "За најбоље резултате треба ти интернет без кашњења. Можеш\n"
        ...
        "explanationText": (
            "Дда би користио памтни телефон или таблет као бежични контролер,\n"
        ...
        "forIOSText": "за iOS:",
        "getItForText": (
            "Преузми ${REMOTE_APP_NAME} за iOS преко Apple App Store\n"
    ...
    "coopSelectWindow": {
        ...
        "activenessInfoText": (
            "Овај множилац расте данима када ти\n" "играш и опада данима када не играш."
        ),
        "activityText": "Активност",
        "campaignText": "Напредак",
        "challengesInfoText": (
            "Освајај награде приликом завршавања мини-игри.\n"
            "\n"
        ...
        "totalText": "укупно",
        "tournamentInfoText": (
            "Такмичи се за најбољи резултат са\n"
        ...
        "welcome1Text": (
            "Добродоша у ${LEAGUE}. Можеш повежати свој ранк\n"
            "у лиги освајајући звездице, зевршавајући задатке\n"
            "и освајајући трофеје на турнирима."
        ),
        "welcome2Text": (
            "Тикете можеш освојити у много сличних активности.\n"
    ...
    "creditsWindow": {
        ...
        "songCreditText": (
            "${TITLE} је изведен од стране ${PERFORMER}\n"
    ...
    "difficultyHardUnlockOnlyText": (
        "Овај ниво може да се откључа само на тешком моду.\n"
    ...
    "editProfileWindow": {
        "accountProfileInfoText": (
            "Овај специјални профил има име и \n"
        ...
        "globalProfileInfoText": (
            "Профили глобалних играча загарантовано имају јединствена \n"
        ...
        "localProfileInfoText": (
            "Профили локалних играча немају иконице и није загарантовано\n"
        ...
        "upgradeProfileInfoText": (
            "Ово ће резервисати твоје име широм света и \n"
    ...
    "failText": "Неуспех",
    "fatalErrorText": (
        "Ух ох; нешто недостаје или је покварено.\n"
    ...
    "gameSettingsWindow": {"addGameText": "Додај игру"},
    "gamesToText": "${WINCOUNT}-${LOSECOUNT}",
    "gatherWindow": {
        "aboutDescriptionLocalMultiplayerExtraText": (
            "Запамти: било који уређај у заједници може да има\n"
            "више од једног играча ако има довољно контролера."
        ),
        "aboutDescriptionText": (
            "Користи ове уметке да организујеш заједницу.\n"
            "\n"
        ...
        "disconnectClientsText": (
            "Ово ће уклонити ${COUNT} играча са твоје\n" "заједнице. Да ли си сигуран?"
        ),
        "earnTicketsForRecommendingAmountText": (
            "Пријатељи ће добити ${COUNT} тикета ако пробају игру\n"
        ...
        "friendPromoCodeInstructionsText": (
            'Да би га искористио, отвори ${APP_NAME} и иди у "Подешавања->Напредна подешавања->\n'
        ...
        "googlePlayReInviteText": (
            "У твојој заједници је ${COUNT} играч/а који ће\n"
        ...
        "inviteAFriendText": (
            "Твоји пријатељи још увек немају игру? Позови их\n"
        ...
        "wifiDirectDescriptionBottomText": (
            'Ако сви уређаји имају "Wi-Fi Direct", они би то могли користити да нађу и да се\n'
        ...
        "wifiDirectDescriptionTopText": (
            "Wi-Fi Direct се може користити да се директно повежу Андроид уређаји без\n"
    ...
    "getTicketsWindow": {
        ...
        "unavailableLinkAccountText": (
            "Извињавамо се, куповина није доступна на овој платформи.\n"
    ...
    "helpWindow": {
        ...
        "controllersInfoText": (
            "Можеш да играш ${APP_NAME} са пријатељима преко мреже, или \n"
        ...
        "controlsText": "Контроле",
        "devicesInfoText": (
            "VR верзија ${APP_NAME}-а може да се игра преко мреже са регуларном\n"
        ...
        "devicesText": "Уређаји",
        "friendsGoodText": (
            "Ово је добро да имаш. ${APP_NAME} је најзабавнији са неколико\n"
    ...
    "installDiskSpaceErrorText": (
        "ГРЕШКА: Немогуће да се заврши инсталација.\n"
    ...
    "internal": {
        ...
        "connectionFailedVersionMismatchText": (
            "Конекција неуспела; домаћин користи другу верзију игре.\n"
        ...
        "joinedPartyInstructionsText": (
            "Неко се придружио твојој заједници.\n" 'Иди на "Играј" да стартујеш игру.'
        ),
        ...
        "touchScreenJoinWarningText": (
            "Придружили сте се уређајом са екраном на додир.\n"
        ...
        "vrOrientationResetCardboardText": (
            "Користи ово да рестартујеш VR оријентацију.\n"
    ...
    "macControllerSubsystemMFiNoteText": (
        "iOS/Mac контролери су пронађени;\n"
    ...
    "mustInviteFriendsText": (
        "Обавештење: мораш да позовеш пријатеље\n"
    ...
    "newTestBuildAvailableText": (
        "Новијi систем за тестирање је доступан! (${VERSION} прави ${BUILD}).\n"
    ...
    "pleaseRateText": (
        "Ако уживате у ${APP_NAME}, молимо вас да издвојите мало\n"
    ...
    "promoCodeWindow": {"codeText": "Код", "enterText": "Уђи"},
    "promoSubmitErrorText": "Грешка при прихватању кода; провери своју интенет конекцију",
    "ps3ControllersWindow": {
        "macInstructionsText": (
            "Искључи напајање са задње стране PS3, буди сигуран да је\n"
        ...
        "ouyaInstructionsText": (
            "Да користиш PS3 контролер са твојим OUYA, једноставно их једном повежи са\n"
    ...
    "remoteAppInfoShortText": (
        "${APP_NAME} је најзабавнији када се игра са породицом или\n"
    ...
    "remote_app": {
        ...
        "connected": "Повезано.",
        "description": (
            "Користи свој телефон или таблет као контролер за BombSquad.\n"
        ...
        "searching_caption": (
            "Притисни на име игре да се придружиш.\n"
            "Буди сигуран да си на истој Wi-Fi мрежи као и игра."
        ),
        "start": "Стартуј",
        "version_mismatch": (
            "Верзије се не подударају.\n"
    ...
    "replayVersionErrorText": (
        "Извињавамо се, овај снимак је направљен у \n"
    ...
    "reportPlayerExplanationText": (
        "Корсти ову пошту да пријавиш играча за варање, неприкладан говор или друго лоше\n"
    ...
    "settingsWindowAdvanced": {
        ...
        "helpTranslateText": (
            "${APP_NAME} језички преводи су рад играча. Ако би желео да\n"
    ...
    "store": {
        ...
        "bombSquadProNewDescriptionText": (
            "• Уклања рекламе и поруке за куповину пуне верзије\n"
        ...
        "freeBombSquadProText": (
            "BombSquad је сада бесплатан, али пошто си је већ платио добићеш\n"
    ...
    "storeDescriptionText": (
        "Лудница за заједницу од 8 играча!\n"
        "\n"
    ...
    "translations": {
        ...
        "gameDescriptions": {
            (
                ...
                "Буди одабран на одређено време да победиш.\n"
        ...
        "inputDeviceNames": {"Keyboard": "Тастатура", "Keyboard P2": "Тастатура И2"},
        "languages": {
            "Arabic": "Арапски",
        ...
        "playlistNames": {"Just Epic": "Само епско", "Just Sports": "Само спортови"},
        "scoreNames": {
            "Flags": "Заставе",
            "Goals": "Голови",
            "Score": "Резултат",
        ...
        "serverResponses": {
            ...
            (
                ...
                "Да ли сте сигурни да желите да повежете ове налоге?\n"
                "\n"
                "${ACCOUNT1}\n"
                "${ACCOUNT2}\n"
                "\n"
            ...
            (
                ...
                "ПОВЕЗИВАЊЕ ОДБИЈЕНО. ${ACCOUNT} садржи\n"
            ...
            (
                ...
                "Повежи налог ${ACCOUNT} са овим налогом?\n"
            ...
            (
                ...
                "Примљено ${COUNT} тикета за пријављивање.\n"
            ...
            (
                ...
                "Фукционалност сервера више није подржана на овај верзији игре;\n"
            ...
            (
                ...
                "Растави ${ACCOUNT} од овог налога?\n"
            ...
            (
                ...
                "УПОЗОРЕЊЕ: жалбе за варање су биле издате против твог налога.\n"
            ...
            (
                ...
                "Твоја копија игре је модификована. Молимо\n"
        ...
        "tips": {
            (
                ...
                "Перфектно усклађен ударац из залета са скоком упут се вртећи може убити\n"
            ...
            (
                ...
                "Направите профиле играча за себе и своје пријатеље са\n"
            ...
            (
                ...
                "Уклете кутије те претварају у темпирану бомбу.\n"
            ...
            (
                ...
                "Упркос њиховом изгледу, све способности ликова су идентичне,\n"
            ...
            (
                ...
                "Држи било које дугме за трчање. Стићи ћеш на места брже\n"
            ...
            (
                ...
                "Ледене бомбе нису много јаке, али оне заледе\n"
            ...
            (
                ...
                "Ако те неко ухвати, ударај га и испустиће те.\n"
            ...
            (
                ...
                "Ако сте танки са контролерима, преузмите '${REMOTE_APP_NAME}' апликацију\n"
            ...
            (
                ...
                "Ако добијеш лепљиву бомбу залепњену за тебе, скачи унаоколо и врти се у круг. Можда\n"
            ...
            (
                ...
                "Ако покупиш клетву, твоја једина нада за преживљавање\n"
            ...
            (
                ...
                "Ако имаш много играча који долазе и одлазе, укључи 'аутоматски избаци неактивне играче'\n"
            ...
            (
                ...
                "Ако уређај постаје врућ или желиш да сачувате батерију,\n"
            ...
            (
                ...
                "Ако ти је слика нестабилна, покушај да смањиш резолуцију\n"
            ...
            (
                ...
                'У "Зароби заставу", твоја властита застава мора бити у бази да би постиглао поен. Ако је\n'
            ...
            (
                ...
                "Многе ствари могу бити подигнуте и бачене, укључујући друге играче. Шутирање\n"
            ...
            (
                ...
                "Играчи се могу придружити и напустити у сред већине игара,\n"
            ...
            (
                ...
                "Глава је најрањивији део, зато лепљива бомба\n"
            ...
            (
                ...
                "Овај ниво нема крај, али високи резултат овде\n"
            ...
            (
                ...
                "Снага бацање је базирана на страни коју држиш на контролеру.\n"
            ...
            (
                ...
                "Досадила ти је листа звукова? Замени је својом!\n"
            ...
            (
                ...
                'Можеш да "нациљаваш" ударце окретањем лево или десно.\n'
            ...
            (
                ...
                "Можеш да процениш када ће бомба да експлодира гледајући на\n"
            ...
            (
                ...
                "Добијаш штету када удариш главом у нешто, зато\n"
    ...
    "wiimoteLicenseWindow": {"titleText": "DarwiinRemote права задржана"},
    "wiimoteListenWindow": {
    ...
    "wiimoteSetupWindow": {
        ...
        "listenText": "Слушај",
        "macInstructionsText": (
            "Буди сигуран да је твој Wii искључен и да је Bluetooth\n"
    ...
    "xbox360ControllersWindow": {
        ...
        "macInstructions2Text": (
            "Да користиш контролере бежично, треба ти ресивер који долази са\n"
