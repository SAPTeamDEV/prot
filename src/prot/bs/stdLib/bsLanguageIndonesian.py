...
values = {
    "accountSettingsWindow": {
        ...
        "linkAccountsInstructionsText": (
            "Untuk menghubungkan dua akun, buat kode di salah satu\n"
        ...
        "setAccountNameDesc": (
            "Pilih nama yang ditampilkan untuk akun anda.\n"
            "Gunakan nama dari akun yang tersambung atau\n"
            "buatlah nama khusus baru."
        ),
        "signInInfoText": (
            "Masuk untuk mendapatkan tiket, bermain online,\n"
    ...
    "addGameWindow": {"getMoreGamesText": "Game Lain...", "titleText": "Tambah Game"},
    "allowText": "Boleh",
    "alreadySignedInText": (
        "akun anda telah masuk di media lain;\n"
    ...
    "buttonText": "tombol",
    "canWeDebugText": (
        "Bolehkah BombSquad mengirim informasi kerusakan\n"
    ...
    "configGamepadWindow": {
        ...
        "secondHalfText": (
            "Gunakan ini untuk pengontrol kedua dari\n"
    ...
    "configKeyboardWindow": {
        ...
        "keyboard2NoteText": (
            "Catatan:  beberapa keyboard hanya dapat memasukan beberapa tombol yang ditekan pada satu waktu,\n"
    ...
    "configTouchscreenWindow": {
        ...
        "swipeInfoText": (
            "Model kontrol 'geser' membutuhkan penggunaan sedikit \n"
    ...
    "connectMobileDevicesWindow": {
        ...
        "bestResultsText": (
            "Untuk hasil yang lebih baik, anda membutuhkan jaringan Wi-Fi yang bebas lag.\n"
        ...
        "explanationText": (
            "Untuk menggunakan smartphone atau tablet sebagai pengontrol,\n"
        ...
        "getItForText": (
            "Dapatkan ${REMOTE_APP_NAME} untuk iOS di Apple App Store\n"
    ...
    "coopSelectWindow": {
        ...
        "activenessInfoText": (
            "Kelipatan ini naik di hari ketika anda bermain\n"
            "dan turun di haru ketika anda tidak bermain"
        ),
        "activityText": "Aktivitas",
        "campaignText": "Campaign",
        "challengesInfoText": (
            "Dapatkan hadiah dengan menyelesaikan mini games\n"
            "\n"
        ...
        "totalText": "Total",
        "tournamentInfoText": (
            "Bersaing untuk skor tinggi dengan\n"
        ...
        "welcome1Text": (
            "Selamat datang ke ${LEAGUE}.Kamu bisa tingkatkan \n"
            "ranking liga dengan dapatkan rating bintang, selesaikan \n"
            "penghargaan dan menenangkan piala di turnamen"
        ),
        "welcome2Text": (
            "Kamu juga bisa mendapatkan tiket dari aktivitas yang sama.\n"
    ...
    "creditsWindow": {
        ...
        "songCreditText": (
            "${TITLE} Dimainkan oleh ${PERFORMER}\n"
    ...
    "difficultyHardUnlockOnlyText": (
        "Level ini khusus untuk mode sulit. \n" "Kamu pikir kamu bisa!?!?!"
    ),
    ...
    "editProfileWindow": {
        "accountProfileInfoText": (
            "Profil spesial ini mengikuti nama\n"
        ...
        "globalProfileInfoText": (
            "profil pemain global dijamin untuk memiliki nama unik\n"
        ...
        "localProfileInfoText": (
            "Profile lokal tidak mempunyai ikon dan nama tidak terjamin unik.\n"
        ...
        "upgradeProfileInfoText": (
            "Ini akan jadi nama anda dalam game ini\n"
    ...
    "failText": "Gagal",
    "fatalErrorText": (
        "O-ow, sesuatu hilang atau rusak. \n"
    ...
    "gatherWindow": {
        ...
        "earnTicketsForRecommendingAmountText": (
            "Teman anda akan mendapatkan ${COUNT} tiket jika mereka memainkan game ini\n"
        ...
        "friendPromoCodeInstructionsText": (
            'Untuk menggunakannya, buka ${APP_NAME} dan buka "Pengaturan-> Lanjutan-> Masukkan Kode".\n'
        ...
        "googlePlayReInviteText": (
            "Ada ${COUNT} pemain Google Play di pestamu\n"
        ...
        "inviteAFriendText": (
            "Teman anda belum memainkan ini? undang mereka sekarang\n"
        ...
        "wifiDirectDescriptionBottomText": (
            "Jika semua perangkat punya tab 'Wi-Fi Direct', maka seharusnya semua bisa saling\n"
        ...
        "wifiDirectDescriptionTopText": (
            "Wi-Fi Direct bisa digunakan untuk koneksi Android tanpa hotspot.\n"
    ...
    "getTicketsWindow": {
        ...
        "unavailableLinkAccountText": (
            "Maaf, pembelian tidak dapat dilakukan di perangkat ini.\n"
    ...
    "helpWindow": {
        ...
        "controllersInfoText": (
            "Kamu dapat bermain ${APP_NAME} dengan temanmu melalui sebuah\n"
        ...
        "controlsText": "Kontrol",
        "devicesInfoText": (
            "Versi VR dari ${APP_NAME} bisa dimainkan lewat jaringan dengan\n"
        ...
        "friendsGoodText": (
            "Sangat diperlukan. ${APP_NAME} Sangat menyenangkan dengan beberapa\n"
    ...
    "internal": {
        ...
        "incompatibleVersionHostText": (
            "Host berjalan dengan versi yang berbeda dengan game.\n"
            "Pastikan anda up-to-date dan coba lagi"
        ),
        "incompatibleVersionPlayerText": (
            "${NAME} menjalankan versi game yang berbeda.\n"
        ...
        "touchScreenJoinWarningText": (
            "Kau telah bergabung dengan layar sentuh.\n"
        ...
        "vrOrientationResetCardboardText": (
            "Gunakan ini untuk mengulang orientasi VR.\n"
    ...
    "macControllerSubsystemMFiNoteText": (
        "Dibuat-untuk-ios/Mac kontroler terdeteksi;\n"
    ...
    "newTestBuildAvailableText": (
        "Uji coba baru tersedia!  (${VERSION} bangun ${BUILD}).\n"
        "Dapatkan di ${ADDRESS}"
    ),
    "newText": "Baru",
    ...
    "noProfilesErrorText": (
        "Kamu tidak punya profil pemain, jadi '${NAME}' dipakai. \n"
    ...
    "pleaseRateText": (
        "Jika kau menyukai ${APP_NAME},silahkan memberi waktu sedikit untuk menilai atau menulis komentar. Ini membantu kami untuk menyempurnakan permainan di masa mendatang.\n"
        "\n"
        "terima kasih!\n"
        "-eric"
    ),
    ...
    "promoCodeWindow": {"codeText": "Kode", "enterText": "Masuk"},
    "promoSubmitErrorText": "Kesalahan saat mengirim kode; periksa koneksi internet Anda",
    "ps3ControllersWindow": {
        "macInstructionsText": (
            "Matikan daya pada bagian belakang PS3mu, pastikan\n"
        ...
        "ouyaInstructionsText": (
            "Untuk menggunakan kontroller PS3mu dengan OUYA, hubungkan saja dengan kabel USB\n"
    ...
    "remoteAppInfoShortText": (
        "${APP_NAME} akan menyenangkan ketika dimainkan dengan keluarga & teman.\n"
    ...
    "remote_app": {
        ...
        "connected": "Terhubung.",
        "description": (
            "Gunakan HP atau tabletmu sebagai pengontrol dengan BombSquad.\n"
        ...
        "searching_caption": (
            "Tekan nama dari game yang ingin dimasuki.\n"
    ...
    "reportPlayerExplanationText": (
        "Gunakan email ini untuk melaporkan tindakan curang, kata-kata yang tidak pantas, atau kelakuan buruk lainnya.\n"
    ...
    "settingsWindowAdvanced": {
        ...
        "helpTranslateText": (
            "Translasi ${APP_NAME} selain Inggris adalah bantuan \n"
    ...
    "store": {
        ...
        "bombSquadProNewDescriptionText": (
            "• Menghapus iklan dalam permainan dan omelan-layar\n"
        ...
        "freeBombSquadProText": (
            "BombSquad sekarang gratis, tapi karena dulu kau membelinya\n"
    ...
    "translations": {
        ...
        "gameDescriptions": {
            (
                ...
                "Jadilah 'yang terpilih' dalam waktu yang ditentukan.\n"
        ...
        "playlistNames": {"Just Epic": "Cukup Epik", "Just Sports": "Cukup Olahraga"},
        "scoreNames": {
            "Flags": "Bendera",
            "Goals": "Gol",
            "Score": "Skor",
        ...
        "serverResponses": {
            ...
            (
                ...
                "Kau yakin ingin menghubungkan akun ini?\n"
                "\n"
                "${ACCOUNT1}\n"
                "${ACCOUNT2}\n"
                "\n"
            ...
            (
                ...
                "LINKING DITOLAK. ${ACCOUNT} berisi\n"
            ...
            (
                ...
                "Menghubungkan akun ${ACCOUNT} ke akun ini?\n"
            ...
            (
                ...
                "Menerima ${COUNT} tiket untuk masuk.\n"
            ...
            (
                ...
                "Fungsi server tidak lagi didukung dalam versi game ini;\n"
            ...
            (
                ...
                "PERINGATAN: keluhan tentang kecurangan telah diajukan terhadap akun Anda.\n"
            ...
            (
                ...
                "Salinan gamemu telah dimodifikasi.\n"
        ...
        "tips": {
            (
                ...
                "Larian-lompatan-putaran-pukulan sempurna pada waktu yang tepat bisa membunuh dengan\n"
            ...
            (
                ...
                "Buat profil pemain untuk teman dan dirimu sendiri dengan\n"
            ...
            (
                ...
                "Kotak Terkutuk membuatmu menjadi bom waktu.\n"
            ...
            (
                ...
                "Selain penampilannya, semua kemampuan karakter sama,\n"
            ...
            (
                ...
                "Tahan tombol apa saja untuk lari. Kau akan menjadi lebih cepat\n"
            ...
            (
                ...
                "Bom es tidak cukup kuat, tetapi mereka membekukan\n"
            ...
            (
                ...
                "Jika seseorang mengangkatmu, pukul dia dan dia akan melepaskanmu.\n"
            ...
            (
                ...
                "Jika kau tidak mempunyai kontroller, pasang app '${REMOTE_APP_NAME}\n"
            ...
            (
                ...
                "Jika kau mengambil kutukan, satu-satunya harapanmu untuk hidup adalah\n"
            ...
            (
                ...
                "Jika kau mendapat banyak pemain yang masuk dan bergabung, aktidkan 'auto-kick-idle-players'\n"
            ...
            (
                ...
                "Jika perangkatmu mulai panas atau kau mau menghemat baterai,\n"
            ...
            (
                ...
                "Jika framerate-mu lemah, coba turunkan resolusi\n"
            ...
            (
                ...
                "Dalam Ambil-Benderanya, benderamu sendiri harus ada pada bentengmu untuk mencetak skor, jika tim lain\n"
            ...
            (
                ...
                "Banyak hal yang bisa diambil dan dilempar, termasuk pemain lain. Membuang\n"
            ...
            (
                ...
                "Pemain bisa masuk dan keluar ditengah-tengah permainan,\n"
            ...
            (
                ...
                "Pukulan mendapatkan lebih banyak serangan ketika kau\n"
                "berlari, melompat, dan berputar."
            ),
            (
                "Run back and forth before throwing a bomb\n"
                "to 'whiplash' it and throw it farther."
            ): ("Lari maju mundur untuk melempar bom\n" "sangat jauh."),
            ("Take out a group of enemies by\n" "setting off a bomb near a TNT box."): (
                "Hancurkan sekumpulan musuh dengan\n"
            ...
            (
                ...
                "Kepala adalah tempat yang paling rapuh, jadi menempelkannya dengan bom-lengket\n"
            ...
            (
                ...
                "Level ini tidak akan pernah berakhir, tetapi skor\n"
            ...
            (
                ...
                "Kekuatan lemparan tergantung dimana kau melempar.\n"
            ...
            (
                ...
                "Bosan dengan soundtrack lama? Ganti dengan milikmu sendiri!\n"
            ...
            (
                ...
                "Kau bisa 'arahkan' tinjumu dengan memutar ke kiri dan kanan.\n"
            ...
            (
                ...
                "Kamu bisa melihat bom yang akan meledak dengan melihat warna percikan bom itu sendiri:\n"
            ...
            (
                ...
                "Kamu akan kesakitan jika kamu menabrakan kepalamu ke benda lain,\n"
    ...
    "wiimoteSetupWindow": {
        ...
        "macInstructionsText": (
            "Pastika Wii-mu mati dan Bluetooth hidup\n"
        ...
        "thanksText": (
            "Terimakasih kepada DarwiinRemote team\n" "Untuk dukungan wiimote"
        ),
    ...
    "xbox360ControllersWindow": {
        ...
        "macInstructions2Text": (
            "Untuk menggunakan stik wireless, anda juga memerlukan wireless receiver\n"
        ...
        "macInstructionsText": (
            "Untuk menggunakan stik Xbox 360, anda perlu menginstall\n"
        ...
        "ouyaInstructionsText": (
            "Untuk menggunakan stik Xbox 360 kabel, tancapkan\n"
