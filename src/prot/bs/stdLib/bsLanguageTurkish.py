...
values = {
    "accountSettingsWindow": {
        ...
        "linkAccountsInstructionsNewText": (
            "İki hesabı bağlamak için, ilk hesapta kod oluştur\n"
    ...
    "addGameWindow": {"getMoreGamesText": "Daha Çok Oyun...", "titleText": "Oyun Ekle"},
    "allowText": "Kabul Et",
    "alreadySignedInText": (
        "Başka bir cihazda hesabına giriş yapılmış;\n"
    ...
    "buttonText": "buton",
    "canWeDebugText": (
        "Oyun otomatik olarak hataları, çökmeleri ve basit \n"
    ...
    "configGamepadWindow": {
        ...
        "secondHalfText": (
            "2'si 1 arada cihaz kontrolcüsünün birini\n"
    ...
    "configTouchscreenWindow": {
        ...
        "swipeInfoText": (
            '"Sürme" kontrol stilleri kullanışlıdır fakat\n'
    ...
    "connectMobileDevicesWindow": {
        ...
        "bestResultsText": (
            "En iyi sonuçları gecikmesiz Wifi ağına bağlıyken\n"
        ...
        "explanationText": (
            "Akıllı Telefon veya Tableti kablosuz kontrolcü olarak kullanmak için\n"
        ...
        "forIOSText": "iOS için:",
        "getItForText": (
            "${REMOTE_APP_NAME} iOS için Apple App Store ve Android\n"
    ...
    "coopSelectWindow": {
        ...
        "activenessInfoText": (
            "Bu çarpan oynadığın günlerde yükselir\n" "oynamadığın günlerde düşer."
        ),
        "activityText": "Aktiflik",
        "campaignText": "Mücadele",
        "challengesInfoText": (
            "Mini-oyunları tamamlayarak ödül kazan.\n"
            "\n"
        ...
        "totalText": "toplam",
        "tournamentInfoText": (
            "Ligindeki diğer oyuncular arasında\n"
            "en yüksek skoru yap.\n"
            "\n"
        ...
        "welcome1Text": (
            "${LEAGUE} hoş geldiniz. Lig sıralamanı turnuvalarda\n"
            "yıldız derecesi kazanarak, başarıları tamamlayarak\n"
            "ve kupalar kazanarak geliştirebilirsin."
        ),
        "welcome2Text": (
            "Ayrıca benzer aktivitelerden biletler kazanabilirsin.\n"
    ...
    "creditsWindow": {
        ...
        "songCreditText": (
            "${TITLE}, ${PERFORMER} tarafından yapıldı\n"
    ...
    "difficultyHardUnlockOnlyText": (
        "Bu seviye sadece Zor modda açılır.\n"
    ...
    "editProfileWindow": {
        "accountProfileInfoText": (
            "Bu özel profil, ismin ve simgen\n"
            "üzerine oluşturulur.\n"
            "\n"
            "${ICONS}\n"
            "\n"
        ...
        "globalProfileInfoText": (
            "Global oyuncu profilleri dünya çapında benzersiz\n"
        ...
        "localProfileInfoText": (
            "Yerel oyuncu profilleri, simgenin ve adının benzersiz\n"
        ...
        "upgradeProfileInfoText": (
            "Bu senin dünya çapında benzersiz oyuncu adı\n"
    ...
    "fatalErrorText": (
        "Uh oh; bir şeyler eksik veya hatalı\n"
    ...
    "gatherWindow": {
        ...
        "disconnectClientsText": (
            "Bu, partindeki ${COUNT} oyuncunun bağlantısını\n" "kesecek. Emin misin ?"
        ),
        "earnTicketsForRecommendingAmountText": (
            "Eğer arkadaşların oyunu denerler ise ${COUNT} bilet alacak\n"
        ...
        "friendPromoCodeInstructionsText": (
            'Kullanmak için ${APP_NAME} uygulamasını açın ve "Ayarlar->Gelişmiş->Promo Kodu"\n'
        ...
        "googlePlayReInviteText": (
            "Partinde şuan ${COUNT} Google Play oyuncusu var.\n"
        ...
        "inviteAFriendText": (
            "Bu oyun arkadaşlarında yok mu? Onları davet et.\n"
        ...
        "wifiDirectDescriptionBottomText": (
            "Eğer tüm cihazların 'Wi-Fi Direct' paneli varsa, diğerlerini bulmak ve bağlanmak için\n"
        ...
        "wifiDirectDescriptionTopText": (
            "Wi-Fi Direct Android cihazların Wi-Fi ağı ihtiyacı olmadan doğrudan\n"
    ...
    "getTicketsWindow": {
        ...
        "unavailableLinkAccountText": (
            "Üzgünüz, Satın almalar bu patformda kullanılamaz.\n"
    ...
    "helpWindow": {
        ...
        "controllersInfoText": (
            "Arkadaşlarınla birlikte ağ üzerinden veya yeterince kontrolcünüz\n"
        ...
        "controlsText": "Kontroller",
        "devicesInfoText": (
            "${APP_NAME}'ın VR sürümü ile normal sürümü ağ\n"
        ...
        "friendsGoodText": (
            "Bunların olması güzel. ${APP_NAME} birkaç oyuncu ile daha\n"
    ...
    "internal": {
        ...
        "connectionFailedVersionMismatchText": (
            "Bağlantı başarısız; Kurucu oyunun başka bir sürümünü kullanıyor.\n"
        ...
        "vrOrientationResetCardboardText": (
            "Bunu kullanmak için VR oryantasyonunu sıfırla.\n"
    ...
    "macControllerSubsystemMFiNoteText": (
        "Made-for-iOS/Mac kontrolcü algılandı;\n"
    ...
    "mustInviteFriendsText": (
        'Not: Çok oyunculu oynamak için "${GATHER}"\n'
    ...
    "newTestBuildAvailableText": (
        "Yeni bir test yapısı mevcut! (${VERSION} yapı ${BUILD}).\n"
    ...
    "pleaseRateText": (
        "Eğer ${APP_NAME}'dan zevk aldıysan, lütfen oyunu değerlerdir\n"
    ...
    "promoCodeWindow": {"codeText": "Kod", "enterText": "Gir"},
    "promoSubmitErrorText": "Kod gönderilirken hata oluştu; internet bağlantını kontrol et",
    "ps3ControllersWindow": {
        "macInstructionsText": (
            "PS3'ünüzü kapatıp açın. Bluetooth'un Mac'inizde etkin\n"
        ...
        "ouyaInstructionsText": (
            "OUYA ile PS3 kotnroller kullanmak; basitçe eşlemek için USB kablosunu\n"
    ...
    "remoteAppInfoShortText": (
        "${APP_NAME} aile ve arkadaşların ile oynadığında daha eğlencelidir.\n"
    ...
    "remote_app": {
        ...
        "description": (
            "Telefonunu veya tabletini BombSquad'da kontrolcü olarak kullan.\n"
        ...
        "searching_caption": (
            "Katılacağın oyunun adına tıkla.\n"
    ...
    "replayVersionErrorText": (
        "Üzgünüz, Bu tekrar oyunun eski bir sürümünde\n" "yapılmış ve kullanılamaz."
    ),
    ...
    "reportPlayerExplanationText": (
        "Hile, uygunsuz dil ya da diğer kötü şeyleri rapor etmek için bu E-Postayı kullanın.\n"
    ...
    "settingsWindowAdvanced": {
        ...
        "helpTranslateText": (
            "${APP_NAME}'ın İngilizce olmayan çevirileri topluluk yardımı ile\n"
    ...
    "store": {
        ...
        "bombSquadProNewDescriptionText": (
            "•Oyun-içi reklam ve rahatsız edici ekranlar kalkar\n"
        ...
        "freeBombSquadProText": (
            "BombSquad şuan bedava fakat orijinal olarak oyunu satın aldığın zaman\n"
    ...
    "storeDescriptionText": (
        "8 Kişilik Parti Oyunu Çılgınlığı!\n"
        "\n"
    ...
    "translations": {
        ...
        "gameDescriptions": {
            (
                ...
                "Kazanmak için uzun süre seçilmiş kişi ol.\n"
        ...
        "inputDeviceNames": {"Keyboard": "Klavye", "Keyboard P2": "P2 Klavye"},
        "languages": {
            "Arabic": "Arapça",
        ...
        "playlistNames": {"Just Epic": "Sadece Epik", "Just Sports": "Sadece Sporlar"},
        "scoreNames": {
            "Flags": "Bayraklar",
            "Goals": "Goller",
            "Score": "Skor",
        ...
        "serverResponses": {
            ...
            (
                ...
                "Bu hesapları bağlamak istediğine emin misin?\n"
                "\n"
                "${ACCOUNT1}\n"
                "${ACCOUNT2}\n"
                "\n"
            ...
            (
                ...
                "${ACCOUNT} hesabı bu hesaba bağlansın mı?\n"
            ...
            (
                ...
                "${COUNT} Bilet giriş yapıldığı için alındı.\n"
            ...
            (
                ...
                "Oyunun bu sürümünde sunucu işlevleri artık desteklenmiyor;\n"
            ...
            (
                ...
                "${ACCOUNT} hesabının bağlantısını kaldırmak mı istiyorsunuz?\n"
            ...
            (
                ...
                "UYARI: Hesabınız hile kullanımı nedeniyle şikayet edilmiştir.\n"
            ...
            (
                ...
                "Oyununun kopyası modifiye edilmiş.\n"
        ...
        "tips": {
            (
                ...
                "koşmak-zıplamak-dönmek-vurmak Mükemmel zamanlama ile tek vuruşta öldürür\n"
            ...
            (
                ...
                "Rastgele bir tane yerine, tercih ettiğiniz ve\n"
            ...
            (
                ...
                "Lanet kutuları seni saatli bombaya dönüştürür.\n"
            ...
            (
                ...
                "Görünüşlerinin yanı sıra, tüm karakterlerin yetenekleri aynıdır.\n"
            ...
            (
                ...
                "Koşmak için herhangi bir tuşa basılı tut. Hızlıca yerdeğiştirmeni\n"
            ...
            (
                ...
                "Buz-Bombaları çok güçlü değildir fakat değdiği şeyi\n"
            ...
            (
                ...
                "Birisi seni kaldırırsa, yumrukla ki seni salıversin.\n"
            ...
            (
                ...
                "Eğer kontrolcü için aceleciysen; '${REMOTE_APP_NAME}'\n"
            ...
            (
                ...
                "Eğer yapışkan-bomba sana yapıştıysa, etrafta zıpla ve daireler çizerek dön\n"
            ...
            (
                ...
                "Eğer Lanetlenirsen, Uğruna savaşılacak tek umudun;\n"
            ...
            (
                ...
                "Eğer girip çıkan birçok oyuncun varsa; oyundan çıkmayı unutma ihtimallerine karşı\n"
            ...
            (
                ...
                "Eğer cihazın çok ısındıysa veya güç tasarrufu yapmak istiyorsan\n"
            ...
            (
                ...
                "Eğer FPS dengesiz ise; Oyunun grafik ayarlarından görseller\n"
            ...
            (
                ...
                "Bayrak-Yakalamaca'da skor yapmak için kendi bayrağın kendi bölgende olmalı. Eğer diğer\n"
            ...
            (
                ...
                "Çoğu şey kaldırılıp atılabilir, diğer oyuncular da dahil. Düşmanlarını\n"
            ...
            (
                ...
                "Oyuncular çoğu oyunun ortasında girip çıkabilir. Ayrıca\n"
            ...
            (
                ...
                "Hızlı hareket edersen yumrukların daha fazla hasar verir\n"
            ...
            (
                ...
                "Bu bölüm hiç bitmez. Fakat yaptığın yüksek-skorlar\n"
            ...
            (
                ...
                "Fırlatma kuvveti senin yöneliminle alakalıdır.\n"
            ...
            (
                ...
                "Müziklerden sıkıldın mı? Kendininkiyle değiştir!\n"
            ...
            (
                ...
                "Yumruklarınla sağa veya sola dönerken hedef alabilirsin.\n"
            ...
            (
                ...
                "Bombanın patlama zamanını Fitil kıvılcımlarının rengine bakarak\n"
            ...
            (
                ...
                "Kafanı bir şeylere çarparsan hasar alırsın\n"
    ...
    "wiimoteLicenseWindow": {"titleText": "DarwiinRemote Telif Hakkı"},
    "wiimoteListenWindow": {
    ...
    "wiimoteSetupWindow": {
        ...
        "thanksText": (
            "DarwiinRemote takımına bunu mümkün\n" "kıldığı için teşekkürler."
        ),
    ...
    "xbox360ControllersWindow": {
        ...
        "macInstructions2Text": (
            "Kablosuz olarak kullanmak için; ayrıca 'Xbox 360 Kontroller for Windows'\n"
        ...
        "macInstructionsText": (
            "Xbox 360 kolunu kullanmak için aşağıdaki bağlantıdaki\n"
            "Mac sürücüsü yüklemen gerekiyor.\n"
            "Kablolu ve Kablosuz kontroller de çalışır."
        ),
        "ouyaInstructionsText": (
            "BombSquad ile kablolu Xbox 360 kontrolcüsü kullanmak için basitçe\n"
